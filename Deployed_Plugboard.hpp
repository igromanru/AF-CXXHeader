...
class ADeployed_Plugboard_C : public ADeployed_PowerStrip_ParentBP_C
{
    ...
    class UChildActorComponent* PowerSocket2;                                         // 0x0948 (size: 0x8)
    class UChildActorComponent* PowerSocket1;                                         // 0x0950 (size: 0x8)
    class UChildActorComponent* PowerSocket3;                                         // 0x0958 (size: 0x8)
    class UChildActorComponent* PowerSocket6;                                         // 0x0960 (size: 0x8)
    class UChildActorComponent* PowerSocket5;                                         // 0x0968 (size: 0x8)
    class UChildActorComponent* PowerSocket4;                                         // 0x0970 (size: 0x8)
