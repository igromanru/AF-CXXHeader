...
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x1868 (size: 0x8)
    class UStaticMeshComponent* HoloStand1;                                           // 0x1870 (size: 0x8)
    class UPointLightComponent* PointLight;                                           // 0x1878 (size: 0x8)
    class UStaticMeshComponent* HoloStand;                                            // 0x1880 (size: 0x8)
    class UStaticMeshComponent* HoloBeam;                                             // 0x1888 (size: 0x8)
