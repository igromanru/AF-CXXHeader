#ifndef UE4SS_SDK_SK_FishTank_AnimBP_HPP
#define UE4SS_SDK_SK_FishTank_AnimBP_HPP
...
class USK_FishTank_AnimBP_C : public UFishTankAnimInstance
{
    ...
    void ExecuteUbergraph_SK_FishTank_AnimBP(int32 EntryPoint);
}; // Size: 0x598
