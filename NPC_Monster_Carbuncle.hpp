...
class ANPC_Monster_Carbuncle_C : public ANPC_Base_ParentBP_C
{
    ...
    class UCapsuleComponent* CarbuncleOverlap;                                        // 0x21C0 (size: 0x8)
    class UStaticMeshComponent* StaticDeadVersion;                                    // 0x21C8 (size: 0x8)
    class UCableComponent* Tongue;                                                    // 0x21D0 (size: 0x8)
    double CableOffset;                                                               // 0x21D8 (size: 0x8)
    class USceneComponent* GrabbedPhysicsObject;                                      // 0x21E0 (size: 0x8)
    bool CarbuncleHarvested;                                                          // 0x21E8 (size: 0x1)
    FText To Long Interact with Text;                                                 // 0x21F0 (size: 0x10)
    FText NPCName;                                                                    // 0x2200 (size: 0x10)
    bool FloorPlanted;                                                                // 0x2210 (size: 0x1)
    double CarbuncleOverlapRadius;                                                    // 0x2218 (size: 0x8)
    class AAbioticCharacter* TetherTarget;                                            // 0x2220 (size: 0x8)
    double Last TetherTimeStamp;                                                      // 0x2228 (size: 0x8)
    double MaxTetherTime;                                                             // 0x2230 (size: 0x8)
    double TetherCooldownTime;                                                        // 0x2238 (size: 0x8)
    double MaxTetherDistance;                                                         // 0x2240 (size: 0x8)
    bool IsOnCooldown;                                                                // 0x2248 (size: 0x1)
    FTimerHandle CooldownTimerHandle;                                                 // 0x2250 (size: 0x8)
    bool Tethered;                                                                    // 0x2258 (size: 0x1)
    FName CarbuncleHarvestRow;                                                        // 0x225C (size: 0x8)
    double StompStartTime;                                                            // 0x2268 (size: 0x8)
    float StompDuration;                                                              // 0x2270 (size: 0x4)
    float StompDamage;                                                                // 0x2274 (size: 0x4)
    bool RunTetherCheckOnTick;                                                        // 0x2278 (size: 0x1)
    class UStaticMesh* HarvestedStaticMesh;                                           // 0x2280 (size: 0x8)
    bool DamageTargetWhileTethering;                                                  // 0x2288 (size: 0x1)
