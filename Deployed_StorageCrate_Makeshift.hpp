...
class ADeployed_StorageCrate_Makeshift_C : public ADeployed_Container_ParentBP_C
{
    ...
    float Timeline_NewTrack_0_C5B8EB8748DAFF9796007FA338B36E9B;                       // 0x0A08 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline__Direction_C5B8EB8748DAFF9796007FA338B36E9B; // 0x0A0C (size: 0x1)
