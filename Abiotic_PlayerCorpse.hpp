...
class AAbiotic_PlayerCorpse_C : public ADeployed_Container_ParentBP_C
{
    ...
    class UAbiotic_InventoryComponent_C* FormerEquipSlotInventory;                    // 0x09F0 (size: 0x8)
    class UAbiotic_InventoryComponent_C* FormerHotbarInventory;                       // 0x09F8 (size: 0x8)
    class UAbiotic_InventoryComponent_C* FormerBackpackInventory;                     // 0x0A00 (size: 0x8)
    FString playerName;                                                               // 0x0A08 (size: 0x10)
    FString OwningPlayerID;                                                           // 0x0A18 (size: 0x10)
    bool BodyFadingOut;                                                               // 0x0A28 (size: 0x1)
    double CorpseFadeTime;                                                            // 0x0A30 (size: 0x8)
    TArray<class UMaterialInstanceDynamic*> DynMatInstances;                          // 0x0A38 (size: 0x10)
    bool Looted;                                                                      // 0x0A48 (size: 0x1)
    FText CorpseDisplayText;                                                          // 0x0A50 (size: 0x10)
    class UHumanCustomizationComponent_C* DeadPlayerCustomizationComponent;           // 0x0A60 (size: 0x8)
    bool WasPlacedAtWorldStart;                                                       // 0x0A68 (size: 0x1)
