...
class ADeployed_Battery_ParentBP_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UTextRenderComponent* DeviceText;                                           // 0x0938 (size: 0x8)
    class UTextRenderComponent* BatteryText;                                          // 0x0940 (size: 0x8)
    class UTextRenderComponent* PoweredText;                                          // 0x0948 (size: 0x8)
    class UChildActorComponent* PowerSocket1;                                         // 0x0950 (size: 0x8)
    class USceneComponent* PowerSocketContainer;                                      // 0x0958 (size: 0x8)
    class URechargeableComponent_C* RechargeableComponent;                            // 0x0960 (size: 0x8)
    TArray<class APowerSocket_ChildOfActor_C*> PlugStripPowerSockets;                 // 0x0968 (size: 0x10)
    bool HasBatteryPower;                                                             // 0x0978 (size: 0x1)
    FTimerHandle BatteryTickHandle;                                                   // 0x0980 (size: 0x8)
    TEnumAsByte<E_PowerTimerModes::Type> TimerMode;                                   // 0x0988 (size: 0x1)
    FTimerHandle PowerModeTimerHandle;                                                // 0x0990 (size: 0x8)
    class ADayNightManager_C* DayNightManager;                                        // 0x0998 (size: 0x8)
    bool PowerTimerActive;                                                            // 0x09A0 (size: 0x1)
    double BatteryPercentage;                                                         // 0x09A8 (size: 0x8)
    int32 DevicesPullingPower;                                                        // 0x09B0 (size: 0x4)
    class UMaterialInstanceDynamic* DynMat_BatteryLevel;                              // 0x09B8 (size: 0x8)
    class UMaterialInstanceDynamic* DynMat_PowerDraw;                                 // 0x09C0 (size: 0x8)
    int32 MaxBattery;                                                                 // 0x09C8 (size: 0x4)
    bool FreezeBatteryDrain;                                                          // 0x09CC (size: 0x1)
    int32 BatteryChargeSpeed;                                                         // 0x09D0 (size: 0x4)
