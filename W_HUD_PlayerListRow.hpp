...
class UW_HUD_PlayerListRow_C : public UUserWidget
{
    ...
    class UButton* Button_HardcoreRevive;                                             // 0x0308 (size: 0x8)
    class UButton* Button_Kick;                                                       // 0x0310 (size: 0x8)
    class UButton* Button_Mute;                                                       // 0x0318 (size: 0x8)
    class UButton* Button_Profile;                                                    // 0x0320 (size: 0x8)
    class UButton* Button_Report;                                                     // 0x0328 (size: 0x8)
    class UImage* Image;                                                              // 0x0330 (size: 0x8)
    class UImage* Image_0;                                                            // 0x0338 (size: 0x8)
    class UTextBlock* KickButtonText;                                                 // 0x0340 (size: 0x8)
    class UTextBlock* MuteButtonText;                                                 // 0x0348 (size: 0x8)
    class UTextBlock* Name;                                                           // 0x0350 (size: 0x8)
    class UImage* PlatformIcon;                                                       // 0x0358 (size: 0x8)
    class UTextBlock* ProfileButtonText;                                              // 0x0360 (size: 0x8)
    class UTextBlock* ProfileButtonText_1;                                            // 0x0368 (size: 0x8)
    class UTextBlock* ReportButtonText;                                               // 0x0370 (size: 0x8)
    class UTextBlock* StatusText;                                                     // 0x0378 (size: 0x8)
    class UTextBlock* UniquePlayerID;                                                 // 0x0380 (size: 0x8)
    class AAbiotic_PlayerState_C* PlayerState;                                        // 0x0388 (size: 0x8)
    TEnumAsByte<E_PlayerListViewType::Type> ListType;                                 // 0x0390 (size: 0x1)
    FString BannedPlayerName;                                                         // 0x0398 (size: 0x10)
    FString BannedPlayerID;                                                           // 0x03A8 (size: 0x10)
    bool NoInteraction;                                                               // 0x03B8 (size: 0x1)
    FAbioticBlockedPlayer SavedPlayerInfo;                                            // 0x03C0 (size: 0x20)
    TEnumAsByte<EAbioticPlatform> Platform;                                           // 0x03E0 (size: 0x1)
    bool HasPlayerState;                                                              // 0x03E1 (size: 0x1)
    FW_HUD_PlayerListRow_CRefreshRequested RefreshRequested;                          // 0x03E8 (size: 0x10)
    ...
    void BndEvt__W_HUD_PlayerListRow_Button_HardcoreRevive_K2Node_ComponentBoundEvent_6_OnButtonClickedEvent__DelegateSignature();
