...
class UW_OperatingSystem_Main_C : public UUserWidget
{
    ...
    class UImage* DesktopTaskbarBG;                                                   // 0x0330 (size: 0x8)
    class UImage* Email_BG_Image;                                                     // 0x0338 (size: 0x8)
    class UTextBlock* EmailFolder_NameText;                                           // 0x0340 (size: 0x8)
    class UScrollBox* EmailMessage_ScrollBox;                                         // 0x0348 (size: 0x8)
    class UTextBlock* EmailParagraph;                                                 // 0x0350 (size: 0x8)
    class UCanvasPanel* EmailWindow;                                                  // 0x0358 (size: 0x8)
    class UImage* EmailWindowBG;                                                      // 0x0360 (size: 0x8)
    class UTextBlock* EmailWindowTitleText;                                           // 0x0368 (size: 0x8)
    class UHorizontalBox* HBOX_Attachments;                                           // 0x0370 (size: 0x8)
    class UCanvasPanel* ImagePopupCanvas;                                             // 0x0378 (size: 0x8)
    class UImage* MouseCursor;                                                        // 0x0380 (size: 0x8)
    class UTextBlock* NoAttachmentsText;                                              // 0x0388 (size: 0x8)
    class UTextBlock* PopupFilenameText;                                              // 0x0390 (size: 0x8)
    class UScrollBox* ScrollBox_Emails;                                               // 0x0398 (size: 0x8)
    class UCanvasPanel* StartMenuWindow;                                              // 0x03A0 (size: 0x8)
    class UTextBlock* TimeText;                                                       // 0x03A8 (size: 0x8)
    class UButton* CurrentHoveredButton;                                              // 0x03B0 (size: 0x8)
    TArray<FDataTableRowHandle> Emails;                                               // 0x03B8 (size: 0x10)
    class AComputerTerminal_Standard_C* TerminalParent;                               // 0x03C8 (size: 0x8)
    bool WishlistTerminal;                                                            // 0x03D0 (size: 0x1)
    TEnumAsByte<E_OS_Themes::Type> OS_Visual_Theme;                                   // 0x03D1 (size: 0x1)
    TMap<TEnumAsByte<E_OS_Themes::Type>, FLinearColor> OS_Visual_MainText_Color;      // 0x03D8 (size: 0x50)
    TMap<TEnumAsByte<E_OS_Themes::Type>, FLinearColor> OS_Visual_DesktopIconText_Color; // 0x0428 (size: 0x50)
    TMap<TEnumAsByte<E_OS_Themes::Type>, FLinearColor> OS_Visual_XButton_Color;       // 0x0478 (size: 0x50)
