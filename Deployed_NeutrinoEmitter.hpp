...
class ADeployed_NeutrinoEmitter_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UNiagaraComponent* Niagara;                                                 // 0x0928 (size: 0x8)
    class UAudioComponent* LoopAudio;                                                 // 0x0930 (size: 0x8)
    class UChildActorComponent* AntiRadiation;                                        // 0x0938 (size: 0x8)
