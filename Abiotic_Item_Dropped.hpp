...
class AAbiotic_Item_Dropped_C : public AActor
{
    ...
    class UAbioticTargetingComponent* AbioticTargeting;                               // 0x02A0 (size: 0x8)
    class UThermalReceiverComponent* ThermalReceiver;                                 // 0x02A8 (size: 0x8)
    class UStaticMeshComponent* WorldMesh;                                            // 0x02B0 (size: 0x8)
    FDataTableRowHandle ItemDataRow;                                                  // 0x02B8 (size: 0x10)
    FAbiotic_InventoryItemStruct ItemData;                                            // 0x02C8 (size: 0x650)
    FAbiotic_InventoryChangeableDataStruct ChangeableData;                            // 0x0918 (size: 0x118)
    bool HasBeenPickedUp;                                                             // 0x0A30 (size: 0x1)
    FText To Interact with Text;                                                      // 0x0A38 (size: 0x10)
    bool NoPhysics;                                                                   // 0x0A48 (size: 0x1)
    bool PopupAfterSpawned;                                                           // 0x0A49 (size: 0x1)
    FTimerHandle PhysicsSleepHandle;                                                  // 0x0A50 (size: 0x8)
    bool ShouldSimulate;                                                              // 0x0A58 (size: 0x1)
    FTimerHandle ItemDecayTimerHandle;                                                // 0x0A60 (size: 0x8)
    float ItemDecayInterval;                                                          // 0x0A68 (size: 0x4)
    FTimerHandle CookTimer;                                                           // 0x0A70 (size: 0x8)
    class UNiagaraComponent* CookingParticleComp;                                     // 0x0A78 (size: 0x8)
    bool SpawnedFromProjectileImpact;                                                 // 0x0A80 (size: 0x1)
    float TimeToDespawn;                                                              // 0x0A84 (size: 0x4)
