#ifndef UE4SS_SDK_W_RadialWheel_Ammo_HPP
#define UE4SS_SDK_W_RadialWheel_Ammo_HPP

class UW_RadialWheel_Ammo_C : public UW_RadialWheel_ParentBP_C
{
    ...
    void ExecuteUbergraph_W_RadialWheel_Ammo(int32 EntryPoint);
}; // Size: 0x389
