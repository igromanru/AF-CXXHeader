...
{
    TArray<class UAISenseConfig*> SensesConfig;                                       // 0x00A8 (size: 0x10)
    TSubclassOf<class UAISense> DominantSense;                                        // 0x00B8 (size: 0x8)
    class AAIController* AIOwner;                                                     // 0x00D0 (size: 0x8)
    FAIPerceptionComponentOnPerceptionUpdated OnPerceptionUpdated;                    // 0x0158 (size: 0x10)
    void PerceptionUpdatedDelegate(const TArray<class AActor*>& UpdatedActors);
    FAIPerceptionComponentOnTargetPerceptionForgotten OnTargetPerceptionForgotten;    // 0x0168 (size: 0x10)
    void ActorPerceptionForgetUpdatedDelegate(class AActor* Actor);
    FAIPerceptionComponentOnTargetPerceptionUpdated OnTargetPerceptionUpdated;        // 0x0178 (size: 0x10)
    void ActorPerceptionUpdatedDelegate(class AActor* Actor, FAIStimulus Stimulus);
    FAIPerceptionComponentOnTargetPerceptionInfoUpdated OnTargetPerceptionInfoUpdated; // 0x0188 (size: 0x10)
...
{
    uint8 bAutoRegisterAsSource;                                                      // 0x00A8 (size: 0x1)
    TArray<class TSubclassOf<UAISense>> RegisterAsSourceForSenses;                    // 0x00B0 (size: 0x10)
...
{
    TArray<class UBTNode*> NodeInstances;                                             // 0x0120 (size: 0x10)
...
{
    class UBrainComponent* BrainComp;                                                 // 0x00A8 (size: 0x8)
    class UBlackboardData* DefaultBlackboardAsset;                                    // 0x00B0 (size: 0x8)
...
{
    class UBlackboardComponent* BlackboardComp;                                       // 0x00B0 (size: 0x8)
...
{
    FVector CrowdAgentMoveDirection;                                                  // 0x0300 (size: 0x18)
...
{
    class APawn* ControlledPawn;                                                      // 0x00A8 (size: 0x8)
    TArray<FPawnActionStack> ActionStacks;                                            // 0x00B0 (size: 0x10)
    TArray<FPawnActionEvent> ActionEvents;                                            // 0x00C0 (size: 0x10)
    class UDEPRECATED_PawnAction* CurrentAction;                                      // 0x00D0 (size: 0x8)
...
{
    class UNavLocalGridManager* GridManager;                                          // 0x02E8 (size: 0x8)
...
{
    class UNavMovementComponent* MovementComp;                                        // 0x00E0 (size: 0x8)
...
{
    float HearingThreshold;                                                           // 0x00A8 (size: 0x4)
    float LOSHearingThreshold;                                                        // 0x00AC (size: 0x4)
    float SightRadius;                                                                // 0x00B0 (size: 0x4)
    float SensingInterval;                                                            // 0x00B4 (size: 0x4)
    float HearingMaxSoundAge;                                                         // 0x00B8 (size: 0x4)
    uint8 bEnableSensingUpdates;                                                      // 0x00BC (size: 0x1)
    uint8 bOnlySensePlayers;                                                          // 0x00BC (size: 0x1)
    uint8 bSeePawns;                                                                  // 0x00BC (size: 0x1)
    uint8 bHearNoises;                                                                // 0x00BC (size: 0x1)
    FPawnSensingComponentOnSeePawn OnSeePawn;                                         // 0x00C8 (size: 0x10)
    void SeePawnDelegate(class APawn* Pawn);
    FPawnSensingComponentOnHearNoise OnHearNoise;                                     // 0x00D8 (size: 0x10)
    void HearNoiseDelegate(class APawn* Instigator, const FVector& Location, float Volume);
    float PeripheralVisionAngle;                                                      // 0x00E8 (size: 0x4)
    float PeripheralVisionCosine;                                                     // 0x00EC (size: 0x4)
