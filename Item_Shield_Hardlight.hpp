...
class AItem_Shield_Hardlight_C : public AItem_Shield_ParentBP_C
{
    ...
    class UPointLightComponent* PointLight;                                           // 0x0B88 (size: 0x8)
    class ULaserComponent_C* LaserComponent;                                          // 0x0B90 (size: 0x8)
    class URechargeableComponent_C* RechargeableComponent;                            // 0x0B98 (size: 0x8)
    bool IsLocalWeapon;                                                               // 0x0BA0 (size: 0x1)
    TArray<FHitResult> RecentHitArray;                                                // 0x0BA8 (size: 0x10)
    TArray<class TSubclassOf<UDamageType>> DamageTypes;                               // 0x0BB8 (size: 0x10)
    float DeflectedHitscanConeAngle;                                                  // 0x0BC8 (size: 0x4)
