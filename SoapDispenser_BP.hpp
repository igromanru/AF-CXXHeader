...
class ASoapDispenser_BP_C : public AAbioticActor_C
{
    ...
    class UAudioComponent* SoapAudio;                                                 // 0x02D8 (size: 0x8)
    class UStaticMeshComponent* SoapButton;                                           // 0x02E0 (size: 0x8)
    class UStaticMeshComponent* SoapDispenser;                                        // 0x02E8 (size: 0x8)
