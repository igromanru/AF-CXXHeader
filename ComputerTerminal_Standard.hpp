...
class AComputerTerminal_Standard_C : public AComputerTerminal_ParentBP_C
{
    ...
    class UWidgetComponent* OperatingSystemWidget;                                    // 0x0348 (size: 0x8)
    class UW_OperatingSystem_Main_C* OperatingSystemWidget_Ref;                       // 0x0350 (size: 0x8)
    bool HasBeenUsed;                                                                 // 0x0358 (size: 0x1)
    FTimerHandle HasBeenUsed_Timer;                                                   // 0x0360 (size: 0x8)
