...
{
    bool LastLiftWasSuccess;                                                          // 0x0929 (size: 0x1)
    TArray<class UStaticMesh*> WeightMeshes;                                          // 0x0930 (size: 0x10)
    TArray<class UStaticMeshComponent*> WeightSMComponents;                           // 0x0940 (size: 0x10)
    TArray<class UStaticMesh*> BaseWeightMeshes;                                      // 0x0950 (size: 0x10)
    int32 WeightsLevel;                                                               // 0x0960 (size: 0x4)
