...
class AAbiotic_AIDirector_C : public AActor
{
    ...
    class UNarrativeNPCDirectorComponent_C* NarrativeNPCDirector;                     // 0x02A0 (size: 0x8)
    class UTextRenderComponent* TextRender;                                           // 0x02A8 (size: 0x8)
    class USceneComponent* DefaultSceneRoot;                                          // 0x02B0 (size: 0x8)
    FTimerHandle Tick_PrioritySpawns;                                                 // 0x02B8 (size: 0x8)
    FTimerHandle Tick_DormantSpawns;                                                  // 0x02C0 (size: 0x8)
    bool CurrentFacilitySpawns;                                                       // 0x02C8 (size: 0x1)
    bool DirectorDebugOn;                                                             // 0x02C9 (size: 0x1)
    class ADayNightManager_C* DayNightManager;                                        // 0x02D0 (size: 0x8)
    bool DebugNoDayNightManager;                                                      // 0x02D8 (size: 0x1)
    TArray<class ANPC_Base_ParentBP_C*> NPCArray;                                     // 0x02E0 (size: 0x10)
    int32 NPCCap;                                                                     // 0x02F0 (size: 0x4)
    FTimerHandle Assault_Timer;                                                       // 0x02F8 (size: 0x8)
    TEnumAsByte<E_AssaultPhases::Type> Assault_CurrentPhase;                          // 0x0300 (size: 0x1)
    FAssault_Struct Assault_CurrentData;                                              // 0x0308 (size: 0xA8)
    FTimerHandle Assault_ActiveLogicTimer;                                            // 0x03B0 (size: 0x8)
    double Assault_TimeLastSpawnedNPC;                                                // 0x03B8 (size: 0x8)
    TArray<FVector> Assault_CurrentTargetLocation;                                    // 0x03C0 (size: 0x10)
    FVector Assault_BenchTargetLocation;                                              // 0x03D0 (size: 0x18)
    FVector Assault_PatrolTargetLocation;                                             // 0x03E8 (size: 0x18)
    FName Assault_CurrentRow;                                                         // 0x0400 (size: 0x8)
    int32 Assault_CurrentSpawnIndex;                                                  // 0x0408 (size: 0x4)
    TArray<FName> Assault_NPCList_Wave1;                                              // 0x0410 (size: 0x10)
    TArray<FName> Assault_NPCList_Wave2;                                              // 0x0420 (size: 0x10)
    TArray<FName> Assault_NPCList_Wave3;                                              // 0x0430 (size: 0x10)
    TArray<FName> Assault_NPCList_BossWave;                                           // 0x0440 (size: 0x10)
    double Assault_TimeOfInitialWarning;                                              // 0x0450 (size: 0x8)
    int32 Assault_PreviousSpawnIndex;                                                 // 0x0458 (size: 0x4)
    ...
    TMap<class FName, class FNarrativeNPCSpawns_Struct> NarrativeSpawns;              // 0x05F0 (size: 0x50)
    ...
    void SelectNewAssaultType(FName RowName, bool& FoundValidRow);
