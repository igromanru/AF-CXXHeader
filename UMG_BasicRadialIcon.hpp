...
class UUMG_BasicRadialIcon_C : public UUserWidget
{
    ...
    class USizeBox* Sizer;                                                            // 0x0300 (size: 0x8)
    class UTexture2D* IconImage;                                                      // 0x0308 (size: 0x8)
    double IconSize;                                                                  // 0x0310 (size: 0x8)
    FFBasicIconSettings Settings;                                                     // 0x0318 (size: 0x28)
    FLinearColor CurrentColor;                                                        // 0x0340 (size: 0x10)
    bool highlighted;                                                                 // 0x0350 (size: 0x1)
    double Alpha;                                                                     // 0x0358 (size: 0x8)
    bool UseItemMaterial;                                                             // 0x0360 (size: 0x1)
