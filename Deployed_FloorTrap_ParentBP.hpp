...
class ADeployed_FloorTrap_ParentBP_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class URechargeableComponent_C* RechargeableComponent;                            // 0x0928 (size: 0x8)
    class UBoxComponent* ColliderBox;                                                 // 0x0930 (size: 0x8)
    TSubclassOf<class UDamageType> TrapDamageType;                                    // 0x0938 (size: 0x8)
    TArray<FName> TrapDebuffs;                                                        // 0x0940 (size: 0x10)
    float TrapInitialDamage;                                                          // 0x0950 (size: 0x4)
    int32 BatteryAmountUsedOnTrigger;                                                 // 0x0954 (size: 0x4)
    bool IsActive;                                                                    // 0x0958 (size: 0x1)
