...
class ADeployed_Moisture_Teleporter_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UPointLightComponent* PointLight;                                           // 0x0880 (size: 0x8)
    class UStaticMeshComponent* Spinner;                                              // 0x0888 (size: 0x8)
    TArray<class ADeployed_LiquidContainer_ParentBP_C*> FoundContainers;              // 0x0890 (size: 0x10)
    int32 MaxLiquidLevel;                                                             // 0x08A0 (size: 0x4)
