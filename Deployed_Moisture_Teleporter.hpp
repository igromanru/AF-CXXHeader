...
class ADeployed_Moisture_Teleporter_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UAudioComponent* Audio;                                                     // 0x0938 (size: 0x8)
    class UPointLightComponent* PointLight;                                           // 0x0940 (size: 0x8)
    class UStaticMeshComponent* Spinner;                                              // 0x0948 (size: 0x8)
    TArray<class ADeployed_LiquidContainer_ParentBP_C*> FoundContainers;              // 0x0950 (size: 0x10)
    int32 MaxLiquidLevel;                                                             // 0x0960 (size: 0x4)
