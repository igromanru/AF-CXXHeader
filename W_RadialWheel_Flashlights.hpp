#ifndef UE4SS_SDK_W_RadialWheel_Flashlights_HPP
#define UE4SS_SDK_W_RadialWheel_Flashlights_HPP

class UW_RadialWheel_Flashlights_C : public UW_RadialWheel_ParentBP_C
{
    ...
    void ExecuteUbergraph_W_RadialWheel_Flashlights(int32 EntryPoint);
}; // Size: 0x388
