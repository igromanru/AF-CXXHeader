...
class UW_Inventory_HealthPanel_C : public UUserWidget
{
    ...
    class UUniformGridPanel* UGrid_MedicalItems;                                      // 0x0478 (size: 0x8)
    class UW_ButtonPromptHelperBar_C* W_ButtonPromptHelperBar;                        // 0x0480 (size: 0x8)
    class UW_HealthEntry_C* W_HealthEntry_Continence;                                 // 0x0488 (size: 0x8)
    class UW_HealthEntry_C* W_HealthEntry_Fatigue;                                    // 0x0490 (size: 0x8)
    class UW_HealthEntry_C* W_HealthEntry_Hunger;                                     // 0x0498 (size: 0x8)
    class UW_HealthEntry_LimbCategory_C* W_HealthEntry_LimbCategory;                  // 0x04A0 (size: 0x8)
    class UW_HealthEntry_LimbCategory_C* W_HealthEntry_LimbCategory_1;                // 0x04A8 (size: 0x8)
    class UW_HealthEntry_LimbCategory_C* W_HealthEntry_LimbCategory_2;                // 0x04B0 (size: 0x8)
    class UW_HealthEntry_LimbCategory_C* W_HealthEntry_LimbCategory_3;                // 0x04B8 (size: 0x8)
    class UW_HealthEntry_LimbCategory_C* W_HealthEntry_LimbCategory_4;                // 0x04C0 (size: 0x8)
    class UW_HealthEntry_LimbCategory_C* W_HealthEntry_LimbCategory_5;                // 0x04C8 (size: 0x8)
    class UW_HealthEntry_C* W_HealthEntry_Thirst;                                     // 0x04D0 (size: 0x8)
    class UW_HUD_TemperatureBar_C* W_HUD_TemperatureBar;                              // 0x04D8 (size: 0x8)
    class UImage* Wound_Head_Bleeding;                                                // 0x04E0 (size: 0x8)
    class UImage* Wound_LeftArm_Bleeding;                                             // 0x04E8 (size: 0x8)
    class UImage* Wound_LeftArm_BoneInjury;                                           // 0x04F0 (size: 0x8)
    class UImage* Wound_LeftLeg_Bleeding;                                             // 0x04F8 (size: 0x8)
    class UImage* Wound_LeftLeg_BoneInjury;                                           // 0x0500 (size: 0x8)
    class UImage* Wound_RightArm__BoneInjury;                                         // 0x0508 (size: 0x8)
    class UImage* Wound_RightArm_Bleeding;                                            // 0x0510 (size: 0x8)
    class UImage* Wound_RightLeg_Bleeding;                                            // 0x0518 (size: 0x8)
    class UImage* Wound_RightLeg_BoneInjury;                                          // 0x0520 (size: 0x8)
    class UImage* Wound_Torso_Bleeding;                                               // 0x0528 (size: 0x8)
    TEnumAsByte<ECriticalityLevels::Type> HeadStatus;                                 // 0x0530 (size: 0x1)
    TEnumAsByte<ECriticalityLevels::Type> TorsoStatus;                                // 0x0531 (size: 0x1)
    TEnumAsByte<ECriticalityLevels::Type> LeftArmStatus;                              // 0x0532 (size: 0x1)
    TEnumAsByte<ECriticalityLevels::Type> RightArmStatus;                             // 0x0533 (size: 0x1)
    TEnumAsByte<ECriticalityLevels::Type> LeftLegStatus;                              // 0x0534 (size: 0x1)
    TEnumAsByte<ECriticalityLevels::Type> RightLegStatus;                             // 0x0535 (size: 0x1)
    class UW_PlayerHUD_Main_C* ParentHUD;                                             // 0x0538 (size: 0x8)
    class AAbiotic_Character_ParentBP_C* OwningCharacter;                             // 0x0540 (size: 0x8)
    TArray<class UW_ClickableItemSlot_C*> MedicalItemButtons;                         // 0x0548 (size: 0x10)
    bool RanConstruct;                                                                // 0x0558 (size: 0x1)
    TArray<class UW_HealthEntry_C*> StaticStatusEntries;                              // 0x0560 (size: 0x10)
