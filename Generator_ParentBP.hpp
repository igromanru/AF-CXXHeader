...
class AGenerator_ParentBP_C : public AAbioticActor_C
{
    ...
    int32 GeneratorIndex;                                                             // 0x02C8 (size: 0x4)
    bool GeneratorPoweredOn;                                                          // 0x02CC (size: 0x1)
    FGenerator_ParentBP_CGeneratorStateChanged GeneratorStateChanged;                 // 0x02D0 (size: 0x10)
