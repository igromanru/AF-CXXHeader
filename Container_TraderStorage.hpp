...
class AContainer_TraderStorage_C : public ADeployed_Container_ParentBP_C
{
    ...
    float Timeline_NewTrack_0_BFA6EDC2495544D54B3485B86A24D911;                       // 0x0950 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline__Direction_BFA6EDC2495544D54B3485B86A24D911; // 0x0954 (size: 0x1)
    class UTimelineComponent* Timeline;                                               // 0x0958 (size: 0x8)
    FRotator A;                                                                       // 0x0960 (size: 0x18)
    FRotator B;                                                                       // 0x0978 (size: 0x18)
