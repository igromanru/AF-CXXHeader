...
class AItem_Gear_ParentBP_C : public AAbiotic_Item_ParentBP_C
{
    ...
    double CurrentDurabilityLeft;                                                     // 0x0B18 (size: 0x8)
    TArray<class UMaterialInstanceDynamic*> PlayerGearMeshMaterial;                   // 0x0B20 (size: 0x10)
    bool Equipped;                                                                    // 0x0B30 (size: 0x1)
