...
class AButton_Generic_C : public AAbioticActor_C
{
    ...
    class UStaticMeshComponent* ButtonMesh;                                           // 0x02E0 (size: 0x8)
    FVector ButtonOut;                                                                // 0x02E8 (size: 0x18)
    FVector ButtonIn;                                                                 // 0x0300 (size: 0x18)
    bool Activated;                                                                   // 0x0318 (size: 0x1)
    bool OneTimeUse;                                                                  // 0x0319 (size: 0x1)
    FButton_Generic_CButtonPressed ButtonPressed;                                     // 0x0320 (size: 0x10)
    void ButtonPressed(bool Activated);
    FText ButtonName;                                                                 // 0x0330 (size: 0x10)
    double ButtonCooldown;                                                            // 0x0340 (size: 0x8)
    double TimeOfLastButtonPress;                                                     // 0x0348 (size: 0x8)
    TArray<class AButton_Generic_C*> LinkedButtons;                                   // 0x0350 (size: 0x10)
    bool ButtonDisabled;                                                              // 0x0360 (size: 0x1)
    bool RequiresParentButtonToEnable;                                                // 0x0361 (size: 0x1)
    TArray<FWorldFlagRowHandle> WorldFlagRequirements;                                // 0x0368 (size: 0x10)
    FSaveData_ButtonStruct ButtonSaveData;                                            // 0x0378 (size: 0x38)
    class UMaterialInterface* Material_Active;                                        // 0x03B0 (size: 0x8)
    class UMaterialInterface* Material_Inactive;                                      // 0x03B8 (size: 0x8)
    class UMaterialInterface* Material_Disabled;                                      // 0x03C0 (size: 0x8)
    bool ToggleSwitch;                                                                // 0x03C8 (size: 0x1)
    class USoundBase* SFX_Deactivate;                                                 // 0x03D0 (size: 0x8)
    class USoundBase* SFX_Activate;                                                   // 0x03D8 (size: 0x8)
    bool HasPointLight;                                                               // 0x03E0 (size: 0x1)
    class AAbiotic_GenericDestructible_BP_C* DestructibleBlockingButtonUse;           // 0x03E8 (size: 0x8)
    class AAbioticActor_C* ParentPowerObject;                                         // 0x03F0 (size: 0x8)
    bool EndOfBetaNotice;                                                             // 0x03F8 (size: 0x1)
    bool ShouldSave;                                                                  // 0x03F9 (size: 0x1)
    bool ButtonAlwaysPowered;                                                         // 0x03FA (size: 0x1)
    class ADayNightManager_C* DayNightManager;                                        // 0x0400 (size: 0x8)
    class AAbiotic_Character_ParentBP_C* LastInteractCharacter;                       // 0x0408 (size: 0x8)
    FLinearColor Color_Disabled;                                                      // 0x0410 (size: 0x10)
    FLinearColor Color_Enabled;                                                       // 0x0420 (size: 0x10)
    bool IsChildActorButton;                                                          // 0x0430 (size: 0x1)
    bool ButtonWasForceSaved;                                                         // 0x0431 (size: 0x1)
