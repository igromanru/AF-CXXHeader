...
class AVehicle_Seat_Passenger_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class USceneComponent* SitSpot1;                                                  // 0x0878 (size: 0x8)
    bool DriverSeat;                                                                  // 0x0880 (size: 0x1)
    class UStaticMesh* SeatMesh;                                                      // 0x0888 (size: 0x8)
    bool ReplicationCollisionFixEnabled;                                              // 0x0890 (size: 0x1)
