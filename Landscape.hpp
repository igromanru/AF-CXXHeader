...
class ALandscapeProxy : public APartitionActor
{
    ...
    bool bDisableRuntimeGrassMapGeneration;                                           // 0x02E0 (size: 0x1)
    FIntPoint LandscapeSectionOffset;                                                 // 0x02E4 (size: 0x8)
    int32 MaxLODLevel;                                                                // 0x02EC (size: 0x4)
    float ComponentScreenSizeToUseSubSections;                                        // 0x02F0 (size: 0x4)
    float LOD0ScreenSize;                                                             // 0x02F4 (size: 0x4)
    uint32 LODGroupKey;                                                               // 0x02F8 (size: 0x4)
    float LOD0DistributionSetting;                                                    // 0x02FC (size: 0x4)
    float LODDistributionSetting;                                                     // 0x0300 (size: 0x4)
    FPerQualityLevelFloat ScalableLOD0ScreenSize;                                     // 0x0308 (size: 0x68)
    FPerQualityLevelFloat ScalableLOD0DistributionSetting;                            // 0x0370 (size: 0x68)
    FPerQualityLevelFloat ScalableLODDistributionSetting;                             // 0x03D8 (size: 0x68)
    bool bUseScalableLODSettings;                                                     // 0x0440 (size: 0x1)
    float LODBlendRange;                                                              // 0x0444 (size: 0x4)
    int32 StaticLightingLOD;                                                          // 0x0448 (size: 0x4)
    class UPhysicalMaterial* DefaultPhysMaterial;                                     // 0x0450 (size: 0x8)
    float StreamingDistanceMultiplier;                                                // 0x0458 (size: 0x4)
    class UMaterialInterface* LandscapeMaterial;                                      // 0x0460 (size: 0x8)
    class UMaterialInterface* LandscapeHoleMaterial;                                  // 0x0468 (size: 0x8)
    TArray<class URuntimeVirtualTexture*> RuntimeVirtualTextures;                     // 0x0470 (size: 0x10)
    bool bSetCreateRuntimeVirtualTextureVolumes;                                      // 0x0480 (size: 0x1)
    bool bVirtualTextureRenderWithQuad;                                               // 0x0481 (size: 0x1)
    bool bVirtualTextureRenderWithQuadHQ;                                             // 0x0482 (size: 0x1)
    int32 VirtualTextureNumLods;                                                      // 0x0484 (size: 0x4)
    int32 VirtualTextureLodBias;                                                      // 0x0488 (size: 0x4)
    ERuntimeVirtualTextureMainPassType VirtualTextureRenderPassType;                  // 0x048C (size: 0x1)
    float NegativeZBoundsExtension;                                                   // 0x0490 (size: 0x4)
    float PositiveZBoundsExtension;                                                   // 0x0494 (size: 0x4)
    TArray<class ULandscapeComponent*> LandscapeComponents;                           // 0x0498 (size: 0x10)
    TArray<class ULandscapeHeightfieldCollisionComponent*> CollisionComponents;       // 0x04A8 (size: 0x10)
    TArray<class UHierarchicalInstancedStaticMeshComponent*> FoliageComponents;       // 0x04B8 (size: 0x10)
    class ULandscapeNaniteComponent* NaniteComponent;                                 // 0x04C8 (size: 0x8)
    TArray<class ULandscapeNaniteComponent*> NaniteComponents;                        // 0x04D0 (size: 0x10)
    float GrassTypesMaxDiscardDistance;                                               // 0x0544 (size: 0x4)
    float StaticLightingResolution;                                                   // 0x0558 (size: 0x4)
    uint8 CastShadow;                                                                 // 0x055C (size: 0x1)
    uint8 bCastDynamicShadow;                                                         // 0x055C (size: 0x1)
    uint8 bCastStaticShadow;                                                          // 0x055C (size: 0x1)
    EShadowCacheInvalidationBehavior ShadowCacheInvalidationBehavior;                 // 0x055D (size: 0x1)
    uint8 bCastContactShadow;                                                         // 0x055E (size: 0x1)
    uint8 bCastFarShadow;                                                             // 0x0560 (size: 0x1)
    uint8 bCastHiddenShadow;                                                          // 0x0564 (size: 0x1)
    uint8 bCastShadowAsTwoSided;                                                      // 0x0568 (size: 0x1)
    uint8 bAffectDistanceFieldLighting;                                               // 0x056C (size: 0x1)
    FLightingChannels LightingChannels;                                               // 0x056D (size: 0x1)
    uint8 bUseMaterialPositionOffsetInStaticLighting;                                 // 0x0570 (size: 0x1)
    float NonNaniteVirtualShadowMapConstantDepthBias;                                 // 0x0574 (size: 0x4)
    float NonNaniteVirtualShadowMapInvalidationHeightErrorThreshold;                  // 0x0578 (size: 0x4)
    float NonNaniteVirtualShadowMapInvalidationScreenSizeLimit;                       // 0x057C (size: 0x4)
    uint8 bRenderCustomDepth;                                                         // 0x0580 (size: 0x1)
    ERendererStencilMask CustomDepthStencilWriteMask;                                 // 0x0584 (size: 0x1)
    int32 CustomDepthStencilValue;                                                    // 0x0588 (size: 0x4)
    float LDMaxDrawDistance;                                                          // 0x058C (size: 0x4)
    FLightmassPrimitiveSettings LightmassSettings;                                    // 0x0590 (size: 0x18)
    int32 CollisionMipLevel;                                                          // 0x05A8 (size: 0x4)
    int32 SimpleCollisionMipLevel;                                                    // 0x05AC (size: 0x4)
    FBodyInstance BodyInstance;                                                       // 0x05B0 (size: 0x198)
    uint8 bGenerateOverlapEvents;                                                     // 0x0748 (size: 0x1)
    uint8 bBakeMaterialPositionOffsetIntoCollision;                                   // 0x0748 (size: 0x1)
    int32 ComponentSizeQuads;                                                         // 0x074C (size: 0x4)
    int32 SubsectionSizeQuads;                                                        // 0x0750 (size: 0x4)
    int32 NumSubsections;                                                             // 0x0754 (size: 0x4)
    uint8 bUsedForNavigation;                                                         // 0x0758 (size: 0x1)
    uint8 bFillCollisionUnderLandscapeForNavmesh;                                     // 0x0758 (size: 0x1)
    ENavDataGatheringMode NavigationGeometryGatheringMode;                            // 0x075C (size: 0x1)
    bool bUseDynamicMaterialInstance;                                                 // 0x075D (size: 0x1)
    bool bUseLandscapeForCullingInvisibleHLODVertices;                                // 0x075E (size: 0x1)
    bool bHasLayersContent;                                                           // 0x075F (size: 0x1)
    bool bUseCompressedHeightmapStorage;                                              // 0x0760 (size: 0x1)
    bool bStripPhysicsWhenCookedClient;                                               // 0x0761 (size: 0x1)
    bool bStripPhysicsWhenCookedServer;                                               // 0x0762 (size: 0x1)
    bool bStripGrassWhenCookedClient;                                                 // 0x0763 (size: 0x1)
    bool bStripGrassWhenCookedServer;                                                 // 0x0764 (size: 0x1)
...
{
    TSoftObjectPtr<ALandscape> LandscapeActorRef;                                     // 0x0768 (size: 0x28)
    TSet<FName> OverriddenSharedProperties;                                           // 0x0790 (size: 0x50)
