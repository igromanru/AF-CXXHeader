...
class ADeployed_Container_FilingCabinet_Small_C : public ADeployed_Container_ParentBP_C
{
    ...
    float DrawerTimeline_NewTrack_0_777ECCD64B2C9C19C7244EA75DD8B2C5;                 // 0x0A08 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> DrawerTimeline__Direction_777ECCD64B2C9C19C7244EA75DD8B2C5; // 0x0A0C (size: 0x1)
    class UTimelineComponent* DrawerTimeline;                                         // 0x0A10 (size: 0x8)
    FVector Drawer_Closed;                                                            // 0x0A18 (size: 0x18)
    FVector Drawer_Open;                                                              // 0x0A30 (size: 0x18)
