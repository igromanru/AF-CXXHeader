#ifndef UE4SS_SDK_W_RecipeBookEntryButton_Long_HPP
#define UE4SS_SDK_W_RecipeBookEntryButton_Long_HPP

class UW_RecipeBookEntryButton_Long_C : public UUserWidget
{
    ...
    FW_RecipeBookEntryButton_Long_CNeverCraftedStatusUpdate NeverCraftedStatusUpdate; // 0x0378 (size: 0x10)
    ...
    void ExecuteUbergraph_W_RecipeBookEntryButton_Long(int32 EntryPoint);
