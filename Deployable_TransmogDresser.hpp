...
class ADeployable_TransmogDresser_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class USceneComponent* TmogButtonPrompt1;                                         // 0x0938 (size: 0x8)
    class USceneComponent* TmogButtonPrompt;                                          // 0x0940 (size: 0x8)
    class UStaticMeshComponent* TmogMesh;                                             // 0x0948 (size: 0x8)
    class UStaticMeshComponent* CustomizeMesh;                                        // 0x0950 (size: 0x8)
    class UChildActorComponent* CharacterCustomization;                               // 0x0958 (size: 0x8)
    class UActorComponent* LastHitComponent;                                          // 0x0960 (size: 0x8)
    bool UsingTransmog;                                                               // 0x0968 (size: 0x1)
