...
class AContainer_LaserCollector_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UStaticMeshComponent* Battery8;                                             // 0x0878 (size: 0x8)
    class UStaticMeshComponent* Battery7;                                             // 0x0880 (size: 0x8)
    class UStaticMeshComponent* Battery6;                                             // 0x0888 (size: 0x8)
    class UStaticMeshComponent* Battery5;                                             // 0x0890 (size: 0x8)
    class UStaticMeshComponent* Battery4;                                             // 0x0898 (size: 0x8)
    class UStaticMeshComponent* Battery3;                                             // 0x08A0 (size: 0x8)
    class UStaticMeshComponent* Battery2;                                             // 0x08A8 (size: 0x8)
    class UStaticMeshComponent* Battery1;                                             // 0x08B0 (size: 0x8)
    class UPointLightComponent* PointLight;                                           // 0x08B8 (size: 0x8)
    class UStaticMeshComponent* ReceiverPort;                                         // 0x08C0 (size: 0x8)
    TEnumAsByte<E_LaserCollectorState::Type> CollectionState;                         // 0x08C8 (size: 0x1)
    int32 CurrentLaserInContainer;                                                    // 0x08CC (size: 0x4)
    int32 MaxLaser;                                                                   // 0x08D0 (size: 0x4)
    int32 LaserGainRate;                                                              // 0x08D4 (size: 0x4)
    FTimerHandle LaserCollectionTimer;                                                // 0x08D8 (size: 0x8)
