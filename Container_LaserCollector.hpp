...
class AContainer_LaserCollector_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UStaticMeshComponent* Battery8;                                             // 0x0938 (size: 0x8)
    class UStaticMeshComponent* Battery7;                                             // 0x0940 (size: 0x8)
    class UStaticMeshComponent* Battery6;                                             // 0x0948 (size: 0x8)
    class UStaticMeshComponent* Battery5;                                             // 0x0950 (size: 0x8)
    class UStaticMeshComponent* Battery4;                                             // 0x0958 (size: 0x8)
    class UStaticMeshComponent* Battery3;                                             // 0x0960 (size: 0x8)
    class UStaticMeshComponent* Battery2;                                             // 0x0968 (size: 0x8)
    class UStaticMeshComponent* Battery1;                                             // 0x0970 (size: 0x8)
    class UPointLightComponent* PointLight;                                           // 0x0978 (size: 0x8)
    class UStaticMeshComponent* ReceiverPort;                                         // 0x0980 (size: 0x8)
    TEnumAsByte<E_LaserCollectorState::Type> CollectionState;                         // 0x0988 (size: 0x1)
    int32 CurrentLaserInContainer;                                                    // 0x098C (size: 0x4)
    int32 MaxLaser;                                                                   // 0x0990 (size: 0x4)
    int32 LaserGainRate;                                                              // 0x0994 (size: 0x4)
    FTimerHandle LaserCollectionTimer;                                                // 0x0998 (size: 0x8)
