...
class UW_Inventory_EquipSlots_C : public UUserWidget
{
    ...
    class UW_InventoryItemSlot_C* EquipSlot_Companion;                                // 0x0338 (size: 0x8)
    class UW_InventoryItemSlot_C* EquipSlot_HackingDevice;                            // 0x0340 (size: 0x8)
    class UW_InventoryItemSlot_C* EquipSlot_Head;                                     // 0x0348 (size: 0x8)
    class UW_InventoryItemSlot_C* EquipSlot_Headlamp;                                 // 0x0350 (size: 0x8)
    class UW_InventoryItemSlot_C* EquipSlot_Legs;                                     // 0x0358 (size: 0x8)
    class UImage* EquipSlot_Pager;                                                    // 0x0360 (size: 0x8)
    class UW_InventoryItemSlot_C* EquipSlot_Shield;                                   // 0x0368 (size: 0x8)
    class UW_InventoryItemSlot_C* EquipSlot_Suit;                                     // 0x0370 (size: 0x8)
    class UW_InventoryItemSlot_C* EquipSlot_Torso;                                    // 0x0378 (size: 0x8)
    class UW_InventoryItemSlot_C* EquipSlot_Trinket;                                  // 0x0380 (size: 0x8)
    class UW_InventoryItemSlot_C* EquipSlot_Trinket2;                                 // 0x0388 (size: 0x8)
    class UW_InventoryItemSlot_C* EquipSlot_Wristwatch;                               // 0x0390 (size: 0x8)
