...
class UW_Inventory_EquipSlots_C : public UUserWidget
{
    ...
    class UW_InventoryItemSlot_C* EquipSlot_Necklace;                                 // 0x0358 (size: 0x8)
    class UW_InventoryItemSlot_C* EquipSlot_Necklace_2;                               // 0x0360 (size: 0x8)
    class UImage* EquipSlot_Pager;                                                    // 0x0368 (size: 0x8)
    class UW_InventoryItemSlot_C* EquipSlot_Shield;                                   // 0x0370 (size: 0x8)
    class UW_InventoryItemSlot_C* EquipSlot_Suit;                                     // 0x0378 (size: 0x8)
    class UW_InventoryItemSlot_C* EquipSlot_Torso;                                    // 0x0380 (size: 0x8)
    class UW_InventoryItemSlot_C* EquipSlot_Wristwatch;                               // 0x0388 (size: 0x8)
    class UImage* Image_0;                                                            // 0x0390 (size: 0x8)
    class UButton* PageLocationButton;                                                // 0x0398 (size: 0x8)
    class UCanvasPanel* Pane;                                                         // 0x03A0 (size: 0x8)
    class UTextBlock* PhDText;                                                        // 0x03A8 (size: 0x8)
    class UTextBlock* PlayerNameText;                                                 // 0x03B0 (size: 0x8)
    class UW_HUD_TemperatureBar_C* W_HUD_TemperatureBar;                              // 0x03B8 (size: 0x8)
    class UW_Inventory_3DCharacter_C* W_Inventory_3DCharacter;                        // 0x03C0 (size: 0x8)
    class UW_TransmogToggleButton_C* W_TransmogToggleButton_Arms;                     // 0x03C8 (size: 0x8)
    class UW_TransmogToggleButton_C* W_TransmogToggleButton_Chest;                    // 0x03D0 (size: 0x8)
    class UW_TransmogToggleButton_C* W_TransmogToggleButton_Head;                     // 0x03D8 (size: 0x8)
    class UW_TransmogToggleButton_C* W_TransmogToggleButton_Legs;                     // 0x03E0 (size: 0x8)
    class UW_TransmogToggleButton_C* W_TransmogToggleButton_Suit;                     // 0x03E8 (size: 0x8)
    class UImage* Weight_BG;                                                          // 0x03F0 (size: 0x8)
    class UImage* Weight_Glass;                                                       // 0x03F8 (size: 0x8)
    class UImage* Weight_HookChain;                                                   // 0x0400 (size: 0x8)
    class UImage* Weight_Needle;                                                      // 0x0408 (size: 0x8)
    class UImage* Weight_Scale;                                                       // 0x0410 (size: 0x8)
    class UImage* Weight_Trim;                                                        // 0x0418 (size: 0x8)
    TArray<class UW_InventoryItemSlot_C*> CharacterEquipmentSlots;                    // 0x0420 (size: 0x10)
    class UW_PlayerInventory_Main_C* ParentInventoryWidget;                           // 0x0430 (size: 0x8)
