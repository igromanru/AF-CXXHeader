...
class ADeployed_FloorPoop_C : public AAbioticDeployed_ParentBP_C
{
    ...
    class UNiagaraComponent* Niagara_Stench_Small;                                    // 0x0560 (size: 0x8)
    class USphereComponent* SmellySphere;                                             // 0x0568 (size: 0x8)
    class UStaticMeshComponent* PoopMesh;                                             // 0x0570 (size: 0x8)
    FName ItemClass;                                                                  // 0x0578 (size: 0x8)
