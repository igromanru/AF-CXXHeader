...
class AWorldFlagFX_BP_C : public AAbioticActor_C
{
    ...
    class UTextRenderComponent* WF_Deac;                                              // 0x02C8 (size: 0x8)
    class UTextRenderComponent* WF_Act;                                               // 0x02D0 (size: 0x8)
    ...
    FWorldFlagRowHandle ActivationFlag;                                               // 0x02F0 (size: 0x20)
    FWorldFlagRowHandle DeactivationFlag;                                             // 0x0310 (size: 0x20)
    double SoundFadeInTime;                                                           // 0x0330 (size: 0x8)
