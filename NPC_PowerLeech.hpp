...
class ANPC_PowerLeech_C : public ANPC_Base_ParentBP_C
{
    ...
    class UAudioComponent* PowerDrain_Loop;                                           // 0x21B8 (size: 0x8)
    class AActor* LinkedPowerSource;                                                  // 0x21C0 (size: 0x8)
    class UAudioComponent* LaserLoopSound;                                            // 0x21C8 (size: 0x8)
    FVector RotationOrigin;                                                           // 0x21D0 (size: 0x18)
    double RotationProgress;                                                          // 0x21E8 (size: 0x8)
    double RotationSpeed;                                                             // 0x21F0 (size: 0x8)
    FVector PreviousLocation;                                                         // 0x21F8 (size: 0x18)
    float RotationOriginUpdateFrequency;                                              // 0x2210 (size: 0x4)
    FTimerHandle RotationUpdateTimerHandle;                                           // 0x2218 (size: 0x8)
    float PlayerZapDistance;                                                          // 0x2220 (size: 0x4)
    float PlayerZapDamage;                                                            // 0x2224 (size: 0x4)
    bool UseSpinningMovement;                                                         // 0x2228 (size: 0x1)
    float FurnitureZapDistance;                                                       // 0x222C (size: 0x4)
    float PlayerZagInterval;                                                          // 0x2230 (size: 0x4)
    bool DestroyedByPortalSuppression;                                                // 0x2234 (size: 0x1)
    bool CanBeDestroyedByBenchSuppression;                                            // 0x2235 (size: 0x1)
    class UNiagaraComponent* Beam;                                                    // 0x2238 (size: 0x8)
    bool PowerDraining;                                                               // 0x2240 (size: 0x1)
