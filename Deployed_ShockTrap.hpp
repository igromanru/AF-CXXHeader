...
class ADeployed_ShockTrap_C : public ADeployed_FloorTrap_ParentBP_C
{
    ...
    class UNiagaraComponent* Niagara_Electricity;                                     // 0x0978 (size: 0x8)
    class UNiagaraComponent* Sparks_04;                                               // 0x0980 (size: 0x8)
    class UNiagaraComponent* Sparks_01;                                               // 0x0988 (size: 0x8)
    class UNiagaraComponent* Sparks_02;                                               // 0x0990 (size: 0x8)
    class UNiagaraComponent* Sparks_03;                                               // 0x0998 (size: 0x8)
    FTimerHandle ShockTrapTimer;                                                      // 0x09A0 (size: 0x8)
    int32 CountdownTimer;                                                             // 0x09A8 (size: 0x4)
