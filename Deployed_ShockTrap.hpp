...
class ADeployed_ShockTrap_C : public ADeployed_FloorTrap_ParentBP_C
{
    ...
    class UNiagaraComponent* Niagara_Electricity;                                     // 0x08B8 (size: 0x8)
    class UNiagaraComponent* Sparks_04;                                               // 0x08C0 (size: 0x8)
    class UNiagaraComponent* Sparks_01;                                               // 0x08C8 (size: 0x8)
    class UNiagaraComponent* Sparks_02;                                               // 0x08D0 (size: 0x8)
    class UNiagaraComponent* Sparks_03;                                               // 0x08D8 (size: 0x8)
    FTimerHandle ShockTrapTimer;                                                      // 0x08E0 (size: 0x8)
    int32 CountdownTimer;                                                             // 0x08E8 (size: 0x4)
