...
class ANPC_Monster_Reaper_C : public ANPC_Base_ParentBP_C
{
    ...
    class UAudioComponent* Audio;                                                     // 0x21C0 (size: 0x8)
    class UNiagaraComponent* DissolveParticle;                                        // 0x21C8 (size: 0x8)
    class UNiagaraComponent* Niagara;                                                 // 0x21D0 (size: 0x8)
    class USphereComponent* Sphere;                                                   // 0x21D8 (size: 0x8)
    float Timeline_0_NewTrack_1_62DF85804DA176A7E0F38A941D8B76E6;                     // 0x21E0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_0__Direction_62DF85804DA176A7E0F38A941D8B76E6; // 0x21E4 (size: 0x1)
    class UTimelineComponent* Timeline_0;                                             // 0x21E8 (size: 0x8)
    float EmissiveTimeline_Alpha_BE84A34447F20897B129359E909AF44D;                    // 0x21F0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> EmissiveTimeline__Direction_BE84A34447F20897B129359E909AF44D; // 0x21F4 (size: 0x1)
    class UTimelineComponent* EmissiveTimeline;                                       // 0x21F8 (size: 0x8)
    int32 ElectronicsDisrupted;                                                       // 0x2200 (size: 0x4)
    double TimeLastDroppedEssence;                                                    // 0x2208 (size: 0x8)
    int32 DisruptionsToDropEssence;                                                   // 0x2210 (size: 0x4)
    FName CustomGrabTraceSocket;                                                      // 0x2214 (size: 0x8)
    class AReaperDirector_Security_C* ReaperDirector;                                 // 0x2220 (size: 0x8)
    int32 StaggerDespawnCount;                                                        // 0x2228 (size: 0x4)
