...
class ACharacterCorpse_Human_BP_C : public ACharacterCorpse_ParentBP_C
{
    ...
    class USkeletalMeshComponent* LegArmor;                                           // 0x0428 (size: 0x8)
    class USkeletalMeshComponent* ChestArmor;                                         // 0x0430 (size: 0x8)
    class UHumanCustomizationComponent_C* HumanCustomizationComponent;                // 0x0438 (size: 0x8)
    class USkeletalMeshComponent* Legs;                                               // 0x0440 (size: 0x8)
    class USkeletalMeshComponent* Torso;                                              // 0x0448 (size: 0x8)
    bool CombineMeshes;                                                               // 0x0450 (size: 0x1)
    FName CachedMeshName;                                                             // 0x0454 (size: 0x8)
