...
class ANPC_Zombie_C : public ANPC_Base_ParentBP_C
{
    ...
    class UStaticMeshComponent* IDCardMesh;                                           // 0x21C0 (size: 0x8)
    class UStaticMeshComponent* backpack;                                             // 0x21C8 (size: 0x8)
    class USkeletalMeshComponent* hair;                                               // 0x21D0 (size: 0x8)
    class USkeletalMeshComponent* Hat;                                                // 0x21D8 (size: 0x8)
    class UHumanCustomizationComponent_C* HumanCustomizationComponent;                // 0x21E0 (size: 0x8)
    class USkeletalMeshComponent* Legs;                                               // 0x21E8 (size: 0x8)
    class USkeletalMeshComponent* Chest;                                              // 0x21F0 (size: 0x8)
    bool Eating;                                                                      // 0x21F8 (size: 0x1)
    class UAudioComponent* EatingAudio;                                               // 0x2200 (size: 0x8)
    bool HeadExplode;                                                                 // 0x2208 (size: 0x1)
    TArray<FName> ZombieHeads;                                                        // 0x2210 (size: 0x10)
    TArray<FName> ZombieTorsos;                                                       // 0x2220 (size: 0x10)
    TArray<FName> ZombieLegs;                                                         // 0x2230 (size: 0x10)
    TArray<FName> ZombieBelts;                                                        // 0x2240 (size: 0x10)
    TArray<FName> ZombieShoes;                                                        // 0x2250 (size: 0x10)
    TArray<FName> ZombieShirtColors;                                                  // 0x2260 (size: 0x10)
    TArray<FName> PotentialHats;                                                      // 0x2270 (size: 0x10)
    FName SelectedHat;                                                                // 0x2280 (size: 0x8)
    TArray<FName> PotentialBackpacks;                                                 // 0x2288 (size: 0x10)
    FName SelectedBackpack;                                                           // 0x2298 (size: 0x8)
    TArray<FName> ZombieHairTypes;                                                    // 0x22A0 (size: 0x10)
    TArray<FName> ZombieHairColors;                                                   // 0x22B0 (size: 0x10)
    FName HatTextureVariant;                                                          // 0x22C0 (size: 0x8)
    FName BackpackTextureVariant;                                                     // 0x22C8 (size: 0x8)
    TArray<FName> ZombieHeadAccessories;                                              // 0x22D0 (size: 0x10)
    double HatDropRate;                                                               // 0x22E0 (size: 0x8)
    double BackpackDropRate;                                                          // 0x22E8 (size: 0x8)
