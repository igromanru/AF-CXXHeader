...
class AGardenPlot_ParentBP_C : public ADeployed_LiquidContainer_ParentBP_C
{
    ...
    class UStaticMeshComponent* WarningLight;                                         // 0x0A08 (size: 0x8)
    class UDecalComponent* Decal;                                                     // 0x0A10 (size: 0x8)
    class UStaticMeshComponent* WaterLevel_Box;                                       // 0x0A18 (size: 0x8)
    class UAbiotic_InventoryComponent_C* ContainerInventory;                          // 0x0A20 (size: 0x8)
    TArray<class AFarmingPlot_BP_C*> FarmingPlots;                                    // 0x0A28 (size: 0x10)
    double WaterTickRate;                                                             // 0x0A38 (size: 0x8)
    int32 WaterLossPerTick;                                                           // 0x0A40 (size: 0x4)
    FTimerHandle WaterTimerHandle;                                                    // 0x0A48 (size: 0x8)
    bool WaterRequiredLight;                                                          // 0x0A50 (size: 0x1)
