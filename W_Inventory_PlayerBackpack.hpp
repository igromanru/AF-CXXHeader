...
class UW_Inventory_PlayerBackpack_C : public UUserWidget
{
    ...
    class UTextBlock* InvDebugText;                                                   // 0x0300 (size: 0x8)
    class UTextBlock* InventoryBackpackText;                                          // 0x0308 (size: 0x8)
    class UTextBlock* MoneyText;                                                      // 0x0310 (size: 0x8)
    class UW_InventoryGrid_C* W_BackpackGrid;                                         // 0x0318 (size: 0x8)
    class UW_ButtonPromptHelperBar_C* W_ButtonPromptHelperBar;                        // 0x0320 (size: 0x8)
    class UW_InventoryWeight_C* W_InventoryWeight;                                    // 0x0328 (size: 0x8)
    class UTextBlock* WeightNumberText;                                               // 0x0330 (size: 0x8)
    class UW_PlayerInventory_Main_C* ParentInventoryWidget;                           // 0x0338 (size: 0x8)
    double CurrentWeight;                                                             // 0x0340 (size: 0x8)
    class UWidget* Temp Slot;                                                         // 0x0348 (size: 0x8)
    TArray<class UWidget*> SortedGridSlots;                                           // 0x0350 (size: 0x10)
    int32 Index;                                                                      // 0x0360 (size: 0x4)
    float LiquidWeightMultiplier;                                                     // 0x0364 (size: 0x4)
