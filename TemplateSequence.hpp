...
{
    FMovieSceneSequencePlaybackSettings PlaybackSettings;                             // 0x02A0 (size: 0x28)
    class UTemplateSequencePlayer* SequencePlayer;                                    // 0x02C8 (size: 0x8)
    FSoftObjectPath TemplateSequence;                                                 // 0x02D0 (size: 0x20)
    FTemplateSequenceBindingOverrideData BindingOverride;                             // 0x02F0 (size: 0xC)
