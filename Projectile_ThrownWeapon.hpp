...
class AProjectile_ThrownWeapon_C : public AAbioticProjectile_ParentBP_C
{
    ...
    FAbiotic_WeaponStruct WeaponData;                                                 // 0x0738 (size: 0x1A0)
    FDataTableRowHandle ItemDataRow;                                                  // 0x08D8 (size: 0x10)
    FInventorySlotSelected_Struct OriginalHotbarSlot;                                 // 0x08E8 (size: 0x10)
    float ReturnDelay;                                                                // 0x08F8 (size: 0x4)
    class AAbiotic_Item_Dropped_C* SpawnedItem;                                       // 0x0900 (size: 0x8)
    float ReturnMaxDespawnTime;                                                       // 0x0908 (size: 0x4)
