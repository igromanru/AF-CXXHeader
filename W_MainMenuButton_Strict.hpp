#ifndef UE4SS_SDK_W_MainMenuButton_Strict_HPP
#define UE4SS_SDK_W_MainMenuButton_Strict_HPP

class UW_MainMenuButton_Strict_C : public UUserWidget
{
    ...
    class USizeBox* IconSizeBox;                                                      // 0x0310 (size: 0x8)
    class USizeBox* SizeBox_137;                                                      // 0x0318 (size: 0x8)
    FText ButtonText;                                                                 // 0x0320 (size: 0x10)
    FW_MainMenuButton_Strict_CButtonPressed ButtonPressed;                            // 0x0330 (size: 0x10)
    void ButtonPressed();
    FText OriginalText;                                                               // 0x0340 (size: 0x10)
    FLinearColor DefaultTextColor;                                                    // 0x0350 (size: 0x10)
    TEnumAsByte<EHorizontalAlignment> TextJustification;                              // 0x0360 (size: 0x1)
    class UTexture2D* Icon;                                                           // 0x0368 (size: 0x8)
    FLinearColor HoverColor;                                                          // 0x0370 (size: 0x10)
    ...
    void ExecuteUbergraph_W_MainMenuButton_Strict(int32 EntryPoint);
