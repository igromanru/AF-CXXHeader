...
class AAbiotic_PlayerController_C : public AAbioticPlayerController
{
    ...
    class UPlayerController_WaypointManagerComponent_C* PlayerController_WaypointManagerComponent; // 0x0888 (size: 0x8)
    class UAudioComponent* NPCMusic;                                                  // 0x0890 (size: 0x8)
    class UAudioComponent* NPCRadioAudio;                                             // 0x0898 (size: 0x8)
    class UCheatComponent_C* CheatComponent;                                          // 0x08A0 (size: 0x8)
    float EndCredits_FadeAudio_NewTrack_0_CDED426346DDEA1919651594D659DD6B;           // 0x08A8 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> EndCredits_FadeAudio__Direction_CDED426346DDEA1919651594D659DD6B; // 0x08AC (size: 0x1)
    class UTimelineComponent* EndCredits_FadeAudio;                                   // 0x08B0 (size: 0x8)
    float CursorInterpTimeline_Alpha_50F311B84F055D70817F88AF3E379DAF;                // 0x08B8 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> CursorInterpTimeline__Direction_50F311B84F055D70817F88AF3E379DAF; // 0x08BC (size: 0x1)
    class UTimelineComponent* CursorInterpTimeline;                                   // 0x08C0 (size: 0x8)
    float NewFXTimeline_FXTime_C8276CED400572E6FD10CF8A61D816D7;                      // 0x08C8 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> NewFXTimeline__Direction_C8276CED400572E6FD10CF8A61D816D7; // 0x08CC (size: 0x1)
    class UTimelineComponent* NewFXTimeline;                                          // 0x08D0 (size: 0x8)
    class UW_PlayerHUD_Main_C* PlayerHUDRef;                                          // 0x08D8 (size: 0x8)
    bool IsTextChatOpen;                                                              // 0x08E0 (size: 0x1)
    class UW_MainMenu_Master_C* MainMenuRef;                                          // 0x08E8 (size: 0x8)
    class UAudioComponent* CurrentSoundtrackMusic;                                    // 0x08F0 (size: 0x8)
    TEnumAsByte<E_CursorMode::Type> AbioticCursorMode;                                // 0x08F8 (size: 0x1)
    class UDraggableItem_Operation_C* CurrentItemOnCursor;                            // 0x0900 (size: 0x8)
    double LastMouseGrabItemTime;                                                     // 0x0908 (size: 0x8)
    class ADirectionalLight* Global_DirectionalLight;                                 // 0x0910 (size: 0x8)
    class AAbioticSkylight_C* Global_SkyLight;                                        // 0x0918 (size: 0x8)
    class AExponentialHeightFog* Global_AtmoFog;                                      // 0x0920 (size: 0x8)
    FLevelFXData_Struct CurrentDaytimeFX;                                             // 0x0928 (size: 0x168)
    FLevelFXData_Struct CurrentNighttimeFX;                                           // 0x0A90 (size: 0x168)
    FLevelFXData_Struct PreviousDaytimeFX;                                            // 0x0BF8 (size: 0x168)
    FLevelFXData_Struct PreviousNighttimeFX;                                          // 0x0D60 (size: 0x168)
    class ADayNightManager_C* DayNightManager;                                        // 0x0EC8 (size: 0x8)
    FName Day_FX_Row;                                                                 // 0x0ED0 (size: 0x8)
    FName Night_FX_Row;                                                               // 0x0ED8 (size: 0x8)
    bool GlobalActorsFound;                                                           // 0x0EE0 (size: 0x1)
    bool NextSoundtrackLoaded;                                                        // 0x0EE1 (size: 0x1)
    FName PreviousDayFXRow;                                                           // 0x0EE4 (size: 0x8)
    FName PreviousNightFXRow;                                                         // 0x0EEC (size: 0x8)
    class AAbiotic_PlayerCharacter_C* MyPlayerCharacter;                              // 0x0EF8 (size: 0x8)
    class UW_CheatMenu_C* CheatMenu;                                                  // 0x0F00 (size: 0x8)
    bool Location_FoundNewSectorName;                                                 // 0x0F08 (size: 0x1)
    FText Location_PreviousSectorName;                                                // 0x0F10 (size: 0x10)
    FText Location_CurrentSectorName;                                                 // 0x0F20 (size: 0x10)
    bool ContinenceMinigameActive;                                                    // 0x0F30 (size: 0x1)
    double ContinenceMinigameSliderValue;                                             // 0x0F38 (size: 0x8)
    bool ContinenceMinigame_MoveLeft;                                                 // 0x0F40 (size: 0x1)
    double ContinenceMinigame_BigWindowL;                                             // 0x0F48 (size: 0x8)
    double ContinenceMinigame_BigWindowR;                                             // 0x0F50 (size: 0x8)
    double ContinenceMinigame_SmallWindowL;                                           // 0x0F58 (size: 0x8)
    double ContinenceMinigame_SmallWindowR;                                           // 0x0F60 (size: 0x8)
    class UW_HUD_ContinenceMinigame_C* ContinenceMinigameWidget;                      // 0x0F68 (size: 0x8)
    bool ContinenceMinigame_Paused;                                                   // 0x0F70 (size: 0x1)
    int32 ContinenceMinigame_Counter;                                                 // 0x0F74 (size: 0x4)
    FTimerHandle Timer_AutoSaveCharacter;                                             // 0x0F78 (size: 0x8)
    int32 CheatAttempt;                                                               // 0x0F80 (size: 0x4)
    class AMinigame_SleepRunner_BP_C* Sidescoller Minigame Actor;                     // 0x0F88 (size: 0x8)
    class UAudioComponent* CurrentAmbientTrack;                                       // 0x0F90 (size: 0x8)
    bool IsOnMousePressed;                                                            // 0x0F98 (size: 0x1)
    bool IsCurrentlyDraggingItemSlot;                                                 // 0x0F99 (size: 0x1)
    TSet<FName> CraftableItemsList;                                                   // 0x0FA0 (size: 0x50)
    TArray<FName> HintsSeen;                                                          // 0x0FF0 (size: 0x10)
    FString BugReportURL;                                                             // 0x1000 (size: 0x10)
    double LastLevelFXTransitionTime;                                                 // 0x1010 (size: 0x8)
    class A3D_ItemDisplay_BP_C* 3DItemDisplayActor;                                   // 0x1018 (size: 0x8)
    TSoftObjectPtr<UWorld> CurrentFXLevel;                                            // 0x1020 (size: 0x28)
    FTimerHandle InteractionHeldTimer;                                                // 0x1048 (size: 0x8)
    FName HeldTimer_LastTutorialPanelRow;                                             // 0x1050 (size: 0x8)
    FAbiotic_PlayerController_CHeldInteractStarted HeldInteractStarted;               // 0x1058 (size: 0x10)
    void HeldInteractStarted(double InteractionDuration);
    FAbiotic_PlayerController_CHeldInteractEnded HeldInteractEnded;                   // 0x1068 (size: 0x10)
    void HeldInteractEnded();
    bool NextAmbientSoundLoaded;                                                      // 0x1078 (size: 0x1)
    FVector LastRadioLocation;                                                        // 0x1080 (size: 0x18)
    double NPC_Radio_MaxVolume;                                                       // 0x1098 (size: 0x8)
    FAbiotic_PlayerController_CItemDragStarted ItemDragStarted;                       // 0x10A0 (size: 0x10)
    void ItemDragStarted(TEnumAsByte<E_InventorySlotType::Type> Item Type);
    FAbiotic_PlayerController_CItemDragFinished ItemDragFinished;                     // 0x10B0 (size: 0x10)
    void ItemDragFinished();
    bool ClientHasRecievedCharacter;                                                  // 0x10C0 (size: 0x1)
    bool TriedFindGlobalActorsOnce;                                                   // 0x10C1 (size: 0x1)
    bool IsDebugLevel;                                                                // 0x10C2 (size: 0x1)
    bool StartupFadeActive;                                                           // 0x10C3 (size: 0x1)
    FName ActiveLevelFXName;                                                          // 0x10C4 (size: 0x8)
    FName ActiveSubFXName;                                                            // 0x10CC (size: 0x8)
    FName ActiveWeatherFXName;                                                        // 0x10D4 (size: 0x8)
    FName OverrideLevelFXName;                                                        // 0x10DC (size: 0x8)
    FName CheatLevelFXName;                                                           // 0x10E4 (size: 0x8)
    bool DisableAutomaticFX;                                                          // 0x10EC (size: 0x1)
    class UW_MainMenu_CustomizeCharacter_C* TransmogCustomizationHUD;                 // 0x10F0 (size: 0x8)
    FString ForumLinkURL;                                                             // 0x10F8 (size: 0x10)
    double Local_LastSoundtrackChange;                                                // 0x1108 (size: 0x8)
    TArray<FString> CachedBannedPlayers;                                              // 0x1110 (size: 0x10)
    bool IsModerator;                                                                 // 0x1120 (size: 0x1)
    bool RadioTalking;                                                                // 0x1121 (size: 0x1)
    bool PushToTalkPressed;                                                           // 0x1122 (size: 0x1)
    bool InventoryHasRadio;                                                           // 0x1123 (size: 0x1)
    bool HotbarHasRadio;                                                              // 0x1124 (size: 0x1)
    FString ActiveLevelName;                                                          // 0x1128 (size: 0x10)
    class ABP_WeatherFXCulling_C* WeatherFXCullingActor;                              // 0x1138 (size: 0x8)
    bool NPCMusicActive;                                                              // 0x1140 (size: 0x1)
    FName TerminalRespawnID;                                                          // 0x1144 (size: 0x8)
    FVector2D LastMousePosition;                                                      // 0x1150 (size: 0x10)
    int32 PlayerSpawnAttempts;                                                        // 0x1160 (size: 0x4)
    FAbiotic_PlayerController_COnAdminPasswordIncorrect OnAdminPasswordIncorrect;     // 0x1168 (size: 0x10)
    void OnAdminPasswordIncorrect();
    FAbiotic_PlayerController_COnAdminGranted OnAdminGranted;                         // 0x1178 (size: 0x10)
    void OnAdminGranted();
    FVector2D TargetCursorInterpLocation;                                             // 0x1188 (size: 0x10)
    bool HasDynamicSkyboxActive;                                                      // 0x1198 (size: 0x1)
    bool HasCompletedTraitSelect;                                                     // 0x1199 (size: 0x1)
    bool SoundtrackCurrentlyBlocked;                                                  // 0x119A (size: 0x1)
    double CreditsStartTime;                                                          // 0x11A0 (size: 0x8)
    TArray<double> Credits_AudioStartingPoints;                                       // 0x11A8 (size: 0x10)
