...
{
    uint8 bIsCollisionEventListeningEnabled;                                          // 0x0238 (size: 0x1)
    uint8 bIsBreakingEventListeningEnabled;                                           // 0x0238 (size: 0x1)
    uint8 bIsTrailingEventListeningEnabled;                                           // 0x0238 (size: 0x1)
    uint8 bIsRemovalEventListeningEnabled;                                            // 0x0238 (size: 0x1)
    FChaosCollisionEventRequestSettings CollisionEventRequestSettings;                // 0x023C (size: 0x18)
    FChaosBreakingEventRequestSettings BreakingEventRequestSettings;                  // 0x0254 (size: 0x18)
    FChaosTrailingEventRequestSettings TrailingEventRequestSettings;                  // 0x026C (size: 0x18)
    FChaosRemovalEventRequestSettings RemovalEventRequestSettings;                    // 0x0284 (size: 0x10)
    TSet<AChaosSolverActor*> ChaosSolverActors;                                       // 0x0298 (size: 0x50)
    TSet<AGeometryCollectionActor*> GeometryCollectionActors;                         // 0x02E8 (size: 0x50)
    FChaosDestructionListenerOnCollisionEvents OnCollisionEvents;                     // 0x0338 (size: 0x10)
    void OnChaosCollisionEvents(const TArray<FChaosCollisionEventData>& CollisionEvents);
    FChaosDestructionListenerOnBreakingEvents OnBreakingEvents;                       // 0x0348 (size: 0x10)
    void OnChaosBreakingEvents(const TArray<FChaosBreakingEventData>& BreakingEvents);
    FChaosDestructionListenerOnTrailingEvents OnTrailingEvents;                       // 0x0358 (size: 0x10)
    void OnChaosTrailingEvents(const TArray<FChaosTrailingEventData>& TrailingEvents);
    FChaosDestructionListenerOnRemovalEvents OnRemovalEvents;                         // 0x0368 (size: 0x10)
...
{
    class AChaosSolverActor* ChaosSolverActor;                                        // 0x0560 (size: 0x8)
    class UGeometryCollection* RestCollection;                                        // 0x0570 (size: 0x8)
    TArray<class AFieldSystemActor*> InitializationFields;                            // 0x0578 (size: 0x10)
    bool Simulating;                                                                  // 0x0588 (size: 0x1)
    EObjectStateTypeEnum ObjectType;                                                  // 0x058A (size: 0x1)
    int32 GravityGroupIndex;                                                          // 0x058C (size: 0x4)
    int32 OneWayInteractionLevel;                                                     // 0x0590 (size: 0x4)
    bool bDensityFromPhysicsMaterial;                                                 // 0x0594 (size: 0x1)
    bool bForceMotionBlur;                                                            // 0x0595 (size: 0x1)
    bool EnableClustering;                                                            // 0x0596 (size: 0x1)
    int32 ClusterGroupIndex;                                                          // 0x0598 (size: 0x4)
    int32 MaxClusterLevel;                                                            // 0x059C (size: 0x4)
    int32 MaxSimulatedLevel;                                                          // 0x05A0 (size: 0x4)
    EDamageModelTypeEnum DamageModel;                                                 // 0x05A4 (size: 0x1)
    TArray<float> DamageThreshold;                                                    // 0x05A8 (size: 0x10)
    bool bUseSizeSpecificDamageThreshold;                                             // 0x05B8 (size: 0x1)
    bool bUseMaterialDamageModifiers;                                                 // 0x05B9 (size: 0x1)
    FGeometryCollectionDamagePropagationData DamagePropagationData;                   // 0x05BC (size: 0xC)
    bool bEnableDamageFromCollision;                                                  // 0x05C8 (size: 0x1)
    bool bAllowRemovalOnSleep;                                                        // 0x05C9 (size: 0x1)
    bool bAllowRemovalOnBreak;                                                        // 0x05CA (size: 0x1)
    EClusterConnectionTypeEnum ClusterConnectionType;                                 // 0x05CB (size: 0x1)
    int32 CollisionGroup;                                                             // 0x05CC (size: 0x4)
    float CollisionSampleFraction;                                                    // 0x05D0 (size: 0x4)
    float LinearEtherDrag;                                                            // 0x05D4 (size: 0x4)
    float AngularEtherDrag;                                                           // 0x05D8 (size: 0x4)
    class UChaosPhysicalMaterial* PhysicalMaterial;                                   // 0x05E0 (size: 0x8)
    EInitialVelocityTypeEnum InitialVelocityType;                                     // 0x05E8 (size: 0x1)
    FVector InitialLinearVelocity;                                                    // 0x05F0 (size: 0x18)
    FVector InitialAngularVelocity;                                                   // 0x0608 (size: 0x18)
    class UPhysicalMaterial* PhysicalMaterialOverride;                                // 0x0620 (size: 0x8)
    FGeomComponentCacheParameters CacheParameters;                                    // 0x0628 (size: 0x50)
    TArray<FTransform> RestTransforms;                                                // 0x0678 (size: 0x10)
    FGeometryCollectionComponentNotifyGeometryCollectionPhysicsStateChange NotifyGeometryCollectionPhysicsStateChange; // 0x0688 (size: 0x10)
    void NotifyGeometryCollectionPhysicsStateChange(class UGeometryCollectionComponent* FracturedComponent);
    FGeometryCollectionComponentNotifyGeometryCollectionPhysicsLoadingStateChange NotifyGeometryCollectionPhysicsLoadingStateChange; // 0x0698 (size: 0x10)
    void NotifyGeometryCollectionPhysicsLoadingStateChange(class UGeometryCollectionComponent* FracturedComponent);
    FGeometryCollectionComponentOnChaosBreakEvent OnChaosBreakEvent;                  // 0x06C0 (size: 0x10)
    void OnChaosBreakEvent(const FChaosBreakEvent& BreakEvent);
    FGeometryCollectionComponentOnChaosRemovalEvent OnChaosRemovalEvent;              // 0x06D0 (size: 0x10)
    void OnChaosRemovalEvent(const FChaosRemovalEvent& RemovalEvent);
    FGeometryCollectionComponentOnChaosCrumblingEvent OnChaosCrumblingEvent;          // 0x06E0 (size: 0x10)
    void OnChaosCrumblingEvent(const FChaosCrumblingEvent& CrumbleEvent);
    float DesiredCacheTime;                                                           // 0x0738 (size: 0x4)
    bool CachePlayback;                                                               // 0x073C (size: 0x1)
    FGeometryCollectionComponentOnChaosPhysicsCollision OnChaosPhysicsCollision;      // 0x0740 (size: 0x10)
    void OnChaosPhysicsCollision(const FChaosPhysicsCollisionInfo& CollisionInfo);
    bool bNotifyBreaks;                                                               // 0x0750 (size: 0x1)
    bool bNotifyCollisions;                                                           // 0x0751 (size: 0x1)
    bool bNotifyTrailing;                                                             // 0x0752 (size: 0x1)
    bool bNotifyRemovals;                                                             // 0x0753 (size: 0x1)
    bool bNotifyCrumblings;                                                           // 0x0754 (size: 0x1)
    bool bCrumblingEventIncludesChildren;                                             // 0x0755 (size: 0x1)
    bool bNotifyGlobalBreaks;                                                         // 0x0756 (size: 0x1)
    bool bNotifyGlobalCollisions;                                                     // 0x0757 (size: 0x1)
    bool bNotifyGlobalRemovals;                                                       // 0x0758 (size: 0x1)
    bool bNotifyGlobalCrumblings;                                                     // 0x0759 (size: 0x1)
    bool bGlobalCrumblingEventIncludesChildren;                                       // 0x075A (size: 0x1)
    bool bStoreVelocities;                                                            // 0x075B (size: 0x1)
    bool bIsCurrentlyNavigationRelevant;                                              // 0x075C (size: 0x1)
    bool bShowBoneColors;                                                             // 0x075D (size: 0x1)
    bool bUpdateComponentTransformToRootBone;                                         // 0x075E (size: 0x1)
    bool bUseRootProxyForNavigation;                                                  // 0x075F (size: 0x1)
    bool bUpdateNavigationInTick;                                                     // 0x0760 (size: 0x1)
    class AGeometryCollectionISMPoolActor* ISMPool;                                   // 0x0768 (size: 0x8)
    bool bAutoAssignISMPool;                                                          // 0x0770 (size: 0x1)
    bool bOverrideCustomRenderer;                                                     // 0x0771 (size: 0x1)
    UClass* CustomRendererType;                                                       // 0x0778 (size: 0x8)
    bool bEnableRootProxyForCustomRenderer;                                           // 0x0780 (size: 0x1)
    TScriptInterface<class IGeometryCollectionExternalRenderInterface> CustomRenderer; // 0x0788 (size: 0x10)
    bool bEnableReplication;                                                          // 0x0798 (size: 0x1)
    bool bEnableAbandonAfterLevel;                                                    // 0x0799 (size: 0x1)
    FName AbandonedCollisionProfileName;                                              // 0x079C (size: 0x8)
    TArray<FName> CollisionProfilePerLevel;                                           // 0x07A8 (size: 0x10)
    int32 ReplicationAbandonClusterLevel;                                             // 0x07C8 (size: 0x4)
    int32 ReplicationAbandonAfterLevel;                                               // 0x07CC (size: 0x4)
    int32 ReplicationMaxPositionAndVelocityCorrectionLevel;                           // 0x07D0 (size: 0x4)
    FGeometryCollectionRepData RepData;                                               // 0x07D8 (size: 0x38)
    FGeometryCollectionRepStateData RepStateData;                                     // 0x0810 (size: 0x40)
    FGeometryCollectionRepDynamicData RepDynamicData;                                 // 0x0850 (size: 0x18)
    class UBodySetup* DummyBodySetup;                                                 // 0x0988 (size: 0x8)
    class UChaosGameplayEventDispatcher* EventDispatcher;                             // 0x0990 (size: 0x8)
    TArray<class UInstancedStaticMeshComponent*> EmbeddedGeometryComponents;          // 0x0998 (size: 0x10)
    bool bUseStaticMeshCollisionForTraces;                                            // 0x09A8 (size: 0x1)
...
{
    class AGeometryCollectionDebugDrawActor* GeometryCollectionDebugDrawActor;        // 0x00A8 (size: 0x8)
    class AGeometryCollectionRenderLevelSetActor* GeometryCollectionRenderLevelSetActor; // 0x00B0 (size: 0x8)
...
{
    bool bShowGlobalStats;                                                            // 0x0570 (size: 0x1)
    bool bShowStats;                                                                  // 0x0571 (size: 0x1)
    bool bShowBounds;                                                                 // 0x0572 (size: 0x1)
    class UInstancedStaticMeshComponent* SelectedComponent;                           // 0x0578 (size: 0x8)
