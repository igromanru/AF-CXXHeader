#ifndef UE4SS_SDK_DefaultItem_AnimBP_HPP
#define UE4SS_SDK_DefaultItem_AnimBP_HPP
...
class UDefaultItem_AnimBP_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_DefaultItem_AnimBP(int32 EntryPoint);
}; // Size: 0x450
