...
class AResourceNode_DesktopPC_Note_C : public AResourceNode_ParentBP_C
{
    ...
    class UTextRenderComponent* Note;                                                 // 0x04E0 (size: 0x8)
    class UStaticMeshComponent* NotePaper;                                            // 0x04E8 (size: 0x8)
    class UStaticMeshComponent* DiskDrive;                                            // 0x04F0 (size: 0x8)
