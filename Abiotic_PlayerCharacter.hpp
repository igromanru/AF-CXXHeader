...
class AAbiotic_PlayerCharacter_C : public AAbiotic_Character_ParentBP_C
{
    ...
    class USkeletalMeshComponent* FPWristwatch;                                       // 0x15B8 (size: 0x8)
    class UStaticMeshComponent* IDCardMesh;                                           // 0x15C0 (size: 0x8)
    class UBodyShieldComponent_Player_C* BodyShieldComponent_Player;                  // 0x15C8 (size: 0x8)
    class USkeletalMeshComponent* BodyShieldMesh;                                     // 0x15D0 (size: 0x8)
    class UNiagaraComponent* UnderwaterParticle;                                      // 0x15D8 (size: 0x8)
    class USceneComponent* FP_MouthLocation;                                          // 0x15E0 (size: 0x8)
    class USkeletalMeshComponent* FPLeg_Suit;                                         // 0x15E8 (size: 0x8)
    class UCameraComponent* ThirdPersonCamera;                                        // 0x15F0 (size: 0x8)
    class USpringArmComponent* EmoteSpringArm;                                        // 0x15F8 (size: 0x8)
    class UNiagaraComponent* ActiveWeatherParticle;                                   // 0x1600 (size: 0x8)
    class UAudioComponent* FP_HazmatBreathAudio;                                      // 0x1608 (size: 0x8)
    class UStaticMeshComponent* FPSuitWindow;                                         // 0x1610 (size: 0x8)
    class UAbiotic_TransmogInventoryComp_C* TmogInventory;                            // 0x1618 (size: 0x8)
    class UChildActorComponent* NearbyOverlapActor;                                   // 0x1620 (size: 0x8)
    class USkeletalMeshComponent* FPLeg_Armor;                                        // 0x1628 (size: 0x8)
    class UChildActorComponent* RadioactiveActor;                                     // 0x1630 (size: 0x8)
    class USpotLightComponent* HeadlampSpotlight;                                     // 0x1638 (size: 0x8)
    class UPostProcessComponent* HeadlampPostProcessing;                              // 0x1640 (size: 0x8)
    class UPostProcessComponent* PlayerPostProcess;                                   // 0x1648 (size: 0x8)
    class UChildActorComponent* DeployableOverlapActor;                               // 0x1650 (size: 0x8)
    class UStaticMeshComponent* ScopePlane_R;                                         // 0x1658 (size: 0x8)
    class UStaticMeshComponent* ScopePlane_L;                                         // 0x1660 (size: 0x8)
    class UStaticMeshComponent* ScopePlane_Bot;                                       // 0x1668 (size: 0x8)
    class UStaticMeshComponent* ScopePlane_Top;                                       // 0x1670 (size: 0x8)
    class UStaticMeshComponent* ScopePlane;                                           // 0x1678 (size: 0x8)
    class UPhysicsConstraintComponent* TrinketSwingConstraint;                        // 0x1680 (size: 0x8)
    class UHumanCustomizationComponent_C* HumanCustomizationComponent;                // 0x1688 (size: 0x8)
    class USceneComponent* WaypointLocation;                                          // 0x1690 (size: 0x8)
    class UCameraComponent* FirstPersonCamera;                                        // 0x1698 (size: 0x8)
    class USceneComponent* CameraHeadJoint;                                           // 0x16A0 (size: 0x8)
    class USkeletalMeshComponent* FPLegs;                                             // 0x16A8 (size: 0x8)
    class UPointLightComponent* LanternLight;                                         // 0x16B0 (size: 0x8)
    class UPointLightComponent* WristwatchLight;                                      // 0x16B8 (size: 0x8)
    class USphereComponent* OverlapTrigger;                                           // 0x16C0 (size: 0x8)
    class UAbiotic_CharacterProgressionComponent_C* CharacterProgressionComponent;    // 0x16C8 (size: 0x8)
    class USkeletalMeshComponent* Armor_Suit;                                         // 0x16D0 (size: 0x8)
    class USkeletalMeshComponent* Armor_Helmet;                                       // 0x16D8 (size: 0x8)
    class UStaticMeshComponent* FannyPackMesh;                                        // 0x16E0 (size: 0x8)
    class USkeletalMeshComponent* BeardMesh;                                          // 0x16E8 (size: 0x8)
    class USkeletalMeshComponent* HeadAccessoryMesh;                                  // 0x16F0 (size: 0x8)
    class USkeletalMeshComponent* HairMesh;                                           // 0x16F8 (size: 0x8)
    class USkeletalMeshComponent* Armor_Legs;                                         // 0x1700 (size: 0x8)
    class USkeletalMeshComponent* Armor_Arms;                                         // 0x1708 (size: 0x8)
    class USkeletalMeshComponent* Armor_Torso;                                        // 0x1710 (size: 0x8)
    class UWidgetInteractionComponent* WidgetInteraction;                             // 0x1718 (size: 0x8)
    class USceneComponent* ProjectileSpawnLocation;                                   // 0x1720 (size: 0x8)
    class UNavigationInvokerComponent* NavigationInvoker;                             // 0x1728 (size: 0x8)
    class UAbiotic_InventoryComponent_C* CharacterEquipSlotInventory;                 // 0x1730 (size: 0x8)
    class UAbiotic_InventoryComponent_C* CharacterHotbarInventory;                    // 0x1738 (size: 0x8)
    class USpotLightComponent* FlashlightSpotlight;                                   // 0x1740 (size: 0x8)
    class USceneComponent* FPArmHinge;                                                // 0x1748 (size: 0x8)
    class UWidgetComponent* Wristwatch;                                               // 0x1750 (size: 0x8)
    class UStaticMeshComponent* BackpackMesh;                                         // 0x1758 (size: 0x8)
    class USkeletalMeshComponent* FPArms;                                             // 0x1760 (size: 0x8)
    class USceneComponent* AimSwayNode;                                               // 0x1768 (size: 0x8)
    class USkeletalMeshComponent* PantsMesh;                                          // 0x1770 (size: 0x8)
    class USkeletalMeshComponent* TorsoMesh;                                          // 0x1778 (size: 0x8)
    class USpotLightComponent* CharacterPane_SpotLight;                               // 0x1780 (size: 0x8)
    class USceneCaptureComponent2D* CharacterPane_RenderTarget;                       // 0x1788 (size: 0x8)
    class USpringArmComponent* SpringArm;                                             // 0x1790 (size: 0x8)
    class USceneComponent* ItemDropPoint;                                             // 0x1798 (size: 0x8)
    float FlashlightFlickerTimeline_NewTrack_0_5BF063A64DDA7C4244506CB7798A8C23;      // 0x17A0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> FlashlightFlickerTimeline__Direction_5BF063A64DDA7C4244506CB7798A8C23; // 0x17A4 (size: 0x1)
    class UTimelineComponent* FlashlightFlickerTimeline;                              // 0x17A8 (size: 0x8)
    float ControllerRecoilTimeline_NewTrack_0_AFC3F42148DFC42265088DA509116D45;       // 0x17B0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> ControllerRecoilTimeline__Direction_AFC3F42148DFC42265088DA509116D45; // 0x17B4 (size: 0x1)
    class UTimelineComponent* ControllerRecoilTimeline;                               // 0x17B8 (size: 0x8)
    float ADS_Zoom_Timeline_Alpha_DFE102FD4B24663C0400BEBF14D78F01;                   // 0x17C0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> ADS_Zoom_Timeline__Direction_DFE102FD4B24663C0400BEBF14D78F01; // 0x17C4 (size: 0x1)
    class UTimelineComponent* ADS_Zoom_Timeline;                                      // 0x17C8 (size: 0x8)
    float Timeline_1_DamageMultiplyValue_8328351944D630437C0EF497C55C7BAE;            // 0x17D0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_1__Direction_8328351944D630437C0EF497C55C7BAE; // 0x17D4 (size: 0x1)
    class UTimelineComponent* Timeline_1;                                             // 0x17D8 (size: 0x8)
    float ScreenColorFlashTimeline_NewTrack_0_057EEB42441DFE6AC2A9AA9CD71EB08C;       // 0x17E0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> ScreenColorFlashTimeline__Direction_057EEB42441DFE6AC2A9AA9CD71EB08C; // 0x17E4 (size: 0x1)
    class UTimelineComponent* ScreenColorFlashTimeline;                               // 0x17E8 (size: 0x8)
    float WindUpDamageTimeline_DamageMultiplyValue_B321CE824694AB824DB932BA7CDEBA2B;  // 0x17F0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> WindUpDamageTimeline__Direction_B321CE824694AB824DB932BA7CDEBA2B; // 0x17F4 (size: 0x1)
    class UTimelineComponent* WindUpDamageTimeline;                                   // 0x17F8 (size: 0x8)
    float RecoilTimeline_NewTrack_0_7619EC7841CCE2A53A63A7841FB4C01D;                 // 0x1800 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> RecoilTimeline__Direction_7619EC7841CCE2A53A63A7841FB4C01D; // 0x1804 (size: 0x1)
    class UTimelineComponent* RecoilTimeline;                                         // 0x1808 (size: 0x8)
    FVector SwayTimelineLoop_NewTrack_1_1E19F0E74CE5FFB6096EBC86C262A1F2;             // 0x1810 (size: 0x18)
    TEnumAsByte<ETimelineDirection::Type> SwayTimelineLoop__Direction_1E19F0E74CE5FFB6096EBC86C262A1F2; // 0x1828 (size: 0x1)
    class UTimelineComponent* SwayTimelineLoop;                                       // 0x1830 (size: 0x8)
    double BaseTurnRate;                                                              // 0x1838 (size: 0x8)
    double BaseLookUpRate;                                                            // 0x1840 (size: 0x8)
    double CurrentWalkSpeed;                                                          // 0x1848 (size: 0x8)
    class UW_PlayerInventory_Main_C* InventoryReference;                              // 0x1850 (size: 0x8)
    bool IsInventoryOpen;                                                             // 0x1858 (size: 0x1)
    bool HUD_HiddenByUser;                                                            // 0x1859 (size: 0x1)
    FTimerHandle CharacterPane3DRotateTimer;                                          // 0x1860 (size: 0x8)
    FInventorySlotSelected_Struct CurrentHotbarSlotSelected;                          // 0x1868 (size: 0x10)
    int32 MaxHotbarSlotSelected;                                                      // 0x1878 (size: 0x4)
    bool IsDeployMode;                                                                // 0x187C (size: 0x1)
    bool CanPlaceDeployableNow;                                                       // 0x187D (size: 0x1)
    class AActor* BestInteractable_InteractA;                                         // 0x1880 (size: 0x8)
    FTimerHandle InteractionFinderTimer;                                              // 0x1888 (size: 0x8)
    class AAbiotic_PlayerState_C* MyPlayerState;                                      // 0x1890 (size: 0x8)
    double LastTimeFiredWeapon;                                                       // 0x1898 (size: 0x8)
    double TimeBetweenPunches;                                                        // 0x18A0 (size: 0x8)
    bool Local_KeyHeld_Fire;                                                          // 0x18A8 (size: 0x1)
    double PunchDamage;                                                               // 0x18B0 (size: 0x8)
    bool TriggeredDeathMessageThisLife;                                               // 0x18B8 (size: 0x1)
    class AAbiotic_PlayerController_C* MyPlayerController;                            // 0x18C0 (size: 0x8)
    FHitResult CrosshairHit;                                                          // 0x18C8 (size: 0xF8)
    double BulletSpread_Base;                                                         // 0x19C0 (size: 0x8)
    FVector2D CrosshairOffset;                                                        // 0x19C8 (size: 0x10)
    double BaseGunSway_Multiplier;                                                    // 0x19D8 (size: 0x8)
    double CurrentGunSway_Speed;                                                      // 0x19E0 (size: 0x8)
    FRotator AimSwayRotationCenter;                                                   // 0x19E8 (size: 0x18)
    double AimRecoilAdditive;                                                         // 0x1A00 (size: 0x8)
    bool Local_KeyHeld_Interact;                                                      // 0x1A08 (size: 0x1)
    FTimerHandle InteractionHeldTimer;                                                // 0x1A10 (size: 0x8)
    double CurrentHoldToInteractTime;                                                 // 0x1A18 (size: 0x8)
    class AActor* BestInteractable_InteractB;                                         // 0x1A20 (size: 0x8)
    bool IsViewingWristwatch;                                                         // 0x1A28 (size: 0x1)
    bool Local_KeyHeld_Wristwatch;                                                    // 0x1A29 (size: 0x1)
    class UActorComponent* BestInteractableComponent;                                 // 0x1A30 (size: 0x8)
    int32 CurrentMoney;                                                               // 0x1A38 (size: 0x4)
    FAbiotic_PlayerCharacter_CMoney_Changed Money_Changed;                            // 0x1A40 (size: 0x10)
    void Money_Changed();
    class AAbiotic_Item_ParentBP_C* ItemInHand_BP;                                    // 0x1A50 (size: 0x8)
    FTimerHandle Stamina_Timer;                                                       // 0x1A58 (size: 0x8)
    double Stamina_CheckRate;                                                         // 0x1A60 (size: 0x8)
    double Stamina_DrainRate;                                                         // 0x1A68 (size: 0x8)
    double Stamina_RegainRate;                                                        // 0x1A70 (size: 0x8)
    double Stamina_ExertionDelay;                                                     // 0x1A78 (size: 0x8)
    double LastHoldInteractionStartTime;                                              // 0x1A80 (size: 0x8)
    double CurrentSanity;                                                             // 0x1A88 (size: 0x8)
    double MaxSanity;                                                                 // 0x1A90 (size: 0x8)
    class AAbioticActor_C* LastItemInHand_BP;                                         // 0x1A98 (size: 0x8)
    FAbiotic_PlayerCharacter_CSanity_Changed Sanity_Changed;                          // 0x1AA0 (size: 0x10)
    void Sanity_Changed();
    bool PerformingInteraction;                                                       // 0x1AB0 (size: 0x1)
    bool LastInteractionWasTypeA;                                                     // 0x1AB1 (size: 0x1)
    class AActor* LastHoldInteractableAttempted;                                      // 0x1AB8 (size: 0x8)
    bool JustExecutedInteraction;                                                     // 0x1AC0 (size: 0x1)
    bool Debug_FreeCrafting;                                                          // 0x1AC1 (size: 0x1)
    bool Local_KeyHeld_AltFire;                                                       // 0x1AC2 (size: 0x1)
    bool IsMeleeWindingUp;                                                            // 0x1AC3 (size: 0x1)
    bool IsMeleeWindUpHeld;                                                           // 0x1AC4 (size: 0x1)
    double CurrentMeleeDamageMultiplier;                                              // 0x1AC8 (size: 0x8)
    bool Flashlight_On;                                                               // 0x1AD0 (size: 0x1)
    double TimeLastWarnedFatigue;                                                     // 0x1AD8 (size: 0x8)
    double TimeLastWarnedThirst;                                                      // 0x1AE0 (size: 0x8)
    double TimeLastWarnedHunger;                                                      // 0x1AE8 (size: 0x8)
    FString OverheadName;                                                             // 0x1AF0 (size: 0x10)
    bool JustDeployed;                                                                // 0x1B00 (size: 0x1)
    FInventorySlotSelected_Struct Server_LastSelectedHotbarItem;                      // 0x1B08 (size: 0x10)
    class UObject* LastMeshInFPHands;                                                 // 0x1B18 (size: 0x8)
    bool IsUsingTerminal;                                                             // 0x1B20 (size: 0x1)
    class AComputerTerminal_ParentBP_C* CurrentTerminal;                              // 0x1B28 (size: 0x8)
    FAbiotic_PlayerCharacter_CTerminalUseState_Changed TerminalUseState_Changed;      // 0x1B30 (size: 0x10)
    void TerminalUseState_Changed(bool UsingTerminal);
    double TimeOfLastDeath;                                                           // 0x1B40 (size: 0x8)
    double SittingEyeHeight;                                                          // 0x1B48 (size: 0x8)
    double Skill_AccuracyMultiplier_StartValue;                                       // 0x1B50 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_BackpackBP;                                     // 0x1B58 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_HelmetBP;                                       // 0x1B60 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_ArmsBP;                                         // 0x1B68 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_LegsBP;                                         // 0x1B70 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_SuitBP;                                         // 0x1B78 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_TorsoBP;                                        // 0x1B80 (size: 0x8)
    class UMeshComponent* CurrentFPItemMesh;                                          // 0x1B88 (size: 0x8)
    bool LocalJumpCooldownActive;                                                     // 0x1B90 (size: 0x1)
    bool Trait_FannyPack;                                                             // 0x1B91 (size: 0x1)
    double ArmorSlowMultiplier;                                                       // 0x1B98 (size: 0x8)
    bool Local_KeyHeld_Crouch;                                                        // 0x1BA0 (size: 0x1)
    FInventorySlotSelected_Struct CurrentFPItemIndex;                                 // 0x1BA8 (size: 0x10)
    FAbiotic_InventoryItemStruct CurrentHeldItemData;                                 // 0x1BB8 (size: 0x650)
    bool CurrentHeldItemExists;                                                       // 0x2208 (size: 0x1)
    TArray<class UActorComponent*> LastHighlightedInteractComponents;                 // 0x2210 (size: 0x10)
    FText InteractWithText;                                                           // 0x2220 (size: 0x10)
    bool IsPlugPlacementMode;                                                         // 0x2230 (size: 0x1)
    class APowerSocket_ParentBP_C* CurrentPlugCableSocket;                            // 0x2238 (size: 0x8)
    FTimerHandle SanityTimer;                                                         // 0x2240 (size: 0x8)
    double Sanity_CheckRate;                                                          // 0x2248 (size: 0x8)
    FTimerHandle LightValueTimer;                                                     // 0x2250 (size: 0x8)
    float LightValueCheckTime;                                                        // 0x2258 (size: 0x4)
    double LastAuditoryHallucination;                                                 // 0x2260 (size: 0x8)
    TArray<TSoftObjectPtr<USoundCue>> HallucinationSounds_Innocent;                   // 0x2268 (size: 0x10)
    TArray<TSoftObjectPtr<USoundCue>> HallucinationSounds_Hostile;                    // 0x2278 (size: 0x10)
    double PreviousRadiation;                                                         // 0x2288 (size: 0x8)
    FName CurrentPerformingEmote;                                                     // 0x2290 (size: 0x8)
    class UAnimMontage* LastKnownLoadedEmote;                                         // 0x2298 (size: 0x8)
    FEmote_Struct LastEmoteData;                                                      // 0x22A0 (size: 0xF0)
    class UStaticMeshComponent* FPPlugMesh;                                           // 0x2390 (size: 0x8)
    double FallDamageResistance;                                                      // 0x2398 (size: 0x8)
    double MaxInventoryWeight;                                                        // 0x23A0 (size: 0x8)
    FAbiotic_PlayerCharacter_CInventoryWeight_Changed InventoryWeight_Changed;        // 0x23A8 (size: 0x10)
    void InventoryWeight_Changed();
    double DefaultMaxStamina;                                                         // 0x23B8 (size: 0x8)
    double DefaultMaxInventoryWeight;                                                 // 0x23C0 (size: 0x8)
    bool LanternLight_On;                                                             // 0x23C8 (size: 0x1)
    FString Asset ID;                                                                 // 0x23D0 (size: 0x10)
    FTimerHandle PlayerLocHandle;                                                     // 0x23E0 (size: 0x8)
    FVector LastZiplineVelocity;                                                      // 0x23E8 (size: 0x18)
    int32 MeleeSwingIndex;                                                            // 0x2400 (size: 0x4)
    FMeleeSwingStyle_Struct ClientLastMeleeSwingStyleData;                            // 0x2408 (size: 0x80)
    class UDecalComponent* CrosshairDecal;                                            // 0x2488 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_HeadlampBP;                                     // 0x2490 (size: 0x8)
    bool HeadlampOn;                                                                  // 0x2498 (size: 0x1)
    class UW_RadialWheel_ParentBP_C* RadialWheel;                                     // 0x24A0 (size: 0x8)
    FName ChosenEmote;                                                                // 0x24A8 (size: 0x8)
    double CurrentJumpHeight;                                                         // 0x24B0 (size: 0x8)
    FAbiotic_InventoryChangeableDataStruct Carryover Changeable Data;                 // 0x24B8 (size: 0x88)
    class UW_PlayerHUD_RecipeVBox_C* RecipeUnlockVBox;                                // 0x2540 (size: 0x8)
    FTimerHandle SneakingXPTimer;                                                     // 0x2548 (size: 0x8)
    double DeadEyeHeight;                                                             // 0x2550 (size: 0x8)
    bool DangerousIngestionWarning;                                                   // 0x2558 (size: 0x1)
    double CrouchAlpha;                                                               // 0x2560 (size: 0x8)
    double CrouchInterpSpeed;                                                         // 0x2568 (size: 0x8)
    bool CanUseJetpack;                                                               // 0x2570 (size: 0x1)
    class UCurveFloat* JetpackCurve;                                                  // 0x2578 (size: 0x8)
    float AccsCameraShakeAmount;                                                      // 0x2580 (size: 0x4)
    bool Ctrls_InvertYAxis;                                                           // 0x2584 (size: 0x1)
    double Ctrls_MouseXSensitivity;                                                   // 0x2588 (size: 0x8)
    FTimerHandle FireDelayTimer;                                                      // 0x2590 (size: 0x8)
    float Axis Value Forward;                                                         // 0x2598 (size: 0x4)
    bool LocalUsingAutoMove;                                                          // 0x259C (size: 0x1)
    double Liquid Percentage Remains;                                                 // 0x25A0 (size: 0x8)
    TArray<class UAbiotic_InventoryComponent_C*> Additional Inventories;              // 0x25A8 (size: 0x10)
    bool PendingNonHotbarUsage;                                                       // 0x25B8 (size: 0x1)
    class UStaticMeshComponent* ClipboardMesh;                                        // 0x25C0 (size: 0x8)
    FString CurrentFPItemAssetID;                                                     // 0x25C8 (size: 0x10)
    TEnumAsByte<E_AnimInteractState::Type> InteractAnimationState;                    // 0x25D8 (size: 0x1)
    double Ctrls_MouseYSensitivity;                                                   // 0x25E0 (size: 0x8)
    double Ctrls_GamepadXSensitivity;                                                 // 0x25E8 (size: 0x8)
    double Ctrls_GamepadYSensitivity;                                                 // 0x25F0 (size: 0x8)
    class UMaterialInstanceDynamic* CrosshairDecalMaterial;                           // 0x25F8 (size: 0x8)
    FTimerHandle ProjectilePathTimer;                                                 // 0x2600 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_TrinketBP;                                      // 0x2608 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_WristwatchBP;                                   // 0x2610 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_HackingDeviceBP;                                // 0x2618 (size: 0x8)
    bool HasProcessedMeleeDurability;                                                 // 0x2620 (size: 0x1)
    class UStaticMesh* HologramArrowMesh;                                             // 0x2628 (size: 0x8)
    FVector WristwatchPointLightLocation;                                             // 0x2630 (size: 0x18)
    int32 LastSelectedHotbarSlot;                                                     // 0x2648 (size: 0x4)
    bool RangedWeaponInRange;                                                         // 0x264C (size: 0x1)
    bool Local_CrosshairHidden;                                                       // 0x264D (size: 0x1)
    bool IsWeaponThrowReady;                                                          // 0x264E (size: 0x1)
    bool IsWeaponThrowHeld;                                                           // 0x264F (size: 0x1)
    double CurrentThrowWeaponDistanceMultiplier;                                      // 0x2650 (size: 0x8)
    double AmbientTemp;                                                               // 0x2658 (size: 0x8)
    double CallForHelpStartTime;                                                      // 0x2660 (size: 0x8)
    class UMaterialInterface* DefaultLightFunction;                                   // 0x2668 (size: 0x8)
    bool UsingSniperScope;                                                            // 0x2670 (size: 0x1)
    bool CrosshairCenterNoSway;                                                       // 0x2671 (size: 0x1)
    bool UnderwaterFXActive;                                                          // 0x2672 (size: 0x1)
    class UStaticMesh* CurrentDeployHologram;                                         // 0x2678 (size: 0x8)
    double LadderUpDownBias;                                                          // 0x2680 (size: 0x8)
    bool MeleeOnlyTargets;                                                            // 0x2688 (size: 0x1)
    TArray<double> ArmorWeightClasses;                                                // 0x2690 (size: 0x10)
    FRotator LastMeleeSwingRotation;                                                  // 0x26A0 (size: 0x18)
    class UMaterialInstanceDynamic* RadiationPostProcess;                             // 0x26B8 (size: 0x8)
    double RadiationPostProcessAlpha;                                                 // 0x26C0 (size: 0x8)
    bool ServerLevelLoaded;                                                           // 0x26C8 (size: 0x1)
    bool OwningLevelLoaded;                                                           // 0x26C9 (size: 0x1)
    class AAbiotic_PlayerFreezeJail_C* JailActor;                                     // 0x26D0 (size: 0x8)
    bool HeldItemIsCooking;                                                           // 0x26D8 (size: 0x1)
    double LastTimeCookingThrowable;                                                  // 0x26E0 (size: 0x8)
    TArray<class USceneComponent*> ChildrenComponentsToDestroy;                       // 0x26E8 (size: 0x10)
    float Axis Value Right;                                                           // 0x26F8 (size: 0x4)
    bool HasRecentlyTeleported;                                                       // 0x26FC (size: 0x1)
    FAbiotic_PlayerCharacter_COnHungerRestored OnHungerRestored;                      // 0x2700 (size: 0x10)
    void OnHungerRestored(double CurrentHunger);
    FAbiotic_PlayerCharacter_COnThirstRestored OnThirstRestored;                      // 0x2710 (size: 0x10)
    void OnThirstRestored(double CurrentThirst);
    class AItem_Gear_ParentBP_C* Gear_ShieldBP;                                       // 0x2720 (size: 0x8)
    bool ShieldHeld;                                                                  // 0x2728 (size: 0x1)
    double HotbarSlotChangedTimestamp;                                                // 0x2730 (size: 0x8)
    float RollStartTime;                                                              // 0x2738 (size: 0x4)
    FAbiotic_PlayerCharacter_CCharacter_Emoted Character_Emoted;                      // 0x2740 (size: 0x10)
    void Character_Emoted(FName EmoteRow);
    FRotator ScopeSwayRotation;                                                       // 0x2750 (size: 0x18)
    class UCurveVector* ScopeSwayCurve;                                               // 0x2768 (size: 0x8)
    double ScopeSwayTime;                                                             // 0x2770 (size: 0x8)
    double ScopeSwaySpeed;                                                            // 0x2778 (size: 0x8)
    bool SprintKeyHeld;                                                               // 0x2780 (size: 0x1)
    bool ScopeHoldBreath;                                                             // 0x2781 (size: 0x1)
    TArray<FBuffDebuffRowHandle> CurrentSetBonuses;                                   // 0x2788 (size: 0x10)
    FAbiotic_PlayerCharacter_COnCurrentSetBonusesUpdated OnCurrentSetBonusesUpdated;  // 0x2798 (size: 0x10)
    void OnCurrentSetBonusesUpdated(class AAbiotic_PlayerCharacter_C* OwningCharacter);
    bool DoingThrowAnimation;                                                         // 0x27A8 (size: 0x1)
    class UAudioComponent* DBNOHeartbeat;                                             // 0x27B0 (size: 0x8)
    bool IsSquinting;                                                                 // 0x27B8 (size: 0x1)
    double Last_ADS_FOV;                                                              // 0x27C0 (size: 0x8)
    FRotator RecoilTimelineStartRotation;                                             // 0x27C8 (size: 0x18)
    class UMaterialInstanceDynamic* CrosshairDecalMaterial_Shotgun;                   // 0x27E0 (size: 0x8)
    class APowerSocket_ParentBP_C* LastPlugCableSocket;                               // 0x27E8 (size: 0x8)
    TArray<FAbioticItemCount_Struct> CableRerouteCost;                                // 0x27F0 (size: 0x10)
    double DistanceForSubtitles;                                                      // 0x2800 (size: 0x8)
    FTimerHandle Equip_ClearFireDelayTimer;                                           // 0x2808 (size: 0x8)
    bool TempShieldHolster;                                                           // 0x2810 (size: 0x1)
    FAbiotic_PlayerCharacter_COnShieldHeldUpdated OnShieldHeldUpdated;                // 0x2818 (size: 0x10)
    void OnShieldHeldUpdated(bool ShieldHeld);
    class UCurveFloat* LaserSightCurve_Pistol;                                        // 0x2828 (size: 0x8)
    class UCurveFloat* LaserSightCurve_Shotgun;                                       // 0x2830 (size: 0x8)
    FName CurrentItemRow;                                                             // 0x2838 (size: 0x8)
    bool Ctrls_ToggleSprint;                                                          // 0x2840 (size: 0x1)
    bool AccsStaticInteractPrompt;                                                    // 0x2841 (size: 0x1)
    bool IsFirstPerson;                                                               // 0x2842 (size: 0x1)
    bool EmoteShouldHideFP;                                                           // 0x2843 (size: 0x1)
    class UMaterialInstanceDynamic* Hot Post Process;                                 // 0x2848 (size: 0x8)
    class UCurveFloat* TemperatureUICurve;                                            // 0x2850 (size: 0x8)
    class UMaterialInstanceDynamic* Cold Post Process;                                // 0x2858 (size: 0x8)
    double CurrentTemperatureFXAlpha;                                                 // 0x2860 (size: 0x8)
    class UCurveFloat* TemperaturePPCurve;                                            // 0x2868 (size: 0x8)
    class UAudioComponent* UnderwaterSound;                                           // 0x2870 (size: 0x8)
    int32 CurrentWeaponBurstCounter;                                                  // 0x2878 (size: 0x4)
    bool FiringWeaponBurst;                                                           // 0x287C (size: 0x1)
    double Light_FlickeringIntensityLow;                                              // 0x2880 (size: 0x8)
    double Light_DefaultIntensity;                                                    // 0x2888 (size: 0x8)
    float Light_FlickerAlpha;                                                         // 0x2890 (size: 0x4)
    bool LightFlickerEnabled;                                                         // 0x2894 (size: 0x1)
    class UAudioComponent* ActiveNPCMusic;                                            // 0x2898 (size: 0x8)
    double Lantern_DefaultIntensity;                                                  // 0x28A0 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_Trinket2_BP;                                    // 0x28A8 (size: 0x8)
    bool IsCurrentlyOfferingItem;                                                     // 0x28B0 (size: 0x1)
    bool PagerOn;                                                                     // 0x28B1 (size: 0x1)
    double StaminaLoss_Jumping;                                                       // 0x28B8 (size: 0x8)
    FTimerHandle ReloadHeldTimer;                                                     // 0x28C0 (size: 0x8)
    FVector LastActorLocation;                                                        // 0x28C8 (size: 0x18)
    float Last AFKInput Time Stamp;                                                   // 0x28E0 (size: 0x4)
    double TimeToAFK;                                                                 // 0x28E8 (size: 0x8)
    FAbiotic_PlayerCharacter_COnGearVisualStatus_Updated OnGearVisualStatus_Updated;  // 0x28F0 (size: 0x10)
    void OnGearVisualStatus_Updated();
    class UMeshComponent* ShieldComponent_TP;                                         // 0x2900 (size: 0x8)
    class UMeshComponent* ShieldComponent_FP;                                         // 0x2908 (size: 0x8)
    FAbiotic_PlayerCharacter_CAimDownSights_Changed AimDownSights_Changed;            // 0x2910 (size: 0x10)
    void AimDownSights_Changed(bool UsingSniperScope, bool IsSquinting);
    bool ShouldBlockCrouchInput;                                                      // 0x2920 (size: 0x1)
    class ADayNightManager_C* Local_DayNightManager;                                  // 0x2928 (size: 0x8)
    bool InfiniteAmmo;                                                                // 0x2930 (size: 0x1)
    class UAbioticPhysicalMaterial* FloorMaterial;                                    // 0x2938 (size: 0x8)
    FBuffDebuffRowHandle LastShield;                                                  // 0x2940 (size: 0x20)
    FTimerHandle OutOfMyWayTimer;                                                     // 0x2960 (size: 0x8)
    FGameplayTagContainer IgnoredDamageResistanceTags;                                // 0x2968 (size: 0x20)
    FString LocalOverheadName;                                                        // 0x2988 (size: 0x10)
    bool JustSetCableConnection;                                                      // 0x2998 (size: 0x1)
    double LastTimeSprintingStarted;                                                  // 0x29A0 (size: 0x8)
    TArray<class AAbioticDeployed_ParentBP_C*> LastFurnitureLookedAtQueue;            // 0x29A8 (size: 0x10)
    bool GridSnapping;                                                                // 0x29B8 (size: 0x1)
    int32 ThrownProjectileLastIndex;                                                  // 0x29BC (size: 0x4)
    TEnumAsByte<E_AttackMissed::Type> LastAttackMissed;                               // 0x29C0 (size: 0x1)
    bool BattleChargeActive;                                                          // 0x29C1 (size: 0x1)
    bool KillLookAtTarget;                                                            // 0x29C2 (size: 0x1)
    bool CurrentlyViewingWristwatch;                                                  // 0x29C3 (size: 0x1)
    bool Local_ReadyToControlPlayer;                                                  // 0x29C4 (size: 0x1)
    class AAbioticDeployed_ParentBP_C* LastDeployedActor;                             // 0x29C8 (size: 0x8)
    bool ThrowUnderhand;                                                              // 0x29D0 (size: 0x1)
    double LastMontageLength;                                                         // 0x29D8 (size: 0x8)
    class AAbiotic_Character_ParentBP_C* LastLookingAtCharacter;                      // 0x29E0 (size: 0x8)
    bool NonHotbarUsageSecondary;                                                     // 0x29E8 (size: 0x1)
    FAbiotic_PlayerCharacter_COnTeleporterUsed OnTeleporterUsed;                      // 0x29F0 (size: 0x10)
    void OnTeleporterUsed(class AAbiotic_PlayerCharacter_C* Character, class AActor* TeleportCause);
    FTimerHandle LocalReloadTickTimer;                                                // 0x2A00 (size: 0x8)
    FLinearColor DefaultWatchLightColor;                                              // 0x2A08 (size: 0x10)
    class AActor* MountedActor;                                                       // 0x2A18 (size: 0x8)
    class AActor* LastMountedActor;                                                   // 0x2A20 (size: 0x8)
    bool PreviousSeatBlockedItemUse;                                                  // 0x2A28 (size: 0x1)
    class ANPC_Base_ParentBP_C* Companion;                                            // 0x2A30 (size: 0x8)
    double ZiplineStartTime;                                                          // 0x2A38 (size: 0x8)
    ...
    void PlayUseAnimationTP(bool Secondary Use Anim, bool LockInPlace);
    void UpdateWristWatchWidgetVisibility();
    bool Server_TryApplyWeaponCoating(FInventorySlotSelected_Struct CoatingSlot, FInventorySlotSelected_Struct TargetSlot);
    void SetWristwatchAnimBP(class USkeletalMeshComponent* WatchComponent);
    void UpdateIDCardMeshSocketReference();
    void OnRep_MountedActor();
    void SetMountedActor(class AActor* NewMountedActor);
    void UpdateWristwatchLightVisibility();
    void DetermineReloadSections(class USkeletalMeshComponent* SkeletalMeshComponent, class UAnimMontage* Montage, FName& LoopStartName, FName& LoopEndName);
    void TryReloadPartial(int32 Amount, class AAbiotic_Item_ParentBP_C* Weapon, bool& Success);
    void OnRep_ThrowUnderhand();
    void DoesSeatBlockItemUse(bool& BlockItemUse, class AAbioticDeployed_Furniture_ParentBP_C*& Seat);
    ...
    void OnNotifyEnd_CCE1AFA54DE30BB9D98EB59617BCEF1E(FName NotifyName);
    void OnNotifyBegin_CCE1AFA54DE30BB9D98EB59617BCEF1E(FName NotifyName);
    void OnInterrupted_CCE1AFA54DE30BB9D98EB59617BCEF1E(FName NotifyName);
    void OnBlendOut_CCE1AFA54DE30BB9D98EB59617BCEF1E(FName NotifyName);
    void OnCompleted_CCE1AFA54DE30BB9D98EB59617BCEF1E(FName NotifyName);
    ...
    void OnNotifyEnd_EC576EBD460990019ED58597D74EB8E8(FName NotifyName);
    void OnNotifyBegin_EC576EBD460990019ED58597D74EB8E8(FName NotifyName);
    void OnInterrupted_EC576EBD460990019ED58597D74EB8E8(FName NotifyName);
    void OnBlendOut_EC576EBD460990019ED58597D74EB8E8(FName NotifyName);
    void OnCompleted_EC576EBD460990019ED58597D74EB8E8(FName NotifyName);
    void OnNotifyEnd_32E984104534FF7CC23DB3AB53FF073D(FName NotifyName);
    void OnNotifyBegin_32E984104534FF7CC23DB3AB53FF073D(FName NotifyName);
    void OnInterrupted_32E984104534FF7CC23DB3AB53FF073D(FName NotifyName);
    void OnBlendOut_32E984104534FF7CC23DB3AB53FF073D(FName NotifyName);
    void OnCompleted_32E984104534FF7CC23DB3AB53FF073D(FName NotifyName);
    ...
    void Client_PlayChefSenseFX(const class AStove_ParentBP_C* Stove);
    void OnUseBeltIDCardLocationUpdated();
    void PlayThirdPersonLinkedMontage(bool LockInPlace, class UAnimMontage* MontageToPlay, class UAnimMontage* ItemMontageToPlay, float PlayRate, bool SecondaryUse);
    void TryUsingItem_Secondary();
    ...
    void PlayFPItemReloadMontage_Internal(FName StartingSection);
    void ReloadTick();
    void PlayFPArmsReloadMontage_Internal(FName StartingSection);
    void PlayLinkedFPReloadMontage(TSoftObjectPtr<UAnimMontage> ItemMontage, TSoftObjectPtr<UAnimMontage> FPArmMontage, float InPlayRate, bool Offhand);
    void ReloadWeapon();
    void FinishWeaponReload();
    void Local_InterruptReload();
    void Local_OpenRenameWindow(FInventorySlotSelected_Struct TargetItem);
    void StopRenaming();
    void RenameYesClicked_Event();
    void OnRenameTextChanged_Event(const FText& Text);
    void Request_TryApplyWeaponCoating(FInventorySlotSelected_Struct CoatingSlot, FInventorySlotSelected_Struct TargetSlot);
    void Request_RenameItem(class UAbiotic_InventoryComponent_C* Inventory, int32 SlotIndex, FString NewName);
    ...
    void ReceivedNewBed();
    void Client_ThirdPersonView(bool Enabled, FVector OptionalOffset);
    ...
    void TryUseNonHotbarSlot(class UAbiotic_InventoryComponent_C* SlotInventory, int32 SlotIndex, bool NonHotbarUsageSecondary);
    ...
    void OnDamageApplied__DelegateSignature(class AActor* DamagedActor, double RawDamage, TSubclassOf<class UAbiotic_DamageType_ParentBP_C> DamageType, FHitResult HitResult, bool IsMelee, class AActor* DamageCauser);
    void OnTeleporterUsed__DelegateSignature(class AAbiotic_PlayerCharacter_C* Character, class AActor* TeleportCause);
