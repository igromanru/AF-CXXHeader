...
class AAbiotic_PlayerCharacter_C : public AAbiotic_Character_ParentBP_C
{
    ...
    class UStaticMeshComponent* IDCardMesh;                                           // 0x1518 (size: 0x8)
    class UBodyShieldComponent_Player_C* BodyShieldComponent_Player;                  // 0x1520 (size: 0x8)
    class USkeletalMeshComponent* BodyShieldMesh;                                     // 0x1528 (size: 0x8)
    class UNiagaraComponent* UnderwaterParticle;                                      // 0x1530 (size: 0x8)
    class USceneComponent* FP_MouthLocation;                                          // 0x1538 (size: 0x8)
    class USkeletalMeshComponent* FPLeg_Suit;                                         // 0x1540 (size: 0x8)
    class UCameraComponent* ThirdPersonCamera;                                        // 0x1548 (size: 0x8)
    class USpringArmComponent* EmoteSpringArm;                                        // 0x1550 (size: 0x8)
    class UNiagaraComponent* ActiveWeatherParticle;                                   // 0x1558 (size: 0x8)
    class UAudioComponent* FP_HazmatBreathAudio;                                      // 0x1560 (size: 0x8)
    class UStaticMeshComponent* FPSuitWindow;                                         // 0x1568 (size: 0x8)
    class UAbiotic_TransmogInventoryComp_C* TmogInventory;                            // 0x1570 (size: 0x8)
    class UChildActorComponent* NearbyOverlapActor;                                   // 0x1578 (size: 0x8)
    class USkeletalMeshComponent* FPLeg_Armor;                                        // 0x1580 (size: 0x8)
    class UChildActorComponent* RadioactiveActor;                                     // 0x1588 (size: 0x8)
    class USpotLightComponent* HeadlampSpotlight;                                     // 0x1590 (size: 0x8)
    class UPostProcessComponent* HeadlampPostProcessing;                              // 0x1598 (size: 0x8)
    class UPostProcessComponent* PlayerPostProcess;                                   // 0x15A0 (size: 0x8)
    class UChildActorComponent* DeployableOverlapActor;                               // 0x15A8 (size: 0x8)
    class UStaticMeshComponent* ScopePlane_R;                                         // 0x15B0 (size: 0x8)
    class UStaticMeshComponent* ScopePlane_L;                                         // 0x15B8 (size: 0x8)
    class UStaticMeshComponent* ScopePlane_Bot;                                       // 0x15C0 (size: 0x8)
    class UStaticMeshComponent* ScopePlane_Top;                                       // 0x15C8 (size: 0x8)
    class UStaticMeshComponent* ScopePlane;                                           // 0x15D0 (size: 0x8)
    class UPhysicsConstraintComponent* TrinketSwingConstraint;                        // 0x15D8 (size: 0x8)
    class UHumanCustomizationComponent_C* HumanCustomizationComponent;                // 0x15E0 (size: 0x8)
    class USceneComponent* WaypointLocation;                                          // 0x15E8 (size: 0x8)
    class UCameraComponent* FirstPersonCamera;                                        // 0x15F0 (size: 0x8)
    class USceneComponent* CameraHeadJoint;                                           // 0x15F8 (size: 0x8)
    class USkeletalMeshComponent* FPLegs;                                             // 0x1600 (size: 0x8)
    class UPointLightComponent* LanternLight;                                         // 0x1608 (size: 0x8)
    class UPointLightComponent* WristwatchLight;                                      // 0x1610 (size: 0x8)
    class USphereComponent* OverlapTrigger;                                           // 0x1618 (size: 0x8)
    class UAbiotic_CharacterProgressionComponent_C* CharacterProgressionComponent;    // 0x1620 (size: 0x8)
    class USkeletalMeshComponent* Armor_Suit;                                         // 0x1628 (size: 0x8)
    class USkeletalMeshComponent* Armor_Helmet;                                       // 0x1630 (size: 0x8)
    class UStaticMeshComponent* FannyPackMesh;                                        // 0x1638 (size: 0x8)
    class USkeletalMeshComponent* BeardMesh;                                          // 0x1640 (size: 0x8)
    class USkeletalMeshComponent* HeadAccessoryMesh;                                  // 0x1648 (size: 0x8)
    class USkeletalMeshComponent* HairMesh;                                           // 0x1650 (size: 0x8)
    class USkeletalMeshComponent* Armor_Legs;                                         // 0x1658 (size: 0x8)
    class USkeletalMeshComponent* Armor_Arms;                                         // 0x1660 (size: 0x8)
    class USkeletalMeshComponent* Armor_Torso;                                        // 0x1668 (size: 0x8)
    class UWidgetInteractionComponent* WidgetInteraction;                             // 0x1670 (size: 0x8)
    class USceneComponent* ProjectileSpawnLocation;                                   // 0x1678 (size: 0x8)
    class UNavigationInvokerComponent* NavigationInvoker;                             // 0x1680 (size: 0x8)
    class UAbiotic_InventoryComponent_C* CharacterEquipSlotInventory;                 // 0x1688 (size: 0x8)
    class UAbiotic_InventoryComponent_C* CharacterHotbarInventory;                    // 0x1690 (size: 0x8)
    class USpotLightComponent* FlashlightSpotlight;                                   // 0x1698 (size: 0x8)
    class USceneComponent* FPArmHinge;                                                // 0x16A0 (size: 0x8)
    class UWidgetComponent* Wristwatch;                                               // 0x16A8 (size: 0x8)
    class UStaticMeshComponent* TP_ItemInHand;                                        // 0x16B0 (size: 0x8)
    class UStaticMeshComponent* BackpackMesh;                                         // 0x16B8 (size: 0x8)
    class USkeletalMeshComponent* FPArms;                                             // 0x16C0 (size: 0x8)
    class USceneComponent* AimSwayNode;                                               // 0x16C8 (size: 0x8)
    class USkeletalMeshComponent* PantsMesh;                                          // 0x16D0 (size: 0x8)
    class USkeletalMeshComponent* TorsoMesh;                                          // 0x16D8 (size: 0x8)
    class USpotLightComponent* CharacterPane_SpotLight;                               // 0x16E0 (size: 0x8)
    class USceneCaptureComponent2D* CharacterPane_RenderTarget;                       // 0x16E8 (size: 0x8)
    class USpringArmComponent* SpringArm;                                             // 0x16F0 (size: 0x8)
    class USceneComponent* ItemDropPoint;                                             // 0x16F8 (size: 0x8)
    float FlashlightFlickerTimeline_NewTrack_0_5BF063A64DDA7C4244506CB7798A8C23;      // 0x1700 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> FlashlightFlickerTimeline__Direction_5BF063A64DDA7C4244506CB7798A8C23; // 0x1704 (size: 0x1)
    class UTimelineComponent* FlashlightFlickerTimeline;                              // 0x1708 (size: 0x8)
    float ControllerRecoilTimeline_NewTrack_0_AFC3F42148DFC42265088DA509116D45;       // 0x1710 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> ControllerRecoilTimeline__Direction_AFC3F42148DFC42265088DA509116D45; // 0x1714 (size: 0x1)
    class UTimelineComponent* ControllerRecoilTimeline;                               // 0x1718 (size: 0x8)
    float ADS_Zoom_Timeline_Alpha_DFE102FD4B24663C0400BEBF14D78F01;                   // 0x1720 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> ADS_Zoom_Timeline__Direction_DFE102FD4B24663C0400BEBF14D78F01; // 0x1724 (size: 0x1)
    class UTimelineComponent* ADS_Zoom_Timeline;                                      // 0x1728 (size: 0x8)
    float Timeline_1_DamageMultiplyValue_8328351944D630437C0EF497C55C7BAE;            // 0x1730 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_1__Direction_8328351944D630437C0EF497C55C7BAE; // 0x1734 (size: 0x1)
    class UTimelineComponent* Timeline_1;                                             // 0x1738 (size: 0x8)
    float ScreenColorFlashTimeline_NewTrack_0_057EEB42441DFE6AC2A9AA9CD71EB08C;       // 0x1740 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> ScreenColorFlashTimeline__Direction_057EEB42441DFE6AC2A9AA9CD71EB08C; // 0x1744 (size: 0x1)
    class UTimelineComponent* ScreenColorFlashTimeline;                               // 0x1748 (size: 0x8)
    float WindUpDamageTimeline_DamageMultiplyValue_B321CE824694AB824DB932BA7CDEBA2B;  // 0x1750 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> WindUpDamageTimeline__Direction_B321CE824694AB824DB932BA7CDEBA2B; // 0x1754 (size: 0x1)
    class UTimelineComponent* WindUpDamageTimeline;                                   // 0x1758 (size: 0x8)
    float RecoilTimeline_NewTrack_0_7619EC7841CCE2A53A63A7841FB4C01D;                 // 0x1760 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> RecoilTimeline__Direction_7619EC7841CCE2A53A63A7841FB4C01D; // 0x1764 (size: 0x1)
    class UTimelineComponent* RecoilTimeline;                                         // 0x1768 (size: 0x8)
    FVector SwayTimelineLoop_NewTrack_1_1E19F0E74CE5FFB6096EBC86C262A1F2;             // 0x1770 (size: 0x18)
    TEnumAsByte<ETimelineDirection::Type> SwayTimelineLoop__Direction_1E19F0E74CE5FFB6096EBC86C262A1F2; // 0x1788 (size: 0x1)
    class UTimelineComponent* SwayTimelineLoop;                                       // 0x1790 (size: 0x8)
    double BaseTurnRate;                                                              // 0x1798 (size: 0x8)
    double BaseLookUpRate;                                                            // 0x17A0 (size: 0x8)
    double CurrentWalkSpeed;                                                          // 0x17A8 (size: 0x8)
    class UW_PlayerInventory_Main_C* InventoryReference;                              // 0x17B0 (size: 0x8)
    bool IsInventoryOpen;                                                             // 0x17B8 (size: 0x1)
    bool HUD_HiddenByUser;                                                            // 0x17B9 (size: 0x1)
    FTimerHandle CharacterPane3DRotateTimer;                                          // 0x17C0 (size: 0x8)
    FInventorySlotSelected_Struct CurrentHotbarSlotSelected;                          // 0x17C8 (size: 0x10)
    int32 MaxHotbarSlotSelected;                                                      // 0x17D8 (size: 0x4)
    bool IsDeployMode;                                                                // 0x17DC (size: 0x1)
    bool CanPlaceDeployableNow;                                                       // 0x17DD (size: 0x1)
    class AActor* BestInteractable_InteractA;                                         // 0x17E0 (size: 0x8)
    FTimerHandle InteractionFinderTimer;                                              // 0x17E8 (size: 0x8)
    class AAbiotic_PlayerState_C* MyPlayerState;                                      // 0x17F0 (size: 0x8)
    double LastTimeFiredWeapon;                                                       // 0x17F8 (size: 0x8)
    double TimeBetweenPunches;                                                        // 0x1800 (size: 0x8)
    bool Local_KeyHeld_Fire;                                                          // 0x1808 (size: 0x1)
    double PunchDamage;                                                               // 0x1810 (size: 0x8)
    bool TriggeredDeathMessageThisLife;                                               // 0x1818 (size: 0x1)
    class AAbiotic_PlayerController_C* MyPlayerController;                            // 0x1820 (size: 0x8)
    FHitResult CrosshairHit;                                                          // 0x1828 (size: 0xF8)
    double BulletSpread_Base;                                                         // 0x1920 (size: 0x8)
    FVector2D CrosshairOffset;                                                        // 0x1928 (size: 0x10)
    double BaseGunSway_Multiplier;                                                    // 0x1938 (size: 0x8)
    double CurrentGunSway_Speed;                                                      // 0x1940 (size: 0x8)
    FRotator AimSwayRotationCenter;                                                   // 0x1948 (size: 0x18)
    double AimRecoilAdditive;                                                         // 0x1960 (size: 0x8)
    bool Local_KeyHeld_Interact;                                                      // 0x1968 (size: 0x1)
    FTimerHandle InteractionHeldTimer;                                                // 0x1970 (size: 0x8)
    double CurrentHoldToInteractTime;                                                 // 0x1978 (size: 0x8)
    class AActor* BestInteractable_InteractB;                                         // 0x1980 (size: 0x8)
    bool IsViewingWristwatch;                                                         // 0x1988 (size: 0x1)
    bool Local_KeyHeld_Wristwatch;                                                    // 0x1989 (size: 0x1)
    class UActorComponent* BestInteractableComponent;                                 // 0x1990 (size: 0x8)
    int32 CurrentMoney;                                                               // 0x1998 (size: 0x4)
    FAbiotic_PlayerCharacter_CMoney_Changed Money_Changed;                            // 0x19A0 (size: 0x10)
    void Money_Changed();
    class AAbiotic_Item_ParentBP_C* ItemInHand_BP;                                    // 0x19B0 (size: 0x8)
    FTimerHandle Stamina_Timer;                                                       // 0x19B8 (size: 0x8)
    double Stamina_CheckRate;                                                         // 0x19C0 (size: 0x8)
    double Stamina_DrainRate;                                                         // 0x19C8 (size: 0x8)
    double Stamina_RegainRate;                                                        // 0x19D0 (size: 0x8)
    double Stamina_ExertionDelay;                                                     // 0x19D8 (size: 0x8)
    double LastHoldInteractionStartTime;                                              // 0x19E0 (size: 0x8)
    double CurrentSanity;                                                             // 0x19E8 (size: 0x8)
    double MaxSanity;                                                                 // 0x19F0 (size: 0x8)
    class AAbioticActor_C* LastItemInHand_BP;                                         // 0x19F8 (size: 0x8)
    FAbiotic_PlayerCharacter_CSanity_Changed Sanity_Changed;                          // 0x1A00 (size: 0x10)
    void Sanity_Changed();
    bool PerformingInteraction;                                                       // 0x1A10 (size: 0x1)
    bool LastInteractionWasTypeA;                                                     // 0x1A11 (size: 0x1)
    class AActor* LastHoldInteractableAttempted;                                      // 0x1A18 (size: 0x8)
    bool JustExecutedInteraction;                                                     // 0x1A20 (size: 0x1)
    bool Debug_FreeCrafting;                                                          // 0x1A21 (size: 0x1)
    bool Local_KeyHeld_AltFire;                                                       // 0x1A22 (size: 0x1)
    bool IsMeleeWindingUp;                                                            // 0x1A23 (size: 0x1)
    bool IsMeleeWindUpHeld;                                                           // 0x1A24 (size: 0x1)
    double CurrentMeleeDamageMultiplier;                                              // 0x1A28 (size: 0x8)
    bool Flashlight_On;                                                               // 0x1A30 (size: 0x1)
    double TimeLastWarnedFatigue;                                                     // 0x1A38 (size: 0x8)
    double TimeLastWarnedThirst;                                                      // 0x1A40 (size: 0x8)
    double TimeLastWarnedHunger;                                                      // 0x1A48 (size: 0x8)
    FString OverheadName;                                                             // 0x1A50 (size: 0x10)
    bool JustDeployed;                                                                // 0x1A60 (size: 0x1)
    FInventorySlotSelected_Struct Server_LastSelectedHotbarItem;                      // 0x1A68 (size: 0x10)
    class UObject* LastMeshInFPHands;                                                 // 0x1A78 (size: 0x8)
    bool IsUsingTerminal;                                                             // 0x1A80 (size: 0x1)
    class AComputerTerminal_ParentBP_C* CurrentTerminal;                              // 0x1A88 (size: 0x8)
    FAbiotic_PlayerCharacter_CTerminalUseState_Changed TerminalUseState_Changed;      // 0x1A90 (size: 0x10)
    void TerminalUseState_Changed(bool UsingTerminal);
    double TimeOfLastDeath;                                                           // 0x1AA0 (size: 0x8)
    double SittingEyeHeight;                                                          // 0x1AA8 (size: 0x8)
    double Skill_AccuracyMultiplier_StartValue;                                       // 0x1AB0 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_BackpackBP;                                     // 0x1AB8 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_HelmetBP;                                       // 0x1AC0 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_ArmsBP;                                         // 0x1AC8 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_LegsBP;                                         // 0x1AD0 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_SuitBP;                                         // 0x1AD8 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_TorsoBP;                                        // 0x1AE0 (size: 0x8)
    class UMeshComponent* CurrentFPItemMesh;                                          // 0x1AE8 (size: 0x8)
    bool LocalJumpCooldownActive;                                                     // 0x1AF0 (size: 0x1)
    bool Trait_FannyPack;                                                             // 0x1AF1 (size: 0x1)
    double ArmorSlowMultiplier;                                                       // 0x1AF8 (size: 0x8)
    bool Local_KeyHeld_Crouch;                                                        // 0x1B00 (size: 0x1)
    FInventorySlotSelected_Struct CurrentFPItemIndex;                                 // 0x1B08 (size: 0x10)
    FAbiotic_InventoryItemStruct CurrentHeldItemData;                                 // 0x1B18 (size: 0x650)
    bool CurrentHeldItemExists;                                                       // 0x2168 (size: 0x1)
    TArray<class UActorComponent*> LastHighlightedInteractComponents;                 // 0x2170 (size: 0x10)
    FText InteractWithText;                                                           // 0x2180 (size: 0x10)
    bool IsPlugPlacementMode;                                                         // 0x2190 (size: 0x1)
    class APowerSocket_ParentBP_C* CurrentPlugCableSocket;                            // 0x2198 (size: 0x8)
    FTimerHandle SanityTimer;                                                         // 0x21A0 (size: 0x8)
    double Sanity_CheckRate;                                                          // 0x21A8 (size: 0x8)
    FTimerHandle LightValueTimer;                                                     // 0x21B0 (size: 0x8)
    float LightValueCheckTime;                                                        // 0x21B8 (size: 0x4)
    double LastAuditoryHallucination;                                                 // 0x21C0 (size: 0x8)
    TArray<TSoftObjectPtr<USoundCue>> HallucinationSounds_Innocent;                   // 0x21C8 (size: 0x10)
    TArray<TSoftObjectPtr<USoundCue>> HallucinationSounds_Hostile;                    // 0x21D8 (size: 0x10)
    double PreviousRadiation;                                                         // 0x21E8 (size: 0x8)
    FName CurrentPerformingEmote;                                                     // 0x21F0 (size: 0x8)
    class UAnimMontage* LastKnownLoadedEmote;                                         // 0x21F8 (size: 0x8)
    FEmote_Struct LastEmoteData;                                                      // 0x2200 (size: 0xF0)
    class UStaticMeshComponent* FPPlugMesh;                                           // 0x22F0 (size: 0x8)
    double FallDamageResistance;                                                      // 0x22F8 (size: 0x8)
    double MaxInventoryWeight;                                                        // 0x2300 (size: 0x8)
    FAbiotic_PlayerCharacter_CInventoryWeight_Changed InventoryWeight_Changed;        // 0x2308 (size: 0x10)
    void InventoryWeight_Changed();
    double DefaultMaxStamina;                                                         // 0x2318 (size: 0x8)
    double DefaultMaxInventoryWeight;                                                 // 0x2320 (size: 0x8)
    bool LanternLight_On;                                                             // 0x2328 (size: 0x1)
    FString Asset ID;                                                                 // 0x2330 (size: 0x10)
    FTimerHandle PlayerLocHandle;                                                     // 0x2340 (size: 0x8)
    FVector LastZiplineVelocity;                                                      // 0x2348 (size: 0x18)
    int32 MeleeSwingIndex;                                                            // 0x2360 (size: 0x4)
    FMeleeSwingStyle_Struct ClientLastMeleeSwingStyleData;                            // 0x2368 (size: 0x80)
    class UDecalComponent* CrosshairDecal;                                            // 0x23E8 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_HeadlampBP;                                     // 0x23F0 (size: 0x8)
    bool HeadlampOn;                                                                  // 0x23F8 (size: 0x1)
    class UW_RadialWheel_ParentBP_C* RadialWheel;                                     // 0x2400 (size: 0x8)
    FName ChosenEmote;                                                                // 0x2408 (size: 0x8)
    double CurrentJumpHeight;                                                         // 0x2410 (size: 0x8)
    FAbiotic_InventoryChangeableDataStruct Carryover Changeable Data;                 // 0x2418 (size: 0x88)
    class UW_PlayerHUD_RecipeVBox_C* RecipeUnlockVBox;                                // 0x24A0 (size: 0x8)
    FTimerHandle SneakingXPTimer;                                                     // 0x24A8 (size: 0x8)
    double DeadEyeHeight;                                                             // 0x24B0 (size: 0x8)
    bool DangerousIngestionWarning;                                                   // 0x24B8 (size: 0x1)
    double CrouchAlpha;                                                               // 0x24C0 (size: 0x8)
    double CrouchInterpSpeed;                                                         // 0x24C8 (size: 0x8)
    bool CanUseJetpack;                                                               // 0x24D0 (size: 0x1)
    class UCurveFloat* JetpackCurve;                                                  // 0x24D8 (size: 0x8)
    float AccsCameraShakeAmount;                                                      // 0x24E0 (size: 0x4)
    bool Ctrls_InvertYAxis;                                                           // 0x24E4 (size: 0x1)
    double Ctrls_MouseXSensitivity;                                                   // 0x24E8 (size: 0x8)
    FTimerHandle FireDelayTimer;                                                      // 0x24F0 (size: 0x8)
    float Axis Value Forward;                                                         // 0x24F8 (size: 0x4)
    bool LocalUsingAutoMove;                                                          // 0x24FC (size: 0x1)
    double Liquid Percentage Remains;                                                 // 0x2500 (size: 0x8)
    TArray<class UAbiotic_InventoryComponent_C*> Additional Inventories;              // 0x2508 (size: 0x10)
    bool PendingNonHotbarUsage;                                                       // 0x2518 (size: 0x1)
    class UStaticMeshComponent* ClipboardMesh;                                        // 0x2520 (size: 0x8)
    FString CurrentFPItemAssetID;                                                     // 0x2528 (size: 0x10)
    TEnumAsByte<E_AnimInteractState::Type> InteractAnimationState;                    // 0x2538 (size: 0x1)
    double Ctrls_MouseYSensitivity;                                                   // 0x2540 (size: 0x8)
    double Ctrls_GamepadXSensitivity;                                                 // 0x2548 (size: 0x8)
    double Ctrls_GamepadYSensitivity;                                                 // 0x2550 (size: 0x8)
    class UMaterialInstanceDynamic* CrosshairDecalMaterial;                           // 0x2558 (size: 0x8)
    FTimerHandle ProjectilePathTimer;                                                 // 0x2560 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_TrinketBP;                                      // 0x2568 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_WristwatchBP;                                   // 0x2570 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_HackingDeviceBP;                                // 0x2578 (size: 0x8)
    bool HasProcessedMeleeDurability;                                                 // 0x2580 (size: 0x1)
    class UStaticMesh* HologramArrowMesh;                                             // 0x2588 (size: 0x8)
    FVector WristwatchPointLightLocation;                                             // 0x2590 (size: 0x18)
    int32 LastSelectedHotbarSlot;                                                     // 0x25A8 (size: 0x4)
    bool RangedWeaponInRange;                                                         // 0x25AC (size: 0x1)
    bool Local_CrosshairHidden;                                                       // 0x25AD (size: 0x1)
    bool IsWeaponThrowReady;                                                          // 0x25AE (size: 0x1)
    bool IsWeaponThrowHeld;                                                           // 0x25AF (size: 0x1)
    double CurrentThrowWeaponDistanceMultiplier;                                      // 0x25B0 (size: 0x8)
    double AmbientTemp;                                                               // 0x25B8 (size: 0x8)
    double CallForHelpStartTime;                                                      // 0x25C0 (size: 0x8)
    class UMaterialInterface* DefaultLightFunction;                                   // 0x25C8 (size: 0x8)
    bool UsingSniperScope;                                                            // 0x25D0 (size: 0x1)
    bool CrosshairCenterNoSway;                                                       // 0x25D1 (size: 0x1)
    bool UnderwaterFXActive;                                                          // 0x25D2 (size: 0x1)
    class UStaticMesh* CurrentDeployHologram;                                         // 0x25D8 (size: 0x8)
    double LadderUpDownBias;                                                          // 0x25E0 (size: 0x8)
    bool MeleeOnlyTargets;                                                            // 0x25E8 (size: 0x1)
    TArray<double> ArmorWeightClasses;                                                // 0x25F0 (size: 0x10)
    FRotator LastMeleeSwingRotation;                                                  // 0x2600 (size: 0x18)
    class UMaterialInstanceDynamic* RadiationPostProcess;                             // 0x2618 (size: 0x8)
    double RadiationPostProcessAlpha;                                                 // 0x2620 (size: 0x8)
    bool ServerLevelLoaded;                                                           // 0x2628 (size: 0x1)
    bool OwningLevelLoaded;                                                           // 0x2629 (size: 0x1)
    class AAbiotic_PlayerFreezeJail_C* JailActor;                                     // 0x2630 (size: 0x8)
    bool HeldItemIsCooking;                                                           // 0x2638 (size: 0x1)
    double LastTimeCookingThrowable;                                                  // 0x2640 (size: 0x8)
    TArray<class USceneComponent*> ChildrenComponentsToDestroy;                       // 0x2648 (size: 0x10)
    float Axis Value Right;                                                           // 0x2658 (size: 0x4)
    bool HasRecentlyTeleported;                                                       // 0x265C (size: 0x1)
    FAbiotic_PlayerCharacter_COnHungerRestored OnHungerRestored;                      // 0x2660 (size: 0x10)
    void OnHungerRestored(double CurrentHunger);
    FAbiotic_PlayerCharacter_COnThirstRestored OnThirstRestored;                      // 0x2670 (size: 0x10)
    void OnThirstRestored(double CurrentThirst);
    class AItem_Gear_ParentBP_C* Gear_ShieldBP;                                       // 0x2680 (size: 0x8)
    bool ShieldHeld;                                                                  // 0x2688 (size: 0x1)
    double HotbarSlotChangedTimestamp;                                                // 0x2690 (size: 0x8)
    float RollStartTime;                                                              // 0x2698 (size: 0x4)
    FAbiotic_PlayerCharacter_CCharacter_Emoted Character_Emoted;                      // 0x26A0 (size: 0x10)
    void Character_Emoted(FName EmoteRow);
    FRotator ScopeSwayRotation;                                                       // 0x26B0 (size: 0x18)
    class UCurveVector* ScopeSwayCurve;                                               // 0x26C8 (size: 0x8)
    double ScopeSwayTime;                                                             // 0x26D0 (size: 0x8)
    double ScopeSwaySpeed;                                                            // 0x26D8 (size: 0x8)
    bool SprintKeyHeld;                                                               // 0x26E0 (size: 0x1)
    bool ScopeHoldBreath;                                                             // 0x26E1 (size: 0x1)
    TArray<FBuffDebuffRowHandle> CurrentSetBonuses;                                   // 0x26E8 (size: 0x10)
    FAbiotic_PlayerCharacter_COnCurrentSetBonusesUpdated OnCurrentSetBonusesUpdated;  // 0x26F8 (size: 0x10)
    void OnCurrentSetBonusesUpdated(class AAbiotic_PlayerCharacter_C* OwningCharacter);
    bool DoingThrowAnimation;                                                         // 0x2708 (size: 0x1)
    class UAudioComponent* DBNOHeartbeat;                                             // 0x2710 (size: 0x8)
    bool IsSquinting;                                                                 // 0x2718 (size: 0x1)
    double Last_ADS_FOV;                                                              // 0x2720 (size: 0x8)
    FRotator RecoilTimelineStartRotation;                                             // 0x2728 (size: 0x18)
    class UMaterialInstanceDynamic* CrosshairDecalMaterial_Shotgun;                   // 0x2740 (size: 0x8)
    class APowerSocket_ParentBP_C* LastPlugCableSocket;                               // 0x2748 (size: 0x8)
    TArray<FAbioticItemCount_Struct> CableRerouteCost;                                // 0x2750 (size: 0x10)
    double DistanceForSubtitles;                                                      // 0x2760 (size: 0x8)
    FTimerHandle Equip_ClearFireDelayTimer;                                           // 0x2768 (size: 0x8)
    bool TempShieldHolster;                                                           // 0x2770 (size: 0x1)
    FAbiotic_PlayerCharacter_COnShieldHeldUpdated OnShieldHeldUpdated;                // 0x2778 (size: 0x10)
    void OnShieldHeldUpdated(bool ShieldHeld);
    class UCurveFloat* LaserSightCurve_Pistol;                                        // 0x2788 (size: 0x8)
    class UCurveFloat* LaserSightCurve_Shotgun;                                       // 0x2790 (size: 0x8)
    FName CurrentItemRow;                                                             // 0x2798 (size: 0x8)
    bool Ctrls_ToggleSprint;                                                          // 0x27A0 (size: 0x1)
    bool AccsStaticInteractPrompt;                                                    // 0x27A1 (size: 0x1)
    bool IsFirstPerson;                                                               // 0x27A2 (size: 0x1)
    bool EmoteShouldHideFP;                                                           // 0x27A3 (size: 0x1)
    class UMaterialInstanceDynamic* Hot Post Process;                                 // 0x27A8 (size: 0x8)
    class UCurveFloat* TemperatureUICurve;                                            // 0x27B0 (size: 0x8)
    class UMaterialInstanceDynamic* Cold Post Process;                                // 0x27B8 (size: 0x8)
    double CurrentTemperatureFXAlpha;                                                 // 0x27C0 (size: 0x8)
    class UCurveFloat* TemperaturePPCurve;                                            // 0x27C8 (size: 0x8)
    class UAudioComponent* UnderwaterSound;                                           // 0x27D0 (size: 0x8)
    int32 CurrentWeaponBurstCounter;                                                  // 0x27D8 (size: 0x4)
    bool FiringWeaponBurst;                                                           // 0x27DC (size: 0x1)
    double Light_FlickeringIntensityLow;                                              // 0x27E0 (size: 0x8)
    double Light_DefaultIntensity;                                                    // 0x27E8 (size: 0x8)
    float Light_FlickerAlpha;                                                         // 0x27F0 (size: 0x4)
    bool LightFlickerEnabled;                                                         // 0x27F4 (size: 0x1)
    class UAudioComponent* ActiveNPCMusic;                                            // 0x27F8 (size: 0x8)
    double Lantern_DefaultIntensity;                                                  // 0x2800 (size: 0x8)
    class AItem_Gear_ParentBP_C* Gear_Trinket2_BP;                                    // 0x2808 (size: 0x8)
    bool IsCurrentlyOfferingItem;                                                     // 0x2810 (size: 0x1)
    bool PagerOn;                                                                     // 0x2811 (size: 0x1)
    double StaminaLoss_Jumping;                                                       // 0x2818 (size: 0x8)
    FTimerHandle ReloadHeldTimer;                                                     // 0x2820 (size: 0x8)
    FVector LastActorLocation;                                                        // 0x2828 (size: 0x18)
    float Last AFKInput Time Stamp;                                                   // 0x2840 (size: 0x4)
    double TimeToAFK;                                                                 // 0x2848 (size: 0x8)
    FAbiotic_PlayerCharacter_COnGearVisualStatus_Updated OnGearVisualStatus_Updated;  // 0x2850 (size: 0x10)
    void OnGearVisualStatus_Updated();
    class UMeshComponent* ShieldComponent_TP;                                         // 0x2860 (size: 0x8)
    class UMeshComponent* ShieldComponent_FP;                                         // 0x2868 (size: 0x8)
    FAbiotic_PlayerCharacter_CAimDownSights_Changed AimDownSights_Changed;            // 0x2870 (size: 0x10)
    void AimDownSights_Changed(bool UsingSniperScope, bool IsSquinting);
    bool ShouldBlockCrouchInput;                                                      // 0x2880 (size: 0x1)
    class ADayNightManager_C* Local_DayNightManager;                                  // 0x2888 (size: 0x8)
    bool InfiniteAmmo;                                                                // 0x2890 (size: 0x1)
    class UAbioticPhysicalMaterial* FloorMaterial;                                    // 0x2898 (size: 0x8)
    FBuffDebuffRowHandle LastShield;                                                  // 0x28A0 (size: 0x20)
    FTimerHandle OutOfMyWayTimer;                                                     // 0x28C0 (size: 0x8)
    FGameplayTagContainer IgnoredDamageResistanceTags;                                // 0x28C8 (size: 0x20)
    FString LocalOverheadName;                                                        // 0x28E8 (size: 0x10)
    bool JustSetCableConnection;                                                      // 0x28F8 (size: 0x1)
    double LastTimeSprintingStarted;                                                  // 0x2900 (size: 0x8)
    TArray<class AAbioticDeployed_ParentBP_C*> LastFurnitureLookedAtQueue;            // 0x2908 (size: 0x10)
    bool GridSnapping;                                                                // 0x2918 (size: 0x1)
    int32 ThrownProjectileLastIndex;                                                  // 0x291C (size: 0x4)
    TEnumAsByte<E_AttackMissed::Type> LastAttackMissed;                               // 0x2920 (size: 0x1)
    bool BattleChargeActive;                                                          // 0x2921 (size: 0x1)
    bool KillLookAtTarget;                                                            // 0x2922 (size: 0x1)
    bool CurrentlyViewingWristwatch;                                                  // 0x2923 (size: 0x1)
    bool Local_ReadyToControlPlayer;                                                  // 0x2924 (size: 0x1)
    class AAbioticDeployed_ParentBP_C* LastDeployedActor;                             // 0x2928 (size: 0x8)
    bool ThrowUnderhand;                                                              // 0x2930 (size: 0x1)
    double LastMontageLength;                                                         // 0x2938 (size: 0x8)
    class AAbiotic_Character_ParentBP_C* LastLookingAtCharacter;                      // 0x2940 (size: 0x8)
    bool NonHotbarUsageSecondary;                                                     // 0x2948 (size: 0x1)
    FAbiotic_PlayerCharacter_COnTeleporterUsed OnTeleporterUsed;                      // 0x2950 (size: 0x10)
    void OnTeleporterUsed(class AAbiotic_PlayerCharacter_C* Character, class AActor* TeleportCause);
    FTimerHandle LocalReloadTickTimer;                                                // 0x2960 (size: 0x8)
    FLinearColor DefaultWatchLightColor;                                              // 0x2968 (size: 0x10)
