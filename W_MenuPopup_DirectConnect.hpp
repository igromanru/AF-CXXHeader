...
class UW_MenuPopup_DirectConnect_C : public UUserWidget
{
    ...
    class UCircularThrobber* CircularThrobber_0;                                      // 0x0320 (size: 0x8)
    class UVerticalBox* ConnectType_IP;                                               // 0x0328 (size: 0x8)
    class UVerticalBox* ConnectType_JoinCode;                                         // 0x0330 (size: 0x8)
    class UTextBlock* ErrorText;                                                      // 0x0338 (size: 0x8)
    class UImage* Image;                                                              // 0x0340 (size: 0x8)
    class UImage* Image_159;                                                          // 0x0348 (size: 0x8)
    class UImage* Image_275;                                                          // 0x0350 (size: 0x8)
