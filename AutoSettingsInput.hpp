...
class UAutoSettingsInputConfig : public UDeveloperSettings
{
    ...
    TArray<FKey> BindingClearKeys;                                                    // 0x0130 (size: 0x10)
    float MouseMoveCaptureDistance;                                                   // 0x0140 (size: 0x4)
    TArray<FAxisAssociation> AxisAssociations;                                        // 0x0148 (size: 0x10)
    TArray<FName> BlacklistedActions;                                                 // 0x0158 (size: 0x10)
    TArray<FName> BlacklistedAxes;                                                    // 0x0168 (size: 0x10)
...
class UKeyLabel : public UUserWidget
{
    ...
    bool bUseIcon;                                                                    // 0x0318 (size: 0x1)
    float AxisScale;                                                                  // 0x031C (size: 0x4)
