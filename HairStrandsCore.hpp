...
{
    class UGroomAsset* GroomAsset;                                                    // 0x0568 (size: 0x8)
    class UGroomCache* GroomCache;                                                    // 0x0570 (size: 0x8)
    TArray<class UNiagaraComponent*> NiagaraComponents;                               // 0x0578 (size: 0x10)
    class USkeletalMesh* SourceSkeletalMesh;                                          // 0x0588 (size: 0x8)
    class UGroomBindingAsset* BindingAsset;                                           // 0x0590 (size: 0x8)
    class UPhysicsAsset* PhysicsAsset;                                                // 0x0598 (size: 0x8)
    FHairSimulationSettings SimulationSettings;                                       // 0x05B0 (size: 0x90)
    class UMeshDeformer* MeshDeformer;                                                // 0x0640 (size: 0x8)
    class UMeshDeformerInstance* MeshDeformerInstance;                                // 0x0648 (size: 0x8)
    class UMeshDeformerInstanceSettings* MeshDeformerInstanceSettings;                // 0x0650 (size: 0x8)
    class UMaterialInterface* Strands_DebugMaterial;                                  // 0x0658 (size: 0x8)
    class UMaterialInterface* Strands_DefaultMaterial;                                // 0x0660 (size: 0x8)
    class UMaterialInterface* Cards_DefaultMaterial;                                  // 0x0668 (size: 0x8)
    class UMaterialInterface* Meshes_DefaultMaterial;                                 // 0x0670 (size: 0x8)
    class UNiagaraSystem* AngularSpringsSystem;                                       // 0x0678 (size: 0x8)
    class UNiagaraSystem* CosseratRodsSystem;                                         // 0x0680 (size: 0x8)
    FString AttachmentName;                                                           // 0x0688 (size: 0x10)
    TArray<FHairGroupDesc> GroomGroupsDesc;                                           // 0x0720 (size: 0x10)
    bool bUseCards;                                                                   // 0x0730 (size: 0x1)
    bool bRunning;                                                                    // 0x0731 (size: 0x1)
    bool bLooping;                                                                    // 0x0732 (size: 0x1)
    bool bManualTick;                                                                 // 0x0733 (size: 0x1)
    float ElapsedTime;                                                                // 0x0734 (size: 0x4)
