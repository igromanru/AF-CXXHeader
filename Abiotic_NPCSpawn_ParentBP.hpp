...
class AAbiotic_NPCSpawn_ParentBP_C : public AActor
{
    ...
    double SpawnCooldown_Default;                                                     // 0x0340 (size: 0x8)
    double PlayerWithinDistanceToSpawn;                                               // 0x0348 (size: 0x8)
    TEnumAsByte<ETimesOfDay::Type> AllowableSpawnHours;                               // 0x0350 (size: 0x1)
    int32 PlayersRequiredToSpawn;                                                     // 0x0354 (size: 0x4)
    TMap<class FName, class FName> NPCSpawnsByFlag;                                   // 0x0358 (size: 0x50)
    TArray<class ANPC_Base_ParentBP_C*> CurrentNPCs;                                  // 0x03A8 (size: 0x10)
    int32 NPCsAllowedFromSpawn;                                                       // 0x03B8 (size: 0x4)
    TArray<class AAI_PatrolPath_C*> PotentialPatrolPaths;                             // 0x03C0 (size: 0x10)
    bool PatrolOnlyActiveAfterCombat;                                                 // 0x03D0 (size: 0x1)
    bool CanSpawnInLineOfSight;                                                       // 0x03D1 (size: 0x1)
    TEnumAsByte<ENPCAwarenessState::Type> AwarenessState;                             // 0x03D2 (size: 0x1)
    bool StationaryUntilPlayerEncounter;                                              // 0x03D3 (size: 0x1)
    bool AlwaysPassDistanceCheck;                                                     // 0x03D4 (size: 0x1)
    int32 DirectorFailCounter;                                                        // 0x03D8 (size: 0x4)
    class AAbiotic_AIDirector_C* AI Director;                                         // 0x03E0 (size: 0x8)
    bool NoLoot;                                                                      // 0x03E8 (size: 0x1)
    TArray<FAbiotic_NPCSpawnsStruct> NPCsToSpawn;                                     // 0x03F0 (size: 0x10)
    int32 NPC Level;                                                                  // 0x0400 (size: 0x4)
    bool OnlySpawnOnce;                                                               // 0x0404 (size: 0x1)
    bool HasSpawnedOnce;                                                              // 0x0405 (size: 0x1)
    bool SpawnedViaTrigger;                                                           // 0x0406 (size: 0x1)
    bool WorldSaveHasModified;                                                        // 0x0407 (size: 0x1)
    bool SpawnWithEffect;                                                             // 0x0408 (size: 0x1)
    class UAnimMontage* MontageOnSpawn;                                               // 0x0410 (size: 0x8)
    bool Debug;                                                                       // 0x0418 (size: 0x1)
    bool AlwaysDropGibs;                                                              // 0x0419 (size: 0x1)
    FAbiotic_NPCSpawn_ParentBP_CCooldownUpdated CooldownUpdated;                      // 0x0420 (size: 0x10)
    void CooldownUpdated();
    bool ManualSpawn;                                                                 // 0x0430 (size: 0x1)
    bool Spawn Without Squad;                                                         // 0x0431 (size: 0x1)
    bool NeverBlockedByInhibitors;                                                    // 0x0432 (size: 0x1)
    TArray<FTransform> SpawnTransforms;                                               // 0x0438 (size: 0x10)
