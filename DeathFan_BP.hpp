...
class ADeathFan_BP_C : public AAbioticActor_C
{
    ...
    class UBoxComponent* DeathBox;                                                    // 0x02D0 (size: 0x8)
    class UStaticMeshComponent* Mesh;                                                 // 0x02D8 (size: 0x8)
    class URotatingMovementComponent* RotatingMovement;                               // 0x02E0 (size: 0x8)
    bool FanActive;                                                                   // 0x02E8 (size: 0x1)
    class AGenerator_ParentBP_C* ParentGenerator;                                     // 0x02F0 (size: 0x8)
    bool FanOnlyNoDeath;                                                              // 0x02F8 (size: 0x1)
