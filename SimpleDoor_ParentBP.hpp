...
class ASimpleDoor_ParentBP_C : public AAbioticActor_C
{
    ...
    class UNavModifierComponent* Door_NavBlocker;                                     // 0x02E0 (size: 0x8)
    class UTextRenderComponent* EditorTextLockedSide;                                 // 0x02E8 (size: 0x8)
    class UBoxComponent* KickKnockbackZone;                                           // 0x02F0 (size: 0x8)
    class USceneComponent* DoorCenter;                                                // 0x02F8 (size: 0x8)
    class USceneComponent* MoveThroughInward;                                         // 0x0300 (size: 0x8)
    class USceneComponent* MoveThroughOutward;                                        // 0x0308 (size: 0x8)
    class UStaticMeshComponent* EditorOutwardDoorMesh;                                // 0x0310 (size: 0x8)
    class UStaticMeshComponent* EditorInwardDoorMesh;                                 // 0x0318 (size: 0x8)
    class USceneComponent* EditorOutwardRoot;                                         // 0x0320 (size: 0x8)
    class USceneComponent* EditorInwardRoot;                                          // 0x0328 (size: 0x8)
    class UStaticMeshComponent* DoorMesh;                                             // 0x0330 (size: 0x8)
    class USceneComponent* DoorRotationRoot;                                          // 0x0338 (size: 0x8)
    class UArrowComponent* Back;                                                      // 0x0340 (size: 0x8)
    class UArrowComponent* Front;                                                     // 0x0348 (size: 0x8)
    float ChangeDoorState_NewTrack_0_99922EB94C1739893298C0AB4B22DF23;                // 0x0350 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> ChangeDoorState__Direction_99922EB94C1739893298C0AB4B22DF23; // 0x0354 (size: 0x1)
    class UTimelineComponent* ChangeDoorState;                                        // 0x0358 (size: 0x8)
    TEnumAsByte<E_DoorStates::Type> DoorState;                                        // 0x0360 (size: 0x1)
    FRotator BeginTimelineRotation;                                                   // 0x0368 (size: 0x18)
    TEnumAsByte<E_DoorSwingAllowance::Type> DoorSwingAllowance;                       // 0x0380 (size: 0x1)
    FRotator ClosedRotation;                                                          // 0x0388 (size: 0x18)
    FRotator OpenOutwardRotation;                                                     // 0x03A0 (size: 0x18)
    FRotator OpenInwardRotation;                                                      // 0x03B8 (size: 0x18)
    int32 DoorStyle;                                                                  // 0x03D0 (size: 0x4)
    int32 DoorTexture;                                                                // 0x03D4 (size: 0x4)
    TSoftObjectPtr<UMaterialInterface> DoorSignTexture;                               // 0x03D8 (size: 0x28)
    double MaxOutwardDegrees;                                                         // 0x0400 (size: 0x8)
    double MaxInwardDegrees;                                                          // 0x0408 (size: 0x8)
    bool Flipped;                                                                     // 0x0410 (size: 0x1)
    TEnumAsByte<E_DoorStates::Type> LastSideInteractedFrom;                           // 0x0411 (size: 0x1)
    bool OneWayDoor;                                                                  // 0x0412 (size: 0x1)
    bool OneWayDoor_HasBeenUnlocked;                                                  // 0x0413 (size: 0x1)
    class ASimpleDoor_ParentBP_C* LinkedDoor;                                         // 0x0418 (size: 0x8)
    bool ShareDoorStateWithLinkedDoor;                                                // 0x0420 (size: 0x1)
    TArray<class AActor*> IgnoreActorsWhenSwinging;                                   // 0x0428 (size: 0x10)
    FSaveData_Door_Struct DoorSaveData;                                               // 0x0438 (size: 0x38)
    class AButton_Generic_C* ButtonTiedToLockMechanism;                               // 0x0470 (size: 0x8)
    double LastDoorTime;                                                              // 0x0478 (size: 0x8)
    bool ToiletLocked;                                                                // 0x0480 (size: 0x1)
    class AActor* LastInteractor;                                                     // 0x0488 (size: 0x8)
    TEnumAsByte<E_DoorStates::Type> PreviousDoorState;                                // 0x0490 (size: 0x1)
    TArray<class AActor*> StoppedByActors;                                            // 0x0498 (size: 0x10)
    class AToilet_ParentBP_C* LinkedToilet;                                           // 0x04A8 (size: 0x8)
    TArray<class AActor*> DoorSwingIgnoreActors;                                      // 0x04B0 (size: 0x10)
    double TimeNPCLastInteractedWith;                                                 // 0x04C0 (size: 0x8)
    bool FakeDoor;                                                                    // 0x04C8 (size: 0x1)
    double DoorYawRot;                                                                // 0x04D0 (size: 0x8)
    class AButton_Generic_C* ButtonToForceMeOpen;                                     // 0x04D8 (size: 0x8)
    FSimpleDoor_ParentBP_CDoorStateChanged DoorStateChanged;                          // 0x04E0 (size: 0x10)
    void DoorStateChanged();
    bool DoorDisabled;                                                                // 0x04F0 (size: 0x1)
    class USoundBase* DoorSFX;                                                        // 0x04F8 (size: 0x8)
    bool NoVignetteReset;                                                             // 0x0500 (size: 0x1)
    FWorldFlagRowHandle WorldFlagToUnlock;                                            // 0x0508 (size: 0x20)
    double DoorSwingRateDefault;                                                      // 0x0528 (size: 0x8)
    bool NeverBeBlocked;                                                              // 0x0530 (size: 0x1)
    bool CanAutoClose;                                                                // 0x0531 (size: 0x1)
    bool IgnoreForcedDoorTexture;                                                     // 0x0532 (size: 0x1)
