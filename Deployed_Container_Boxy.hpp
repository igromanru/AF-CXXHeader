...
class ADeployed_Container_Boxy_C : public ADeployed_Container_Cargo_C
{
    ...
    FRotator LidClosedRot;                                                            // 0x0958 (size: 0x18)
    FRotator LidOpenRot;                                                              // 0x0970 (size: 0x18)
    class UAbiotic_InventoryComponent_C* RemoteInventoryReference;                    // 0x0988 (size: 0x8)
    FDeployed_Container_Boxy_COnContainerOpened OnContainerOpened;                    // 0x0990 (size: 0x10)
