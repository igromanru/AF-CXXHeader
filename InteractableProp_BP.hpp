#ifndef UE4SS_SDK_InteractableProp_BP_HPP
#define UE4SS_SDK_InteractableProp_BP_HPP

class AInteractableProp_BP_C : public AAbioticActor_C
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x02D0 (size: 0x8)
    class UStaticMeshComponent* InteractionMesh;                                      // 0x02D8 (size: 0x8)
    bool CustomButtonPromptLocation;                                                  // 0x02E0 (size: 0x1)
    TArray<FDataTableRowHandle> JournalEntriesOnInteract;                             // 0x02E8 (size: 0x10)
    TArray<FDataTableRowHandle> RecipesOnInteract;                                    // 0x02F8 (size: 0x10)
    TArray<FDataTableRowHandle> CustomizationUnlocksOnInteract;                       // 0x0308 (size: 0x10)
    FText ObjectDisplayText;                                                          // 0x0318 (size: 0x10)
    FText Interact Text;                                                              // 0x0328 (size: 0x10)
    TArray<FString> RetrievedByPlayers;                                               // 0x0338 (size: 0x10)
    ...
    void ExecuteUbergraph_InteractableProp_BP(int32 EntryPoint);
}; // Size: 0x348
