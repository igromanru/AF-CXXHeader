...
class UW_MainMenu_Background_Entry_C : public UUserWidget
{
    ...
    class UImage* NewItemHighlight;                                                   // 0x02F8 (size: 0x8)
    class UCheckBox* RecipeCheckbox;                                                  // 0x0300 (size: 0x8)
    class UImage* SelectionHighlight;                                                 // 0x0308 (size: 0x8)
    class UBackgroundEntryItem* BackgroundEntryItem;                                  // 0x0310 (size: 0x8)
    class ULevelStreaming* LevelToEnable;                                             // 0x0318 (size: 0x8)
