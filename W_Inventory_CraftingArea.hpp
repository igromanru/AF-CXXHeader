...
class UW_Inventory_CraftingArea_C : public UUserWidget
{
    ...
    class UVerticalBox* VBox_CraftingGridButtons;                                     // 0x04E0 (size: 0x8)
    class UW_BenchUpgradeScreen_C* W_BenchUpgradeScreen;                              // 0x04E8 (size: 0x8)
    class UW_CraftingListEmptyMessage_C* W_CraftingListEmptyMessage;                  // 0x04F0 (size: 0x8)
    class UW_Research_Microscope_C* W_Research_Microscope;                            // 0x04F8 (size: 0x8)
    class UW_Research_RecipeGuesser_C* W_Research_RecipeGuesser;                      // 0x0500 (size: 0x8)
    class UW_RecipeFilterTab_C* W_Tab_Construction;                                   // 0x0508 (size: 0x8)
    class UW_RecipeFilterTab_C* W_Tab_Defense;                                        // 0x0510 (size: 0x8)
    class UW_RecipeFilterTab_C* W_Tab_Electricity;                                    // 0x0518 (size: 0x8)
    class UW_RecipeFilterTab_C* W_Tab_Farming;                                        // 0x0520 (size: 0x8)
    class UW_RecipeFilterTab_C* W_Tab_Fav;                                            // 0x0528 (size: 0x8)
    class UW_RecipeFilterTab_C* W_Tab_Food;                                           // 0x0530 (size: 0x8)
    class UW_RecipeFilterTab_C* W_Tab_Gear;                                           // 0x0538 (size: 0x8)
    class UW_RecipeFilterTab_C* W_Tab_General;                                        // 0x0540 (size: 0x8)
    class UW_RecipeFilterTab_C* W_Tab_Health;                                         // 0x0548 (size: 0x8)
    class UW_RecipeFilterTab_C* W_Tab_Resources;                                      // 0x0550 (size: 0x8)
    class UW_RecipeFilterTab_C* W_Tab_Tools;                                          // 0x0558 (size: 0x8)
    class UW_RecipeFilterTab_C* W_Tab_Vehicles;                                       // 0x0560 (size: 0x8)
    class UW_RecipeFilterTab_C* W_Tab_Weapons;                                        // 0x0568 (size: 0x8)
    class UWidgetSwitcher* WidgetSwitcher_CraftingMain;                               // 0x0570 (size: 0x8)
    class UWidgetSwitcher* WidgetSwitcher_EmptyList;                                  // 0x0578 (size: 0x8)
    bool PlayerCraftingOnly;                                                          // 0x0580 (size: 0x1)
    FDataTableRowHandle SelectedItemToCraft;                                          // 0x0588 (size: 0x10)
    FAbioticRecipe_Struct SelectedRecipe;                                             // 0x0598 (size: 0xB8)
    FButtonStyle CraftButton_Style_Allowed;                                           // 0x0650 (size: 0x3F0)
    FButtonStyle CraftButton_Style_Disallowed;                                        // 0x0A40 (size: 0x3F0)
    bool Allowed to Craft;                                                            // 0x0E30 (size: 0x1)
    class AAbiotic_PlayerCharacter_C* CraftingPlayerCharacter;                        // 0x0E38 (size: 0x8)
    bool UsingBench;                                                                  // 0x0E40 (size: 0x1)
    bool ShowCraftingProgressBar;                                                     // 0x0E41 (size: 0x1)
    double CurrentCraftingBarPercent;                                                 // 0x0E48 (size: 0x8)
    double TimeToCraft;                                                               // 0x0E50 (size: 0x8)
    TArray<FName> PlayerCraftingExtraCostItems;                                       // 0x0E58 (size: 0x10)
    TArray<FDataTableRowHandle> Benches Available;                                    // 0x0E68 (size: 0x10)
    TEnumAsByte<E_RecipeCategory::Type> CurrentRecipeFilter;                          // 0x0E78 (size: 0x1)
    bool Favorites;                                                                   // 0x0E79 (size: 0x1)
    class UCheckBox* CurrentlyCheckedCheckbox;                                        // 0x0E80 (size: 0x8)
    bool ShowOnlyAvailableRecipes;                                                    // 0x0E88 (size: 0x1)
    class UCraftingEntryItem* LastSelectedRecipe_ItemRow;                             // 0x0E90 (size: 0x8)
    class AAbioticDeployed_CraftingBench_ParentBP_C* BenchRef;                        // 0x0E98 (size: 0x8)
    class UDataTable* Recipe Table;                                                   // 0x0EA0 (size: 0x8)
    class UCraftingEntryItem* LastSelectedRecipe;                                     // 0x0EA8 (size: 0x8)
    class UW_RecipeFilterTab_C* Current Filter Tab;                                   // 0x0EB0 (size: 0x8)
    bool CraftingCancelled;                                                           // 0x0EB8 (size: 0x1)
    bool IsCrafting;                                                                  // 0x0EB9 (size: 0x1)
    class UAudioComponent* CraftingSound;                                             // 0x0EC0 (size: 0x8)
    bool RecipeListEmpty;                                                             // 0x0EC8 (size: 0x1)
    bool RecipeListRequiresRefresh;                                                   // 0x0EC9 (size: 0x1)
    FTimerHandle RefreshRecipeListTimer;                                              // 0x0ED0 (size: 0x8)
    bool HasSortedRecipeArray;                                                        // 0x0ED8 (size: 0x1)
    TArray<FName> CachedAlphabetizedArray;                                            // 0x0EE0 (size: 0x10)
    class UCraftingEntryItem* ItemRowShortcutFrom;                                    // 0x0EF0 (size: 0x8)
    int32 CraftQueueCount;                                                            // 0x0EF8 (size: 0x4)
    FW_Inventory_CraftingArea_CCraftQueueCountUpdate CraftQueueCountUpdate;           // 0x0F00 (size: 0x10)
    void CraftQueueCountUpdate(int32 QueueCount);
    int32 MaxCraftQueueCount;                                                         // 0x0F10 (size: 0x4)
    FW_Inventory_CraftingArea_CNeverCraftedItemUpdate NeverCraftedItemUpdate;         // 0x0F18 (size: 0x10)
    void NeverCraftedItemUpdate();
    FTimerHandle RefreshRecipe;                                                       // 0x0F28 (size: 0x8)
    TArray<FGameplayTag> RecipeTagOrder;                                              // 0x0F30 (size: 0x10)
    bool HasSeenBenchUpgradesTip;                                                     // 0x0F40 (size: 0x1)
    TArray<class UCraftingEntryItem*> CraftingEntries;                                // 0x0F48 (size: 0x10)
    TArray<uint8> NewItemCategories;                                                  // 0x0F58 (size: 0x10)
    TArray<uint8> NewResearchCategories;                                              // 0x0F68 (size: 0x10)
    FString SearchStringFilter;                                                       // 0x0F78 (size: 0x10)
    bool UseGridForSearchResults;                                                     // 0x0F88 (size: 0x1)
    ...
    void BndEvt__W_Inventory_CraftingArea_RecipeEntryList_1_K2Node_ComponentBoundEvent_10_SimpleListItemEventDynamic__DelegateSignature(class UObject* Item);
    ...
    void BndEvt__W_Inventory_CraftingArea_RecipeEntryList_1_K2Node_ComponentBoundEvent_17_SimpleListItemEventDynamic__DelegateSignature(class UObject* Item);
