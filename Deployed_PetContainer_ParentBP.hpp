...
class ADeployed_PetContainer_ParentBP_C : public ADeployed_Container_ParentBP_C
{
    ...
    class UBoxComponent* CaptureBox;                                                  // 0x0940 (size: 0x8)
    class USceneComponent* LurePoint;                                                 // 0x0948 (size: 0x8)
    class ANPC_Base_ParentBP_C* CaughtPet;                                            // 0x0950 (size: 0x8)
    FTimerHandle LureTimer;                                                           // 0x0958 (size: 0x8)
    bool Closed;                                                                      // 0x0960 (size: 0x1)
    double FeedingDuration;                                                           // 0x0968 (size: 0x8)
    double FeedingStartTime;                                                          // 0x0970 (size: 0x8)
    bool WildTamableAllowed;                                                          // 0x0978 (size: 0x1)
    FName LureTag;                                                                    // 0x097C (size: 0x8)
    TArray<TSoftClassPtr<ANPC_Base_ParentBP_C>> ClassToIndex;                         // 0x0988 (size: 0x10)
    TEnumAsByte<ENPCCharacterSize::Type> CompatiblePetSize;                           // 0x0998 (size: 0x1)
    bool CanPatPet;                                                                   // 0x0999 (size: 0x1)
    class USoundBase* PetEnterSound;                                                  // 0x09A0 (size: 0x8)
    class USoundBase* PetExitSound;                                                   // 0x09A8 (size: 0x8)
    bool CanInteractWithPetInContainer;                                               // 0x09B0 (size: 0x1)
    bool PetCanLeaveOnItsOwn;                                                         // 0x09B1 (size: 0x1)
    bool AllowScalingPet;                                                             // 0x09B2 (size: 0x1)
    class ADayNightManager_C* DayNightManager;                                        // 0x09B8 (size: 0x8)
    TArray<FBuffDebuffRowHandle> DebuffImmunitiesWhenOccupying;                       // 0x09C0 (size: 0x10)
    TArray<FName> CachedOccupantDebuffImmunities;                                     // 0x09D0 (size: 0x10)
    class ANPC_Base_ParentBP_C* LastCaughtPet;                                        // 0x09E0 (size: 0x8)
