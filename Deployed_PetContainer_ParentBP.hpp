...
class ADeployed_PetContainer_ParentBP_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UArrowComponent* EscapePoint;                                               // 0x0938 (size: 0x8)
    class USceneComponent* CapturePoint;                                              // 0x0940 (size: 0x8)
    class UBoxComponent* VisBlocker;                                                  // 0x0948 (size: 0x8)
    class UStaticMeshComponent* Nachos;                                               // 0x0950 (size: 0x8)
    class UBoxComponent* CaptureBox;                                                  // 0x0958 (size: 0x8)
    class USceneComponent* LurePoint;                                                 // 0x0960 (size: 0x8)
    class UStaticMeshComponent* Lid;                                                  // 0x0968 (size: 0x8)
    float CageCloseTimeline_NewTrack_0_B5F177DF4331FEDD5AFBE3BE96EAFBCB;              // 0x0970 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> CageCloseTimeline__Direction_B5F177DF4331FEDD5AFBE3BE96EAFBCB; // 0x0974 (size: 0x1)
    class UTimelineComponent* CageCloseTimeline;                                      // 0x0978 (size: 0x8)
    class ANPC_Monster_Pest_C* CaughtPest;                                            // 0x0980 (size: 0x8)
    FTimerHandle LureTimer;                                                           // 0x0988 (size: 0x8)
    bool Closed;                                                                      // 0x0990 (size: 0x1)
    int32 FeedingCount;                                                               // 0x0994 (size: 0x4)
    double FeedingDuration;                                                           // 0x0998 (size: 0x8)
    double FeedingStartTime;                                                          // 0x09A0 (size: 0x8)
    bool WildPestAllowed;                                                             // 0x09A8 (size: 0x1)
    FName LureTag;                                                                    // 0x09AC (size: 0x8)
    bool IsPestCurrentlyEating;                                                       // 0x09B4 (size: 0x1)
    class ANPC_Monster_Pest_C* LocalOldPest;                                          // 0x09B8 (size: 0x8)
    UClass* LocalClass;                                                               // 0x09C0 (size: 0x8)
