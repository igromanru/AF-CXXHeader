...
class UW_WorldSelectMenu_C : public UUserWidget
{
    ...
    class UImage* HostBG;                                                             // 0x0330 (size: 0x8)
    class UCanvasPanel* HostPanel;                                                    // 0x0338 (size: 0x8)
    class UImage* Image;                                                              // 0x0340 (size: 0x8)
    class UImage* Image_0;                                                            // 0x0348 (size: 0x8)
    class UImage* Image_85;                                                           // 0x0350 (size: 0x8)
    class UImage* Image_273;                                                          // 0x0358 (size: 0x8)
    class UImage* Image_275;                                                          // 0x0360 (size: 0x8)
    class UImage* Image_510;                                                          // 0x0368 (size: 0x8)
    class UBackgroundBlur* IncompatibleBlur;                                          // 0x0370 (size: 0x8)
    class UCircularThrobber* LoadingThrobber;                                         // 0x0378 (size: 0x8)
    class UW_Settings_SliderBar_C* Slider_MaxPlayers;                                 // 0x0380 (size: 0x8)
    class UEditableTextBox* TextInput_Password;                                       // 0x0388 (size: 0x8)
    class UEditableTextBox* TextInput_ServerName;                                     // 0x0390 (size: 0x8)
    class UVerticalBox* VBOX_Multiplayer;                                             // 0x0398 (size: 0x8)
    class UW_MainMenuButton_Strict_C* W_MainMenuButton_DeleteSaveNew;                 // 0x03A0 (size: 0x8)
    class UW_MainMenuButton_Strict_C* W_MainMenuButton_RemoveFromCloudNew;            // 0x03A8 (size: 0x8)
    class UW_MainMenuButton_Strict_C* W_MainMenuButton_RestoreSave;                   // 0x03B0 (size: 0x8)
    class UW_MainMenuButton_Strict_C* W_MainMenuButton_SaveDirNew;                    // 0x03B8 (size: 0x8)
    class UW_MainMenuButton_Strict_C* W_MainMenuButton_WorldSettingsNew;              // 0x03C0 (size: 0x8)
    class UScrollBox* WorldListScrollBox;                                             // 0x03C8 (size: 0x8)
    class UListView* WorldListView;                                                   // 0x03D0 (size: 0x8)
    class UTextBlock* WorldNameText;                                                  // 0x03D8 (size: 0x8)
    class UTextBlock* WorldUptimeText;                                                // 0x03E0 (size: 0x8)
    class UWorldEntryItem* SelectedWorld;                                             // 0x03E8 (size: 0x8)
    class UWidget* LastPopupWidget;                                                   // 0x03F0 (size: 0x8)
    bool HostLAN;                                                                     // 0x03F8 (size: 0x1)
    int32 MaxPlayers;                                                                 // 0x03FC (size: 0x4)
    bool SingleplayerOnly;                                                            // 0x0400 (size: 0x1)
    FW_WorldSelectMenu_CSandboxSettingsPressed SandboxSettingsPressed;                // 0x0408 (size: 0x10)
    void SandboxSettingsPressed(FString FolderName);
    int32 Character_Limit;                                                            // 0x0418 (size: 0x4)
    TArray<FString> ABC_Strings;                                                      // 0x0420 (size: 0x10)
