...
class ADayNightManager_C : public AAbioticActor_C
{
    ...
    int32 DefaultStartingHour;                                                        // 0x02E0 (size: 0x4)
    int32 MorningStartHour;                                                           // 0x02E4 (size: 0x4)
    int32 NightfallStartHour;                                                         // 0x02E8 (size: 0x4)
    int32 AssaultCheckHour;                                                           // 0x02EC (size: 0x4)
    int32 WeatherCheckHour;                                                           // 0x02F0 (size: 0x4)
    double CurrentTimeInSeconds;                                                      // 0x02F8 (size: 0x8)
    FTimerHandle DayNightTimer;                                                       // 0x0300 (size: 0x8)
    double 24HoursInSeconds;                                                          // 0x0308 (size: 0x8)
    double SecondsPerRealSecond_Day;                                                  // 0x0310 (size: 0x8)
    double DoNotModify!DayNightTickRate;                                              // 0x0318 (size: 0x8)
    int32 CurrentDay;                                                                 // 0x0320 (size: 0x4)
    bool IsNight;                                                                     // 0x0324 (size: 0x1)
    FDayNightManager_CNightfall Nightfall;                                            // 0x0328 (size: 0x10)
    void Nightfall();
    FDayNightManager_CNewDay NewDay;                                                  // 0x0338 (size: 0x10)
    void NewDay(int32 DayNumber);
    FDayNightManager_CMorning Morning;                                                // 0x0348 (size: 0x10)
    void Morning();
    int32 LastKnownHour;                                                              // 0x0358 (size: 0x4)
    FDayNightManager_CTimeChanged TimeChanged;                                        // 0x0360 (size: 0x10)
    void TimeChanged(double TimeInSeconds);
    FDayNightManager_CHourChanged HourChanged;                                        // 0x0370 (size: 0x10)
    void HourChanged(int32 NewHour, int32 PreviousHour);
    double SecondsPerRealSecond_Night;                                                // 0x0380 (size: 0x8)
    TArray<class USoundBase*> Announcement Sounds in Order;                           // 0x0388 (size: 0x10)
    int32 CurrentAnnouncementIndex;                                                   // 0x0398 (size: 0x4)
    FTimerHandle NextAnnouncementLineTimer;                                           // 0x03A0 (size: 0x8)
    int32 AmbientTemperature_Day;                                                     // 0x03A8 (size: 0x4)
    int32 AmbientTemperature_Night;                                                   // 0x03AC (size: 0x4)
    FVector AnnouncementLocationOffset;                                               // 0x03B0 (size: 0x18)
    TArray<FDataTableRowHandle> CurrentAnnouncementJournals;                          // 0x03C8 (size: 0x10)
    FTimerHandle AutosaveTimer;                                                       // 0x03D8 (size: 0x8)
    class UAudioComponent* LastAnnouncementSound;                                     // 0x03E0 (size: 0x8)
    bool HavePlayersLeftStartingZone;                                                 // 0x03E8 (size: 0x1)
    int32 LastAssaultDay;                                                             // 0x03EC (size: 0x4)
    bool IsAssaultDay;                                                                // 0x03F0 (size: 0x1)
    int32 SleepingPlayers;                                                            // 0x03F4 (size: 0x4)
    class AAbiotic_Survival_GameState_C* GameState;                                   // 0x03F8 (size: 0x8)
    FDayNightManager_COnSleepingPlayersUpdated OnSleepingPlayersUpdated;              // 0x0400 (size: 0x10)
    void OnSleepingPlayersUpdated(int32 TotalPlayersSleeping);
    FDayNightManager_CSleepState_Changed SleepState_Changed;                          // 0x0410 (size: 0x10)
    void SleepState_Changed(class AAbiotic_Character_ParentBP_C* InteractingPlayer);
    FDayNightManager_CAssaultCheckTime AssaultCheckTime;                              // 0x0420 (size: 0x10)
    void AssaultCheckTime();
    int32 LastWeatherDay;                                                             // 0x0430 (size: 0x4)
    FName CurrentWeatherEvent;                                                        // 0x0434 (size: 0x8)
    FDayNightManager_CWeatherEventUpdated WeatherEventUpdated;                        // 0x0440 (size: 0x10)
    void WeatherEventUpdated(FName NewWeatherEvent);
    int32 RequiredDaysBetweenWeather;                                                 // 0x0450 (size: 0x4)
    double TimeLastAutoSaved;                                                         // 0x0458 (size: 0x8)
    class AWeatherDirector* ActiveWeatherDirector;                                    // 0x0460 (size: 0x8)
    double ActiveAmbientRadiation;                                                    // 0x0468 (size: 0x8)
    TArray<FCompendiumEntryRowHandle> CurrentAnnouncementCompendium;                  // 0x0470 (size: 0x10)
    FWeatherEventRowHandle Weather_RequestByPlayer;                                   // 0x0480 (size: 0x20)
