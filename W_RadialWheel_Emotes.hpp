#ifndef UE4SS_SDK_W_RadialWheel_Emotes_HPP
#define UE4SS_SDK_W_RadialWheel_Emotes_HPP

class UW_RadialWheel_Emotes_C : public UW_RadialWheel_ParentBP_C
{
    ...
    class UTextBlock* EmoteName;                                                      // 0x0370 (size: 0x8)
    ...
    void ExecuteUbergraph_W_RadialWheel_Emotes(int32 EntryPoint);
}; // Size: 0x388
