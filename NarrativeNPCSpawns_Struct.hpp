...
struct FNarrativeNPCSpawns_Struct
{
    ...
    class ADeployed_TraderLure_Parent_C* PreferredLure_26_C7F476E540625B7351D9669B97C12634; // 0x0040 (size: 0x8)
    TArray<class ADeployed_TraderLure_Parent_C*> CachedLures_21_0B08235448EC22CFC0E375A8F418FD46; // 0x0048 (size: 0x10)
