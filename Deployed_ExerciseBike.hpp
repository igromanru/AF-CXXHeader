...
class ADeployed_ExerciseBike_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UAudioComponent* Audio;                                                     // 0x0860 (size: 0x8)
    class UChildActorComponent* PowerOutput;                                          // 0x0868 (size: 0x8)
    class USceneComponent* SitSpot;                                                   // 0x0870 (size: 0x8)
    FBuffDebuffRowHandle SkillXpBuffRow;                                              // 0x0878 (size: 0x20)
    FBuffDebuffRowHandle TiringBuffRow;                                               // 0x0898 (size: 0x20)
    FBuffDebuffRowHandle LacticAcidBuffRow;                                           // 0x08B8 (size: 0x20)
    class AAbiotic_Character_ParentBP_C* SeatOccupier;                                // 0x08D8 (size: 0x8)
    class AAbiotic_Character_ParentBP_C* LastSeatOccupier;                            // 0x08E0 (size: 0x8)
    class UAnimMontage* WeakPlayerAnim;                                               // 0x08E8 (size: 0x8)
    class UAnimMontage* StrongPlayerAnim;                                             // 0x08F0 (size: 0x8)
    class UAnimSequence* WeakMachineAnim;                                             // 0x08F8 (size: 0x8)
    class UAnimSequence* StrongMachineAnim;                                           // 0x0900 (size: 0x8)
    bool IsStrongAnim;                                                                // 0x0908 (size: 0x1)
