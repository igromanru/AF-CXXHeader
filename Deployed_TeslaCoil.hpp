...
class ADeployed_TeslaCoil_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UNiagaraComponent* ElectricityParticles_Mid;                                // 0x0878 (size: 0x8)
    class UNiagaraComponent* ElectricityParticles_Low;                                // 0x0880 (size: 0x8)
    class USceneComponent* LineOfSightEye;                                            // 0x0888 (size: 0x8)
    class UAudioComponent* CoilAudio;                                                 // 0x0890 (size: 0x8)
    class USphereComponent* AttackRadius;                                             // 0x0898 (size: 0x8)
    float WarmUpTimeline_NewTrack_0_5CBE1C304A3CA52B5ED982A26639F3CC;                 // 0x08A0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> WarmUpTimeline__Direction_5CBE1C304A3CA52B5ED982A26639F3CC; // 0x08A4 (size: 0x1)
    class UTimelineComponent* WarmUpTimeline;                                         // 0x08A8 (size: 0x8)
    class UMaterialInstanceDynamic* SphereMaterial;                                   // 0x08B0 (size: 0x8)
    TArray<class AActor*> TargetList;                                                 // 0x08B8 (size: 0x10)
    float AttackRateMultiplier;                                                       // 0x08C8 (size: 0x4)
    class AActor* LastTarget;                                                         // 0x08D0 (size: 0x8)
    float BaseCoilDamage;                                                             // 0x08D8 (size: 0x4)
    bool CoilMode_AoE;                                                                // 0x08DC (size: 0x1)
    class UMaterialInstanceDynamic* MiddleRingMaterial;                               // 0x08E0 (size: 0x8)
    class UMaterialInstanceDynamic* TopRingMaterial;                                  // 0x08E8 (size: 0x8)
    class UMaterialInstanceDynamic* BottomRingMaterial;                               // 0x08F0 (size: 0x8)
