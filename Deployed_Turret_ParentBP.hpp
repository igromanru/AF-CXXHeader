...
class ADeployed_Turret_ParentBP_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UStaticMeshComponent* TurretTop;                                            // 0x0878 (size: 0x8)
    class UStaticMeshComponent* TurretRotator;                                        // 0x0880 (size: 0x8)
    class USkeletalMeshComponent* TurretSkeleton;                                     // 0x0888 (size: 0x8)
    class UTurret_Component_C* Turret_Component;                                      // 0x0890 (size: 0x8)
    class USceneComponent* ProjectileSpawnLocation;                                   // 0x0898 (size: 0x8)
    FVector TurretTopOffset;                                                          // 0x08A0 (size: 0x18)
    bool TurretIsPowered;                                                             // 0x08B8 (size: 0x1)
