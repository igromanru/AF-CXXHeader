...
class ADeployed_Container_FilingCabinet_Large_C : public ADeployed_Container_ParentBP_C
{
    ...
    float OpenDrawers_Timeline_NewTrack_2_925602804CACA890DAF99891C9B4AFD6;           // 0x0A08 (size: 0x4)
    float OpenDrawers_Timeline_NewTrack_1_925602804CACA890DAF99891C9B4AFD6;           // 0x0A0C (size: 0x4)
    float OpenDrawers_Timeline_NewTrack_0_925602804CACA890DAF99891C9B4AFD6;           // 0x0A10 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> OpenDrawers_Timeline__Direction_925602804CACA890DAF99891C9B4AFD6; // 0x0A14 (size: 0x1)
    class UTimelineComponent* OpenDrawers_Timeline;                                   // 0x0A18 (size: 0x8)
