...
class UW_SettingsPage_FirstTime_C : public UW_SettingsPage_C
{
    ...
    class UButton* Button_Continue;                                                   // 0x0308 (size: 0x8)
    class UImage* Image;                                                              // 0x0310 (size: 0x8)
    class UVerticalBox* SettingsList;                                                 // 0x0318 (size: 0x8)
    class UW_MenuTitleBig_C* W_MenuTitleBig;                                          // 0x0320 (size: 0x8)
    TArray<FAccessibilitySettingRowHandle> AccessibilitySettings;                     // 0x0328 (size: 0x10)
