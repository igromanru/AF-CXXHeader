...
class AWeapon_Gun_Vacuum_C : public AAbiotic_Weapon_Gun_ParentBP_C
{
    ...
    class UNiagaraComponent* Niagara_AirFunnel;                                       // 0x0BB8 (size: 0x8)
    class URechargeableComponent_C* RechargeableComponent;                            // 0x0BC0 (size: 0x8)
    TArray<class UPrimitiveComponent*> PulledComponents;                              // 0x0BC8 (size: 0x10)
    double VacuumSpeed;                                                               // 0x0BD8 (size: 0x8)
    class USphereComponent* VacuumOverlap;                                            // 0x0BE0 (size: 0x8)
    class USkeletalMeshComponent* Pest_Mesh;                                          // 0x0BE8 (size: 0x8)
    bool Jammed;                                                                      // 0x0BF0 (size: 0x1)
    class USkeletalMeshComponent* TP_SKMesh;                                          // 0x0BF8 (size: 0x8)
    class UAudioComponent* Vacuum_SFXComp;                                            // 0x0C00 (size: 0x8)
    class USoundBase* NormalVacuum_SFX;                                               // 0x0C08 (size: 0x8)
    FHitResult HitResult;                                                             // 0x0C10 (size: 0xF8)
    class USoundBase* PestIn_SFX;                                                     // 0x0D08 (size: 0x8)
    class USoundBase* PestOut_SFX;                                                    // 0x0D10 (size: 0x8)
    class USkeletalMesh* SuckedPestMesh;                                              // 0x0D18 (size: 0x8)
    bool IsLocalWeapon;                                                               // 0x0D20 (size: 0x1)
    bool FunnelActive;                                                                // 0x0D21 (size: 0x1)
