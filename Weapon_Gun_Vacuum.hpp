...
class AWeapon_Gun_Vacuum_C : public AAbiotic_Weapon_Gun_ParentBP_C
{
    ...
    class UCapsuleComponent* AirFunnelOverlap;                                        // 0x0C28 (size: 0x8)
    class USphereComponent* VacuumOverlap;                                            // 0x0C30 (size: 0x8)
    class UNiagaraComponent* Niagara_AirFunnel;                                       // 0x0C38 (size: 0x8)
    class URechargeableComponent_C* RechargeableComponent;                            // 0x0C40 (size: 0x8)
    TArray<class UPrimitiveComponent*> PulledComponents;                              // 0x0C48 (size: 0x10)
    double VacuumSpeed;                                                               // 0x0C58 (size: 0x8)
    class UMeshComponent* FP_Mesh;                                                    // 0x0C60 (size: 0x8)
    class UMeshComponent* TP_Mesh;                                                    // 0x0C68 (size: 0x8)
    class UAudioComponent* Vacuum_SFXComp;                                            // 0x0C70 (size: 0x8)
    class USoundBase* VacuumStart_SFX;                                                // 0x0C78 (size: 0x8)
    class USoundBase* VacuumEnd_SFX;                                                  // 0x0C80 (size: 0x8)
    class USoundBase* PestIn_SFX;                                                     // 0x0C88 (size: 0x8)
    class USoundBase* PestOut_SFX;                                                    // 0x0C90 (size: 0x8)
    bool IsLocalWeapon;                                                               // 0x0C98 (size: 0x1)
    bool FunnelActive;                                                                // 0x0C99 (size: 0x1)
    TArray<FVacuumSuctionableData_Struct> SuctionableData;                            // 0x0CA0 (size: 0x10)
    FVacuumSuctionableData_Struct CurrentSuctionedData;                               // 0x0CB0 (size: 0xD0)
    int32 SuctionedIndex;                                                             // 0x0D80 (size: 0x4)
    int32 LastIndex;                                                                  // 0x0D84 (size: 0x4)
    bool RecentlyFiredProjectile;                                                     // 0x0D88 (size: 0x1)
