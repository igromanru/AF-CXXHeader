...
class ADeployed_Toilet_Portal_C : public AToilet_ParentBP_C
{
    ...
    class UStaticMeshComponent* Storm1;                                               // 0x0950 (size: 0x8)
    class UStaticMeshComponent* Storm2;                                               // 0x0958 (size: 0x8)
    class UAudioComponent* Audio;                                                     // 0x0960 (size: 0x8)
    class UStaticMeshComponent* LaserPowerCollider;                                   // 0x0968 (size: 0x8)
    int32 ExtraContinenceDrainCounter;                                                // 0x0970 (size: 0x4)
