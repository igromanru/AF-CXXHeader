...
class ADeployed_Toilet_Portal_C : public AToilet_ParentBP_C
{
    ...
    class UStaticMeshComponent* Storm1;                                               // 0x08A0 (size: 0x8)
    class UStaticMeshComponent* Storm2;                                               // 0x08A8 (size: 0x8)
    class UAudioComponent* Audio;                                                     // 0x08B0 (size: 0x8)
    class UStaticMeshComponent* LaserPowerCollider;                                   // 0x08B8 (size: 0x8)
    int32 ExtraContinenceDrainCounter;                                                // 0x08C0 (size: 0x4)
