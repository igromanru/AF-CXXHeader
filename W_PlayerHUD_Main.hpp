...
class UW_PlayerHUD_Main_C : public UUserWidget
{
    ...
    class UW_HUD_GadgetBar_C* W_HUD_GadgetBar_Stamina;                                // 0x0558 (size: 0x8)
    class UW_HUD_Location_C* W_HUD_Location;                                          // 0x0560 (size: 0x8)
    class UW_HUD_PinnedJournals_C* W_HUD_PinnedJournals;                              // 0x0568 (size: 0x8)
    class UW_HUD_QuestObjective_C* W_HUD_QuestObjective;                              // 0x0570 (size: 0x8)
    class UW_HUD_SkillUp_C* W_HUD_SkillUp;                                            // 0x0578 (size: 0x8)
    class UW_HUD_SleepingPlayers_C* W_HUD_SleepingPlayers;                            // 0x0580 (size: 0x8)
    class UW_HUD_TemperatureBar_C* W_HUD_TemperatureBar;                              // 0x0588 (size: 0x8)
    class UW_InventoryWeight_C* W_InventoryWeight;                                    // 0x0590 (size: 0x8)
    class UW_LevelLoadingScreen_C* W_LevelLoadingScreen;                              // 0x0598 (size: 0x8)
    class UW_PlayerHUD_BodyDiagram_C* W_PlayerHUD_BodyDiagram;                        // 0x05A0 (size: 0x8)
    class UW_PlayerHUD_Hotbar_C* W_PlayerHUD_Hotbar;                                  // 0x05A8 (size: 0x8)
    class UW_PlayerHUD_ItemActionList_C* W_PlayerHUD_ItemActionList;                  // 0x05B0 (size: 0x8)
    class UW_PlayerInventory_Main_C* W_PlayerInventory_Main;                          // 0x05B8 (size: 0x8)
    class UW_RadioNotification_C* W_RadioNotification;                                // 0x05C0 (size: 0x8)
    class UW_RespawnOptions_C* W_RespawnOptions;                                      // 0x05C8 (size: 0x8)
    class UW_SkillXPGain_C* W_SkillXPGain;                                            // 0x05D0 (size: 0x8)
    class UW_SubtitleManager_C* W_SubtitleManager;                                    // 0x05D8 (size: 0x8)
    class UW_TextChatBox_C* W_TextChatBox;                                            // 0x05E0 (size: 0x8)
    class UW_UIPopupOverlay_C* W_UIPopupOverlay;                                      // 0x05E8 (size: 0x8)
    class UW_VOIPIndicator_C* W_VOIPIndicator;                                        // 0x05F0 (size: 0x8)
    class UW_WaypointOverlay_C* W_WaypointOverlay;                                    // 0x05F8 (size: 0x8)
    class UVerticalBox* Warning_VBox;                                                 // 0x0600 (size: 0x8)
    class AAbiotic_PlayerCharacter_C* OwningCharacter;                                // 0x0608 (size: 0x8)
    FLinearColor DefaultHUDColor;                                                     // 0x0610 (size: 0x10)
    FTimerHandle HUD_BleedoutTimer;                                                   // 0x0620 (size: 0x8)
    FTimerHandle HoldTimer;                                                           // 0x0628 (size: 0x8)
    FText DBNO_Notice_Long;                                                           // 0x0630 (size: 0x10)
    FText Dead_Notice_Long;                                                           // 0x0640 (size: 0x10)
    FText DBNO_ItemAction_GiveUp;                                                     // 0x0650 (size: 0x10)
    FText Dead_ItemAction_Respawn;                                                    // 0x0660 (size: 0x10)
    double RespawnPenaltyDuration;                                                    // 0x0670 (size: 0x8)
    FLinearColor ErrorHUDColor;                                                       // 0x0678 (size: 0x10)
    TArray<class UW_Waypoint_Generic_C*> Waypoints;                                   // 0x0688 (size: 0x10)
    double LastHealthPercentage;                                                      // 0x0698 (size: 0x8)
    class UW_PlayerHUD_InteractionPrompt_C* InteractButtonPrompt;                     // 0x06A0 (size: 0x8)
    TArray<class UW_HUD_ItemPickupNotify_C*> CurrentItemPickupNotifies;               // 0x06A8 (size: 0x10)
    FW_PlayerHUD_Main_CSetup Sleep Score Widget Setup Sleep Score Widget;             // 0x06B8 (size: 0x10)
    void Setup Sleep Score Widget(ESlateVisibility Set Visibility);
    FW_PlayerHUD_Main_CUpdate Sleep Minigame Scores Update Sleep Minigame Scores;     // 0x06C8 (size: 0x10)
    void Update Sleep Minigame Scores(int32 Score);
    FW_PlayerHUD_Main_CJournal Icon Update Journal Icon Update;                       // 0x06D8 (size: 0x10)
    void Journal Icon Update();
    TArray<FName> PendingTutorialTips;                                                // 0x06E8 (size: 0x10)
    TEnumAsByte<E_WaypointMode::Type> Current Waypoint Mode;                          // 0x06F8 (size: 0x1)
    FW_PlayerHUD_Main_CPinnedRecipeUpdate PinnedRecipeUpdate;                         // 0x0700 (size: 0x10)
    void PinnedRecipeUpdate(FName RecipesToPin, bool UnpinAllRecipes);
    FW_PlayerHUD_Main_CUnpinnedButtonVisibilityUpdate UnpinnedButtonVisibilityUpdate; // 0x0710 (size: 0x10)
    void UnpinnedButtonVisibilityUpdate(bool Show);
    TSet<FName> PinnedRecipeList;                                                     // 0x0720 (size: 0x50)
    TMap<class FUIPopupRowHandle, class UW_UIPopup_ParentBP_C*> ActiveUIPopups;       // 0x0770 (size: 0x50)
    TMap<class FUIPopupRowHandle, class EInventoryMode> PendingUIPopups;              // 0x07C0 (size: 0x50)
    bool DebugUIPopups;                                                               // 0x0810 (size: 0x1)
    TArray<FName> UIPopupsSeen;                                                       // 0x0818 (size: 0x10)
    class USoundBase* RecipeNotifyUnlockSound;                                        // 0x0828 (size: 0x8)
    class USoundBase* MapPickupSound;                                                 // 0x0830 (size: 0x8)
    FTimerHandle Timer_OxygenTick;                                                    // 0x0838 (size: 0x8)
    double OxygenTickStartedTime;                                                     // 0x0840 (size: 0x8)
