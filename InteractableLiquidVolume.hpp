...
class AInteractableLiquidVolume_C : public ADeployed_LiquidContainer_ParentBP_C
{
    ...
    class UTextRenderComponent* TextRender;                                           // 0x0948 (size: 0x8)
    class UBoxComponent* LiquidInteractVolume;                                        // 0x0950 (size: 0x8)
    FVector LiquidVolumeSize;                                                         // 0x0958 (size: 0x18)
    bool DisallowWashing;                                                             // 0x0970 (size: 0x1)
    FFishingZoneRowHandle FishingZone;                                                // 0x0978 (size: 0x20)
