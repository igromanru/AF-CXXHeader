...
class UAbiotic_CharacterBuffComponent_C : public UCharacterBuffComponent
{
    ...
    FAbiotic_CharacterBuffComponent_CReceivedNewBuff ReceivedNewBuff;                 // 0x02F0 (size: 0x10)
    void ReceivedNewBuff(FBuffDebuffRowHandle BuffDebuffRowHandle);
    FAbiotic_CharacterBuffComponent_CRemovedBuff RemovedBuff;                         // 0x0300 (size: 0x10)
    void RemovedBuff(FBuffDebuffRowHandle BuffDebuffRowHandle);
    FName DefaultBuffParticleSocket;                                                  // 0x0310 (size: 0x8)
