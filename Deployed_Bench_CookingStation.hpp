...
class ADeployed_Bench_CookingStation_C : public AAbioticDeployed_CraftingBench_ParentBP_C
{
    ...
    class UBenchUpgradeActorComponent* BenchUpgrade_Cheffigy;                         // 0x0908 (size: 0x8)
    ...
    class USceneComponent* InteractPosition_Left;                                     // 0x0928 (size: 0x8)
    class USceneComponent* InteractPosition_Right;                                    // 0x0930 (size: 0x8)
    class UStaticMeshComponent* CookingInteraction;                                   // 0x0938 (size: 0x8)
    class UStaticMeshComponent* FishPrepInteraction;                                  // 0x0940 (size: 0x8)
    int32 SelectedComponentIndex;                                                     // 0x0948 (size: 0x4)
    double LastContainerUpdate;                                                       // 0x0950 (size: 0x8)
