...
class ADeployed_BrainSync_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UNiagaraComponent* SyncParticle;                                            // 0x0878 (size: 0x8)
    class UStaticMeshComponent* Brain01;                                              // 0x0880 (size: 0x8)
    class UAudioComponent* SyncAudio;                                                 // 0x0888 (size: 0x8)
    class USceneComponent* SitSpot;                                                   // 0x0890 (size: 0x8)
    int32 TransferState;                                                              // 0x0898 (size: 0x4)
