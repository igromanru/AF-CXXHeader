...
class ADeployed_BrainSync_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UNiagaraComponent* SyncParticle;                                            // 0x0928 (size: 0x8)
    class UStaticMeshComponent* Brain01;                                              // 0x0930 (size: 0x8)
    class UAudioComponent* SyncAudio;                                                 // 0x0938 (size: 0x8)
    class USceneComponent* SitSpot;                                                   // 0x0940 (size: 0x8)
    int32 TransferState;                                                              // 0x0948 (size: 0x4)
    class AAbiotic_Survival_GameState_C* GameState;                                   // 0x0950 (size: 0x8)
