...
class AWeapon_Gun_Laser_C : public AAbiotic_Weapon_Gun_ParentBP_C
{
    ...
    class UNiagaraComponent* Niagara_LaserEnd;                                        // 0x0BB8 (size: 0x8)
    class ULaserComponent_C* LaserComponent;                                          // 0x0BC0 (size: 0x8)
    class UNiagaraComponent* Niagara_LaserEmitterBeam;                                // 0x0BC8 (size: 0x8)
    class USceneComponent* LaserEndLocation;                                          // 0x0BD0 (size: 0x8)
    bool LaserFiring;                                                                 // 0x0BD8 (size: 0x1)
    FTimerHandle AmmoConsumptionTimer;                                                // 0x0BE0 (size: 0x8)
    bool TickAmmoConsumption;                                                         // 0x0BE8 (size: 0x1)
    float AmmoConsumptionInterval;                                                    // 0x0BEC (size: 0x4)
    float LaserDuration;                                                              // 0x0BF0 (size: 0x4)
    bool Overdrive;                                                                   // 0x0BF4 (size: 0x1)
    float AmmoOverdriveConsumptionInterval;                                           // 0x0BF8 (size: 0x4)
    float LaserDamage;                                                                // 0x0BFC (size: 0x4)
    float LaserOverdriveDamage;                                                       // 0x0C00 (size: 0x4)
    bool IsLocalWeapon;                                                               // 0x0C04 (size: 0x1)
    class USoundBase* LaserStartSFX;                                                  // 0x0C08 (size: 0x8)
    float In Value;                                                                   // 0x0C10 (size: 0x4)

    void PlaySFX(bool Local);
