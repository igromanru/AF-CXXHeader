...
class ADeployed_PestTeleporter_C : public ATraderDepositBox_ParentBP_C
{
    ...
    class UChildActorComponent* Button_Spawn;                                         // 0x0978 (size: 0x8)
    class USceneComponent* ButtonComponent;                                           // 0x0980 (size: 0x8)
    class UStaticMeshComponent* battery;                                              // 0x0988 (size: 0x8)
    class UNiagaraComponent* TeleportFX;                                              // 0x0990 (size: 0x8)
    class UPointLightComponent* TeleportLight;                                        // 0x0998 (size: 0x8)
    int32 NPC Recipe Count;                                                           // 0x09A0 (size: 0x4)
    FTimerHandle OverlapTimer;                                                        // 0x09A8 (size: 0x8)
    TSubclassOf<class ANPC_Base_ParentBP_C> NPCClass;                                 // 0x09B0 (size: 0x8)
