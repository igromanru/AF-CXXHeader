...
class ATV_ParentBP_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UStaticMeshComponent* ScreenMesh;                                           // 0x0928 (size: 0x8)
    class UTextRenderComponent* TVDebug;                                              // 0x0930 (size: 0x8)
    class UAudioComponent* TV_Audio;                                                  // 0x0938 (size: 0x8)
    class URectLightComponent* RectLight;                                             // 0x0940 (size: 0x8)
    bool TV_PoweredOn;                                                                // 0x0948 (size: 0x1)
    double DelayBetweenPlays;                                                         // 0x0950 (size: 0x8)
    int32 AudioPlayIndex;                                                             // 0x0958 (size: 0x4)
    double CurrentAudioStartTime;                                                     // 0x0960 (size: 0x8)
    double CurrentAudioDuration;                                                      // 0x0968 (size: 0x8)
    TEnumAsByte<E_TVColors::Type> TV Style;                                           // 0x0970 (size: 0x1)
    bool IgnoreStyle;                                                                 // 0x0971 (size: 0x1)
    FTimerHandle TVChannelHandle;                                                     // 0x0978 (size: 0x8)
