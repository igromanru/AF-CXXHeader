...
class AAbiotic_Character_ParentBP_C : public AAbioticCharacter
{
    ...
    class UOutlineComponent_C* OutlineComponent;                                      // 0x0928 (size: 0x8)
    class UCapsuleComponent* CharacterPresenceCapsule;                                // 0x0930 (size: 0x8)
    class UThermalReceiverComponent* ThermalReceiver;                                 // 0x0938 (size: 0x8)
    class UAIPerceptionComponent* AIPerception;                                       // 0x0940 (size: 0x8)
    class UAbiotic_CharacterBuffComponent_C* BuffDebuffComponent;                     // 0x0948 (size: 0x8)
    class UAbiotic_InventoryComponent_C* CharacterInventory;                          // 0x0950 (size: 0x8)
    class UAudioComponent* CharacterVoiceAudio;                                       // 0x0958 (size: 0x8)
    float RagdollBlend_PhysicsBlend_0D3332C045A8BC3A68470C9AF96830C5;                 // 0x0960 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> RagdollBlend__Direction_0D3332C045A8BC3A68470C9AF96830C5; // 0x0964 (size: 0x1)
    class UTimelineComponent* RagdollBlend;                                           // 0x0968 (size: 0x8)
    float Timeline_PhysicsBlend_9551C00B415539165B0B10851E745CE1;                     // 0x0970 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline__Direction_9551C00B415539165B0B10851E745CE1; // 0x0974 (size: 0x1)
    class UTimelineComponent* Timeline;                                               // 0x0978 (size: 0x8)
    float ZiplineTimeline_NewTrack_0_A49DF07F41CCAF35CD606489F286D9F2;                // 0x0980 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> ZiplineTimeline__Direction_A49DF07F41CCAF35CD606489F286D9F2; // 0x0984 (size: 0x1)
    class UTimelineComponent* ZiplineTimeline;                                        // 0x0988 (size: 0x8)
    double TotalCombinedHealth;                                                       // 0x0990 (size: 0x8)
    bool IsDead;                                                                      // 0x0998 (size: 0x1)
    FAbiotic_Character_ParentBP_CHealth_Changed Health_Changed;                       // 0x09A0 (size: 0x10)
    void Health_Changed();
    bool IsDBNO;                                                                      // 0x09B0 (size: 0x1)
    bool HasDBNOState;                                                                // 0x09B1 (size: 0x1)
    FAbiotic_Character_ParentBP_CDBNOState_Changed DBNOState_Changed;                 // 0x09B8 (size: 0x10)
    void DBNOState_Changed(class AAbiotic_Character_ParentBP_C* Character);
    double MeleeRange;                                                                // 0x09C8 (size: 0x8)
    double InteractionRange;                                                          // 0x09D0 (size: 0x8)
    double CurrentHunger;                                                             // 0x09D8 (size: 0x8)
    double MaxHunger;                                                                 // 0x09E0 (size: 0x8)
    double HungerDecayInterval;                                                       // 0x09E8 (size: 0x8)
    double HungerDecayAmount;                                                         // 0x09F0 (size: 0x8)
    TArray<FName> HeadBones;                                                          // 0x09F8 (size: 0x10)
    double CurrentFatigue;                                                            // 0x0A08 (size: 0x8)
    double MaxFatigue;                                                                // 0x0A10 (size: 0x8)
    double FatigueIncreaseInterval;                                                   // 0x0A18 (size: 0x8)
    double FatigueIncreaseAmount;                                                     // 0x0A20 (size: 0x8)
    double CurrentThirst;                                                             // 0x0A28 (size: 0x8)
    double MaxThirst;                                                                 // 0x0A30 (size: 0x8)
    double ThirstDecayInterval;                                                       // 0x0A38 (size: 0x8)
    double ThirstDecayAmount;                                                         // 0x0A40 (size: 0x8)
    bool HasThirst;                                                                   // 0x0A48 (size: 0x1)
    bool HasHunger;                                                                   // 0x0A49 (size: 0x1)
    bool HasFatigue;                                                                  // 0x0A4A (size: 0x1)
    FTimerHandle HungerDecayTimer;                                                    // 0x0A50 (size: 0x8)
    FTimerHandle FatigueIncreaseTimer;                                                // 0x0A58 (size: 0x8)
    FTimerHandle ThirstDecayTimer;                                                    // 0x0A60 (size: 0x8)
    FAbiotic_Character_ParentBP_CHunger_Changed Hunger_Changed;                       // 0x0A68 (size: 0x10)
    void Hunger_Changed();
    FAbiotic_Character_ParentBP_CThirst_Changed Thirst_Changed;                       // 0x0A78 (size: 0x10)
    void Thirst_Changed();
    FAbiotic_Character_ParentBP_CFatigue_Changed Fatigue_Changed;                     // 0x0A88 (size: 0x10)
    void Fatigue_Changed();
    bool RecentlyExertedSelf;                                                         // 0x0A98 (size: 0x1)
    FAbiotic_Character_ParentBP_CStamina_Changed Stamina_Changed;                     // 0x0AA0 (size: 0x10)
    void Stamina_Changed();
    double Sprinting_StaminaDrainPerInterval;                                         // 0x0AB0 (size: 0x8)
    double Sprinting_StaminaDrainInterval;                                            // 0x0AB8 (size: 0x8)
    TArray<FName> TorsoBones;                                                         // 0x0AC0 (size: 0x10)
    TArray<FName> LeftArmBones;                                                       // 0x0AD0 (size: 0x10)
    TArray<FName> RightArmBones;                                                      // 0x0AE0 (size: 0x10)
    TArray<FName> LeftLegBones;                                                       // 0x0AF0 (size: 0x10)
    TArray<FName> RightLegBones;                                                      // 0x0B00 (size: 0x10)
    FAbiotic_PointDamageStruct LastPointDamage;                                       // 0x0B10 (size: 0x178)
    TEnumAsByte<E_Factions::Type> Faction;                                            // 0x0C88 (size: 0x1)
    TEnumAsByte<E_AudioImportance::Type> CurrentVoiceAudioImportance;                 // 0x0C89 (size: 0x1)
    bool NPC_Targetable;                                                              // 0x0C8A (size: 0x1)
    TMap<EBodyLimbs, double> Current_LimbHealthMap;                                   // 0x0C90 (size: 0x50)
    bool Inventory;                                                                   // 0x0CE0 (size: 0x1)
    double CurrentBodyTemperature;                                                    // 0x0CE8 (size: 0x8)
    double LethalBodyTemperature_High;                                                // 0x0CF0 (size: 0x8)
    double LethalBodyTemperature_Low;                                                 // 0x0CF8 (size: 0x8)
    bool HasBodyTemperature;                                                          // 0x0D00 (size: 0x1)
    double PreferredBodyTemperature;                                                  // 0x0D08 (size: 0x8)
    FAbiotic_Character_ParentBP_CBodyTemp_Changed BodyTemp_Changed;                   // 0x0D10 (size: 0x10)
    void BodyTemp_Changed();
    bool LockedInPlaceMontage;                                                        // 0x0D20 (size: 0x1)
    double BleedoutStartTime;                                                         // 0x0D28 (size: 0x8)
    double CurrentBleedoutTime;                                                       // 0x0D30 (size: 0x8)
    FTimerHandle BleedoutTimer;                                                       // 0x0D38 (size: 0x8)
    FAbiotic_Character_ParentBP_CDeadAlive_Changed DeadAlive_Changed;                 // 0x0D40 (size: 0x10)
    void DeadAlive_Changed(class AAbiotic_Character_ParentBP_C* Character);
    TArray<class UAnimMontage*> DeathAnimations;                                      // 0x0D50 (size: 0x10)
    int32 SelectedDeathAnimation;                                                     // 0x0D60 (size: 0x4)
    bool DiedExplosively;                                                             // 0x0D64 (size: 0x1)
    bool DamageSpilloverToHead;                                                       // 0x0D65 (size: 0x1)
    bool IsSleeping;                                                                  // 0x0D66 (size: 0x1)
    bool IsSittingInSeat;                                                             // 0x0D67 (size: 0x1)
    bool IsDrivingVehicle;                                                            // 0x0D68 (size: 0x1)
    class ADeployed_Furniture_Bed_ParentBP_C* CurrentBed;                             // 0x0D70 (size: 0x8)
    double FatigueRequiredToSleep;                                                    // 0x0D78 (size: 0x8)
    FTimerHandle Sleeping_Timer;                                                      // 0x0D80 (size: 0x8)
    FAbiotic_Character_ParentBP_CSleepSitState_Changed SleepSitState_Changed;         // 0x0D88 (size: 0x10)
    void SleepSitState_Changed();
    double TimeLastMadeLandingNoise;                                                  // 0x0D98 (size: 0x8)
    class USceneComponent* SeizedByComponent;                                         // 0x0DA0 (size: 0x8)
    bool HasMasterKey;                                                                // 0x0DA8 (size: 0x1)
    double TimeLastRevived;                                                           // 0x0DB0 (size: 0x8)
    TEnumAsByte<EBloodSplatterType::Type> BloodSplatterType;                          // 0x0DB8 (size: 0x1)
    bool IsReloading;                                                                 // 0x0DB9 (size: 0x1)
    TSoftObjectPtr<UAnimMontage> ReloadMontage;                                       // 0x0DC0 (size: 0x28)
    bool InvincibleToNPCs;                                                            // 0x0DE8 (size: 0x1)
    TArray<FName> DebuffsImmune;                                                      // 0x0DF0 (size: 0x10)
    double TimeOfLastPainYell;                                                        // 0x0E00 (size: 0x8)
    double TimeOfLastPainGrunt;                                                       // 0x0E08 (size: 0x8)
    class AAbioticDeployed_Furniture_ParentBP_C* CurrentSeat;                         // 0x0E10 (size: 0x8)
    int32 LastSeatIndex;                                                              // 0x0E18 (size: 0x4)
    double ContinenceToReceive;                                                       // 0x0E20 (size: 0x8)
    bool HasContinence;                                                               // 0x0E28 (size: 0x1)
    double CurrentContinence;                                                         // 0x0E30 (size: 0x8)
    double MaxContinence;                                                             // 0x0E38 (size: 0x8)
    double ContinenceComputeInterval;                                                 // 0x0E40 (size: 0x8)
    FTimerHandle ContinenceComputeTimer;                                              // 0x0E48 (size: 0x8)
    bool RegeneratesHealth;                                                           // 0x0E50 (size: 0x1)
    double HealthRegenInterval;                                                       // 0x0E58 (size: 0x8)
    FTimerHandle HealthRegenTimer;                                                    // 0x0E60 (size: 0x8)
    double CurrentArmor_Chest;                                                        // 0x0E68 (size: 0x8)
    double CurrentArmor_Arms;                                                         // 0x0E70 (size: 0x8)
    double CurrentArmor_Legs;                                                         // 0x0E78 (size: 0x8)
    double CurrentArmor_Head;                                                         // 0x0E80 (size: 0x8)
    bool Invincible;                                                                  // 0x0E88 (size: 0x1)
    TEnumAsByte<ENPCCharacterSize::Type> CharacterSize;                               // 0x0E89 (size: 0x1)
    bool ReducedHeadDamage;                                                           // 0x0E8A (size: 0x1)
    double CurrentLightValue;                                                         // 0x0E90 (size: 0x8)
    bool DebugMeleeSwings;                                                            // 0x0E98 (size: 0x1)
    bool PerformingMeleeSwing;                                                        // 0x0E99 (size: 0x1)
    FMeleeingData_Struct CurrentMeleeingData;                                         // 0x0EA0 (size: 0x50)
    TArray<class AActor*> ActorsHitThisMeleeSwing;                                    // 0x0EF0 (size: 0x10)
    int32 MeleeSwingProgress;                                                         // 0x0F00 (size: 0x4)
    float CurrentReloadDuration;                                                      // 0x0F04 (size: 0x4)
    double SpeakingAlpha;                                                             // 0x0F08 (size: 0x8)
    class USourceEffectEnvelopeFollowerPreset* LipsyncPreset;                         // 0x0F10 (size: 0x8)
    bool HasLipsync;                                                                  // 0x0F18 (size: 0x1)
    bool LipsyncRegistered;                                                           // 0x0F19 (size: 0x1)
    class UEnvelopeFollowerListener* LipSyncFollower;                                 // 0x0F20 (size: 0x8)
    double CurrentSafetyValue;                                                        // 0x0F28 (size: 0x8)
    bool DoTick_GrabZoneCheck;                                                        // 0x0F30 (size: 0x1)
    FName GrabSocket;                                                                 // 0x0F34 (size: 0x8)
    class AAbiotic_Character_ParentBP_C* GrabbedByCharacter;                          // 0x0F40 (size: 0x8)
    float GrabCheckRadius;                                                            // 0x0F48 (size: 0x4)
    class AAbiotic_Character_ParentBP_C* HoldingCharacter;                            // 0x0F50 (size: 0x8)
    bool InfiniteStamina;                                                             // 0x0F58 (size: 0x1)
    bool ClimbingLadder;                                                              // 0x0F59 (size: 0x1)
    class ADeployed_Ladder_ParentBP_C* CurrentLadder;                                 // 0x0F60 (size: 0x8)
    double LadderClimbSpeed;                                                          // 0x0F68 (size: 0x8)
    double LadderStartZ;                                                              // 0x0F70 (size: 0x8)
    bool RecentlyStaggered;                                                           // 0x0F78 (size: 0x1)
    double TemperatureInterval;                                                       // 0x0F80 (size: 0x8)
    FTimerHandle TemperatureCheckTimer;                                               // 0x0F88 (size: 0x8)
    class UCurveFloat* TemperatureCurve;                                              // 0x0F90 (size: 0x8)
    float TargetBodyTemperature;                                                      // 0x0F98 (size: 0x4)
    double CurrentRadiation;                                                          // 0x0FA0 (size: 0x8)
    bool CanReceiveRadiation;                                                         // 0x0FA8 (size: 0x1)
    double RadiationCheckInterval;                                                    // 0x0FB0 (size: 0x8)
    FTimerHandle RadiationCheckTimer;                                                 // 0x0FB8 (size: 0x8)
    double CurrentRadiationBeingReceived;                                             // 0x0FC0 (size: 0x8)
    double MaxRadiation;                                                              // 0x0FC8 (size: 0x8)
    FAbiotic_Character_ParentBP_CRadiation_Changed Radiation_Changed;                 // 0x0FD0 (size: 0x10)
    void Radiation_Changed();
    FAbiotic_Character_ParentBP_CIncomingRadiation_Changed IncomingRadiation_Changed; // 0x0FE0 (size: 0x10)
    void IncomingRadiation_Changed();
    TArray<double> WalkSpeed_Modifiers;                                               // 0x0FF0 (size: 0x10)
    double RadiationResistance;                                                       // 0x1000 (size: 0x8)
    double Pitch;                                                                     // 0x1008 (size: 0x8)
    double Yaw;                                                                       // 0x1010 (size: 0x8)
    double DamageReductionPerArmorPoint;                                              // 0x1018 (size: 0x8)
    bool LastLadderDirectionDown;                                                     // 0x1020 (size: 0x1)
    bool UsingZipline;                                                                // 0x1021 (size: 0x1)
    class AZipline_C* CurrentZipline;                                                 // 0x1028 (size: 0x8)
    FAbiotic_Character_ParentBP_CZiplineState_Changed ZiplineState_Changed;           // 0x1030 (size: 0x10)
    void ZiplineState_Changed();
    double DamageToNPCs;                                                              // 0x1040 (size: 0x8)
    double DefaultSpottability;                                                       // 0x1048 (size: 0x8)
    bool ZenMode;                                                                     // 0x1050 (size: 0x1)
    bool IsAI;                                                                        // 0x1051 (size: 0x1)
    int32 ReviveCount;                                                                // 0x1054 (size: 0x4)
    bool DeadFlailInAir;                                                              // 0x1058 (size: 0x1)
    bool IsShieldBlocking;                                                            // 0x1059 (size: 0x1)
    double LastBlockedDamagePercentage;                                               // 0x1060 (size: 0x8)
    double WalkSoundVolume;                                                           // 0x1068 (size: 0x8)
    double SprintSoundVolume;                                                         // 0x1070 (size: 0x8)
    class UNiagaraComponent* VomitEmitter;                                            // 0x1078 (size: 0x8)
    double TimeLastVomitted;                                                          // 0x1080 (size: 0x8)
    bool LastKilledByInstantDamageType;                                               // 0x1088 (size: 0x1)
    FAbiotic_Character_ParentBP_CWasShoved WasShoved;                                 // 0x1090 (size: 0x10)
    void WasShoved(class AAbiotic_Character_ParentBP_C* Shover);
    bool IsSpeaking;                                                                  // 0x10A0 (size: 0x1)
    bool IsStateDrainDisabled;                                                        // 0x10A1 (size: 0x1)
    FRotator LastSeatRotation;                                                        // 0x10A8 (size: 0x18)
    FBloodStains_Struct BloodStainsData;                                              // 0x10C0 (size: 0x10)
    double DefaultMaxFatigue;                                                         // 0x10D0 (size: 0x8)
    TSubclassOf<class UDamageType> LastFatalDamageType;                               // 0x10D8 (size: 0x8)
    FTimerHandle VomitTimer;                                                          // 0x10E0 (size: 0x8)
    TArray<class AActor*> VomitHitActors;                                             // 0x10E8 (size: 0x10)
    bool SilenceDuringNarrative;                                                      // 0x10F8 (size: 0x1)
    bool LadderStillOnFloor;                                                          // 0x10F9 (size: 0x1)
    class UPlayerCharacterVoiceDataAsset* LoadedVoiceAsset;                           // 0x1100 (size: 0x8)
    double LastStartBlockTime;                                                        // 0x1108 (size: 0x8)
    int32 MaxReviveCount;                                                             // 0x1110 (size: 0x4)
    bool IsDisabled;                                                                  // 0x1114 (size: 0x1)
    bool PerformingWeaponThrow;                                                       // 0x1115 (size: 0x1)
    double WeaponHoldThrowProgress;                                                   // 0x1118 (size: 0x8)
    double TempThreshold_Ignition;                                                    // 0x1120 (size: 0x8)
    double TempThreshold_VeryHot;                                                     // 0x1128 (size: 0x8)
    double TempThreshold_Hot;                                                         // 0x1130 (size: 0x8)
    double TempThreshold_Warm;                                                        // 0x1138 (size: 0x8)
    double TempThreshold_Default;                                                     // 0x1140 (size: 0x8)
    double TempThreshold_Cool;                                                        // 0x1148 (size: 0x8)
    double TempThreshold_Cold;                                                        // 0x1150 (size: 0x8)
    double TempThreshold_VeryCold;                                                    // 0x1158 (size: 0x8)
    bool HasSwimmingStats;                                                            // 0x1160 (size: 0x1)
    FTimerHandle SwimmingUpdateTimer;                                                 // 0x1168 (size: 0x8)
    double SwimmingUpdateInterval;                                                    // 0x1170 (size: 0x8)
    double UnderwaterImmersionDepth;                                                  // 0x1178 (size: 0x8)
    double WaddingImmersionDepth;                                                     // 0x1180 (size: 0x8)
    double DrownTime;                                                                 // 0x1188 (size: 0x8)
    double RebreatherDrownTime;                                                       // 0x1190 (size: 0x8)
    FAbiotic_Character_ParentBP_CContinence_Changed Continence_Changed;               // 0x1198 (size: 0x10)
    void Continence_Changed();
    double TotalArmorWeight;                                                          // 0x11A8 (size: 0x8)
    bool BodyShieldAbsorbedLastHit;                                                   // 0x11B0 (size: 0x1)
    TArray<class ARadioactiveZone_ParentBP_C*> OverlappingRadioactiveZones;           // 0x11B8 (size: 0x10)
    TArray<class AAbioticLevelStreamingVolume*> OverlappingLevelVolumes;              // 0x11C8 (size: 0x10)
    FAbiotic_Character_ParentBP_CLevelStreamingVolumesUpdated LevelStreamingVolumesUpdated; // 0x11D8 (size: 0x10)
    void LevelStreamingVolumesUpdated();
    double CrouchedWaddingImmersionDepth;                                             // 0x11E8 (size: 0x8)
    double MaxArmorDamageReduction;                                                   // 0x11F0 (size: 0x8)
    FGameplayTagContainer CompatibleGrabs;                                            // 0x11F8 (size: 0x20)
    FName HitReactionBone;                                                            // 0x1218 (size: 0x8)
    bool HasBeenGrabbed;                                                              // 0x1220 (size: 0x1)
    bool NoDamageSpillover;                                                           // 0x1221 (size: 0x1)
    float DefaultGravityScale;                                                        // 0x1224 (size: 0x4)
    double NearbyFatigueMultiplier;                                                   // 0x1228 (size: 0x8)
    TMap<EVoiceLineType, double> TimeOfVoiceLineTypeSpoken;                           // 0x1230 (size: 0x50)
    float HitReactImpulse_Max;                                                        // 0x1280 (size: 0x4)
    FAbiotic_Character_ParentBP_COnBlockReaction OnBlockReaction;                     // 0x1288 (size: 0x10)
    void OnBlockReaction();
    bool RecentlyBlockedAttack;                                                       // 0x1298 (size: 0x1)
    bool WasSwimmingLastCheck;                                                        // 0x1299 (size: 0x1)
    FAbiotic_Character_ParentBP_COnGrabbed OnGrabbed;                                 // 0x12A0 (size: 0x10)
    void OnGrabbed(class AAbiotic_Character_ParentBP_C* Character);
    FAbiotic_DeathData_Struct DeathData;                                              // 0x12B0 (size: 0x48)
    bool CanRagdoll;                                                                  // 0x12F8 (size: 0x1)
    FVector RagdollLocation;                                                          // 0x1300 (size: 0x18)
    FName RagdollBoneRoot;                                                            // 0x1318 (size: 0x8)
    class UPhysicsAsset* RagdollPhysicsOverride;                                      // 0x1320 (size: 0x8)
    bool HadRVOEnabled;                                                               // 0x1328 (size: 0x1)
    bool PerformingMeleeAttack;                                                       // 0x1329 (size: 0x1)
    double RagdollDelay;                                                              // 0x1330 (size: 0x8)
    double RagdollBlendLength;                                                        // 0x1338 (size: 0x8)
    FVector ZiplineStartLoc;                                                          // 0x1340 (size: 0x18)
    TSoftObjectPtr<UDialogueWave> LastDialogPlayed;                                   // 0x1358 (size: 0x28)
    bool TorsoIsLethal;                                                               // 0x1380 (size: 0x1)
    FTransform SeatTransform;                                                         // 0x1390 (size: 0x60)
    double TimeLastVehicleHit;                                                        // 0x13F0 (size: 0x8)
    int32 CurrentHeatResist;                                                          // 0x13F8 (size: 0x4)
    int32 CurrentColdResist;                                                          // 0x13FC (size: 0x4)
    FAbiotic_Character_ParentBP_CTempResist_Changed TempResist_Changed;               // 0x1400 (size: 0x10)
    void TempResist_Changed();
    class UNiagaraComponent* ColdBreathEmitter;                                       // 0x1410 (size: 0x8)
    double VomitForwardDistance;                                                      // 0x1418 (size: 0x8)
    double ArmorSoftCap;                                                              // 0x1420 (size: 0x8)
    double DiminishingReturnScalingFactor;                                            // 0x1428 (size: 0x8)
    double LastActiveCamoCooldown;                                                    // 0x1430 (size: 0x8)
    FAbiotic_Character_ParentBP_CCharacterOutlineChanged CharacterOutlineChanged;     // 0x1438 (size: 0x10)
    void CharacterOutlineChanged(class AAbiotic_Character_ParentBP_C* OutlinedCharacter, bool Outline);
    double RecentDamageTaken;                                                         // 0x1448 (size: 0x8)
    float DamageMemory;                                                               // 0x1450 (size: 0x4)
    FAbiotic_Character_ParentBP_CNewDamageTaken NewDamageTaken;                       // 0x1458 (size: 0x10)
    void NewDamageTaken(double IncomingDamage, bool FriendlyFire);
    FAbiotic_Character_ParentBP_CCharacterIsSpeaking_Changed CharacterIsSpeaking_Changed; // 0x1468 (size: 0x10)
    void CharacterIsSpeaking_Changed(bool IsSpeaking, class AAbiotic_Character_ParentBP_C* Character);
    double LastTimeWaterFXPlayed;                                                     // 0x1478 (size: 0x8)
    FVector LadderLocationLastSound;                                                  // 0x1480 (size: 0x18)
    bool TakeFallDamage;                                                              // 0x1498 (size: 0x1)
    FVector StartOfLastFall;                                                          // 0x14A0 (size: 0x18)
    class UNiagaraSystem* DamageResistedNiagara;                                      // 0x14B8 (size: 0x8)
    bool RagdollFreezeReady;                                                          // 0x14C0 (size: 0x1)
    int32 RagdollFreezeAttempt;                                                       // 0x14C4 (size: 0x4)
    bool Parrying;                                                                    // 0x14C8 (size: 0x1)
    double LastTimeUsedOffhand;                                                       // 0x14D0 (size: 0x8)
