...
class ADeployed_DistributionPad_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UNiagaraComponent* Niagara_DistributionPad_Portal;                          // 0x0878 (size: 0x8)
    class UAudioComponent* InventoryActionAudio;                                      // 0x0880 (size: 0x8)
    class UAudioComponent* PoweredAudio;                                              // 0x0888 (size: 0x8)
    class UBoxComponent* PlayerOverlapSphere;                                         // 0x0890 (size: 0x8)
    class USphereComponent* ContainerOverlapSphere;                                   // 0x0898 (size: 0x8)
    TArray<class UAbiotic_InventoryComponent_C*> AdditionalInventories;               // 0x08A0 (size: 0x10)
    int32 DistributeContainerIndex;                                                   // 0x08B0 (size: 0x4)
    FTimerHandle DistributeTimer;                                                     // 0x08B8 (size: 0x8)
    bool DistributionActive;                                                          // 0x08C0 (size: 0x1)
    class AActor* ActorToDistribute;                                                  // 0x08C8 (size: 0x8)
