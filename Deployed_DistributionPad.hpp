...
class ADeployed_DistributionPad_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UNiagaraComponent* Niagara_DistributionPad_Portal;                          // 0x0938 (size: 0x8)
    class UAudioComponent* InventoryActionAudio;                                      // 0x0940 (size: 0x8)
    class UAudioComponent* PoweredAudio;                                              // 0x0948 (size: 0x8)
    class UBoxComponent* PlayerOverlapSphere;                                         // 0x0950 (size: 0x8)
    class USphereComponent* ContainerOverlapSphere;                                   // 0x0958 (size: 0x8)
    TArray<class UAbiotic_InventoryComponent_C*> AdditionalInventories;               // 0x0960 (size: 0x10)
    int32 DistributeContainerIndex;                                                   // 0x0970 (size: 0x4)
    FTimerHandle DistributeTimer;                                                     // 0x0978 (size: 0x8)
    bool DistributionActive;                                                          // 0x0980 (size: 0x1)
    class AActor* ActorToDistribute;                                                  // 0x0988 (size: 0x8)
