#ifndef UE4SS_SDK_W_RadialWheel_CookingItems_HPP
#define UE4SS_SDK_W_RadialWheel_CookingItems_HPP

class UW_RadialWheel_CookingItems_C : public UW_RadialWheel_ParentBP_C
{
    ...
    void ExecuteUbergraph_W_RadialWheel_CookingItems(int32 EntryPoint);
}; // Size: 0x388
