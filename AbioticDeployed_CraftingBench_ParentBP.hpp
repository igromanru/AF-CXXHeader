...
class AAbioticDeployed_CraftingBench_ParentBP_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UAbiotic_InventoryComponent_C* UpgradeInventory;                            // 0x0878 (size: 0x8)
    FDataTableRowHandle BenchDataTableRow;                                            // 0x0880 (size: 0x10)
    double AntiSpawnRadius;                                                           // 0x0890 (size: 0x8)
    EInventoryMode CraftBenchMode;                                                    // 0x0898 (size: 0x1)
    FGameplayTagContainer UpgradeTagContainer;                                        // 0x08A0 (size: 0x20)
    FAbioticDeployed_CraftingBench_ParentBP_CTagContainerUpdated TagContainerUpdated; // 0x08C0 (size: 0x10)
    void TagContainerUpdated();
    bool SupportsUpgrades;                                                            // 0x08D0 (size: 0x1)
    TArray<class UAbiotic_InventoryComponent_C*> AdditionalInventories;               // 0x08D8 (size: 0x10)
    TArray<FName> RecipesToUnlockOnAccess;                                            // 0x08E8 (size: 0x10)
    class UTexture2D* BenchUpgradeIcon;                                               // 0x08F8 (size: 0x8)
