...
{
    class USceneComponent* Support_BL;                                                // 0x0920 (size: 0x8)
    class USceneComponent* Support_BR;                                                // 0x0928 (size: 0x8)
    class USceneComponent* Support_FL;                                                // 0x0930 (size: 0x8)
    class USceneComponent* Support_FR;                                                // 0x0938 (size: 0x8)
    class USceneComponent* SnapLocation;                                              // 0x0940 (size: 0x8)
    double SupportMeshStretchMultiplier;                                              // 0x0948 (size: 0x8)
    double SupportMeshLength;                                                         // 0x0950 (size: 0x8)
