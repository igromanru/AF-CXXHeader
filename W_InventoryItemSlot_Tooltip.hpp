...
class UW_InventoryItemSlot_Tooltip_C : public UUserWidget
{
    ...
    class UTextBlock* WeaponCoatingText;                                              // 0x04A8 (size: 0x8)
    class UTextBlock* Weight_Text;                                                    // 0x04B0 (size: 0x8)
    FAbiotic_InventoryItemStruct ItemData;                                            // 0x04B8 (size: 0x650)
    FAbiotic_InventoryChangeableDataStruct ChangeableItemData;                        // 0x0B08 (size: 0x88)
    bool JustTitle;                                                                   // 0x0B90 (size: 0x1)
    bool BuiltBuffList;                                                               // 0x0B91 (size: 0x1)
    TEnumAsByte<E_ItemTooltipState::Type> TooltipState;                               // 0x0B92 (size: 0x1)
    bool BriefTooltip;                                                                // 0x0B93 (size: 0x1)
    FLinearColor DefaultTextColor;                                                    // 0x0B94 (size: 0x10)
    FRecipeSubstitutes_Struct SubstituteItemData;                                     // 0x0BA8 (size: 0x58)
    double LocationX;                                                                 // 0x0C00 (size: 0x8)
    double LocationY;                                                                 // 0x0C08 (size: 0x8)
    TEnumAsByte<E_InventorySlotType::Type> InvSlotType;                               // 0x0C10 (size: 0x1)
    bool IsRepresentationSlot;                                                        // 0x0C11 (size: 0x1)
    bool CraftableNotice;                                                             // 0x0C12 (size: 0x1)
    FName ItemRowName;                                                                // 0x0C14 (size: 0x8)
    bool BrokenItem;                                                                  // 0x0C1C (size: 0x1)
    double LiquidWeightMultiplier;                                                    // 0x0C20 (size: 0x8)
    bool HiddenItem;                                                                  // 0x0C28 (size: 0x1)
    bool FoundActiveSetBonus;                                                         // 0x0C29 (size: 0x1)
    TArray<class UW_Tooltip_TextLine_C*> FoundSetBonusText;                           // 0x0C30 (size: 0x10)
    TEnumAsByte<E_ItemUpgradeState::Type> ItemUpgradeAvailable;                       // 0x0C40 (size: 0x1)
    TArray<FText> SetBonusTexts;                                                      // 0x0C48 (size: 0x10)
    float CalculatedItemWeight;                                                       // 0x0C58 (size: 0x4)
    TArray<FLinearColor> SetBonusColors;                                              // 0x0C60 (size: 0x10)
    FText LastItemName;                                                               // 0x0C70 (size: 0x10)
