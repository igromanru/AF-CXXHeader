...
class ADeployed_Vine_Plant_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    float GrowVines_NewTrack_0_99E253FB4E8B58AF959E27BE5AF19D1B;                      // 0x0938 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> GrowVines__Direction_99E253FB4E8B58AF959E27BE5AF19D1B; // 0x093C (size: 0x1)
    class UTimelineComponent* GrowVines;                                              // 0x0940 (size: 0x8)
