...
class AItem_ThrowableBP_C : public AAbiotic_Item_Held_C
{
    ...
    float ThrowingArcTimeline_NewTrack_0_9C510F444F19A91567F3F9A54A3D7EB5;            // 0x0B20 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> ThrowingArcTimeline__Direction_9C510F444F19A91567F3F9A54A3D7EB5; // 0x0B24 (size: 0x1)
    class UTimelineComponent* ThrowingArcTimeline;                                    // 0x0B28 (size: 0x8)
    bool HasBeenUsed;                                                                 // 0x0B30 (size: 0x1)
    int32 LastKnownHotbarSlot;                                                        // 0x0B34 (size: 0x4)
    bool About ToThrow;                                                               // 0x0B38 (size: 0x1)
    double ThrowableMontagePauseDelay;                                                // 0x0B40 (size: 0x8)
    int32 FuseCountdown;                                                              // 0x0B48 (size: 0x4)
    FTimerHandle ThrowableCookingTimer;                                               // 0x0B50 (size: 0x8)
    double FuseStartTime;                                                             // 0x0B58 (size: 0x8)
    bool CanThrowUnderhand;                                                           // 0x0B60 (size: 0x1)
    double UnderhandThrowingSpeed;                                                    // 0x0B68 (size: 0x8)
