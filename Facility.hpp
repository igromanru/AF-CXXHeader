...
class AFacility_C : public ALevelScriptActor
{
    ...
    class ABP_Teleporter_ParentBP_C* BP_Teleporter_ParentBP_C_84_ExecuteUbergraph_Facility_RefProperty; // 0x02A8 (size: 0x8)
    ...
    class AStaticMeshActor* StaticMeshActor_222_ExecuteUbergraph_Facility_RefProperty; // 0x02C0 (size: 0x8)
