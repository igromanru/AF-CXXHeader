...
class ANPC_Base_ParentBP_C : public AAbiotic_Character_ParentBP_C
{
    ...
    class UAbioticTargetingComponent_Sockets* AbioticTargetingComponent_Sockets;      // 0x1518 (size: 0x8)
    class UAudioComponent* BreathingAudio;                                            // 0x1520 (size: 0x8)
    class UOptimizationProxyComponent* OptimizationProxy;                             // 0x1528 (size: 0x8)
    class UStaticMeshComponent* NetMesh;                                              // 0x1530 (size: 0x8)
    class UTextRenderComponent* LocalSpotValueText;                                   // 0x1538 (size: 0x8)
    class USceneComponent* KneePoint;                                                 // 0x1540 (size: 0x8)
    float FadeBodyTimeline_Opacity_A74321CF4140C66DAED2358C151E0B07;                  // 0x1548 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> FadeBodyTimeline__Direction_A74321CF4140C66DAED2358C151E0B07; // 0x154C (size: 0x1)
    class UTimelineComponent* FadeBodyTimeline;                                       // 0x1550 (size: 0x8)
    FAbiotic_NPCStruct NPCData;                                                       // 0x1558 (size: 0x2F8)
    FName NPCDataTableRow;                                                            // 0x1850 (size: 0x8)
    bool CanSenseSmells;                                                              // 0x1858 (size: 0x1)
    double Smelling Range;                                                            // 0x1860 (size: 0x8)
    bool PrintDebugStrings;                                                           // 0x1868 (size: 0x1)
    TEnumAsByte<ENPCAwarenessState::Type> AwarenessState;                             // 0x1869 (size: 0x1)
    class AAbiotic_AI_Controller_ParentBP_C* NPC_Controller;                          // 0x1870 (size: 0x8)
    FVector LastRangedAttackLocation;                                                 // 0x1878 (size: 0x18)
    FVector LastMeleeAttackLocation;                                                  // 0x1890 (size: 0x18)
    TSoftObjectPtr<UAnimMontage> AggroAnimation;                                      // 0x18A8 (size: 0x28)
    bool CombatState;                                                                 // 0x18D0 (size: 0x1)
    bool RangedAttack_OnCooldown;                                                     // 0x18D1 (size: 0x1)
    bool MeleeAttack_OnCooldown;                                                      // 0x18D2 (size: 0x1)
    FName MeleeOriginBone;                                                            // 0x18D4 (size: 0x8)
    FVector LastMeleeOrigin;                                                          // 0x18E0 (size: 0x18)
    double MeleeHitApex;                                                              // 0x18F8 (size: 0x8)
    bool HasDroppedLoot;                                                              // 0x1900 (size: 0x1)
    bool CanHurtSelfWithRadialDamage;                                                 // 0x1901 (size: 0x1)
    double DamageTakenAfterDeath;                                                     // 0x1908 (size: 0x8)
    bool IsGibbed;                                                                    // 0x1910 (size: 0x1)
    double DefaultNPCBodyFadeOutTime;                                                 // 0x1918 (size: 0x8)
    bool BodyFadingOut;                                                               // 0x1920 (size: 0x1)
    TArray<class UMaterialInstanceDynamic*> MeshDynamicMaterials;                     // 0x1928 (size: 0x10)
    TEnumAsByte<E_SquadMemberNumber::Type> SquadMemberNumber;                         // 0x1938 (size: 0x1)
    float RangedAttack_Cooldown;                                                      // 0x193C (size: 0x4)
    TSoftObjectPtr<UAnimMontage> StartleAnimation;                                    // 0x1940 (size: 0x28)
    FTimerHandle SpotVisDebugTimer;                                                   // 0x1968 (size: 0x8)
    double StaggerCooldown;                                                           // 0x1970 (size: 0x8)
    TSoftObjectPtr<UAnimMontage> StaggerAnimation;                                    // 0x1978 (size: 0x28)
    double StaggerAnimDuration;                                                       // 0x19A0 (size: 0x8)
    TMap<TEnumAsByte<E_NPC_MeleeTypes::Type>, TSoftObjectPtr<UAnimMontage>> MeleeAttacks; // 0x19A8 (size: 0x50)
    FName ProjectileFireSocket;                                                       // 0x19F8 (size: 0x8)
    TEnumAsByte<E_NPC_MeleeTypes::Type> LastMeleeAttackType;                          // 0x1A00 (size: 0x1)
    TSoftObjectPtr<UAnimMontage> StaggerAnimationLeft;                                // 0x1A08 (size: 0x28)
    TSoftObjectPtr<UAnimMontage> StaggerAnimationRight;                               // 0x1A30 (size: 0x28)
    TSoftObjectPtr<UAnimMontage> BackstepAnimation;                                   // 0x1A58 (size: 0x28)
    FName GrenadeHoldSocket;                                                          // 0x1A80 (size: 0x8)
    class UStaticMeshComponent* LastGrenadeInHandMesh;                                // 0x1A88 (size: 0x8)
    FDataTableRowHandle GrenadeData;                                                  // 0x1A90 (size: 0x10)
    double TimeOfLastGrabAttempt;                                                     // 0x1AA0 (size: 0x8)
    double TimeOfLastSuccessfulGrab;                                                  // 0x1AA8 (size: 0x8)
    double GrabCooldown;                                                              // 0x1AB0 (size: 0x8)
    TArray<FName> SmellTags;                                                          // 0x1AB8 (size: 0x10)
    FTimerHandle GrabEndTimer;                                                        // 0x1AC8 (size: 0x8)
    int32 NPC Level;                                                                  // 0x1AD0 (size: 0x4)
    double LastIncomingDamage;                                                        // 0x1AD8 (size: 0x8)
    bool PerformingRangedBurst;                                                       // 0x1AE0 (size: 0x1)
    double NPCRangedBulletSpread;                                                     // 0x1AE8 (size: 0x8)
    class AAbiotic_Character_ParentBP_C* LastAttackedTarget;                          // 0x1AF0 (size: 0x8)
    class UNiagaraSystem* GibParticles;                                               // 0x1AF8 (size: 0x8)
    bool ParentLevelDeloaded;                                                         // 0x1B00 (size: 0x1)
    FNPC_Base_ParentBP_CCombatReset CombatReset;                                      // 0x1B08 (size: 0x10)
    void CombatReset(bool Success);
    double MeleeRangeTraceExtra;                                                      // 0x1B18 (size: 0x8)
    bool SpinAttack_OnCooldown;                                                       // 0x1B20 (size: 0x1)
    bool BehindAttack_OnCooldown;                                                     // 0x1B21 (size: 0x1)
    double SpinMeleeHitApex;                                                          // 0x1B28 (size: 0x8)
    double BehindMeleeHitApex;                                                        // 0x1B30 (size: 0x8)
    bool PowerAttack_OnCooldown;                                                      // 0x1B38 (size: 0x1)
    TArray<class AActor*> LastActorsHit;                                              // 0x1B40 (size: 0x10)
    double SpinAttackCooldown;                                                        // 0x1B50 (size: 0x8)
    double BehindAttackCooldown;                                                      // 0x1B58 (size: 0x8)
    double PowerMeleeHitApex;                                                         // 0x1B60 (size: 0x8)
    float MeleeTraceRadius;                                                           // 0x1B68 (size: 0x4)
    bool ForwardMeleeSwing;                                                           // 0x1B6C (size: 0x1)
    double ClampMeleeDirectionOffset;                                                 // 0x1B70 (size: 0x8)
    bool ClampMeleeDirection;                                                         // 0x1B78 (size: 0x1)
    float SpinLaunchPower;                                                            // 0x1B7C (size: 0x4)
    double PowerAttackCooldown;                                                       // 0x1B80 (size: 0x8)
    TSoftObjectPtr<AActor> SpawnerOwner;                                              // 0x1B88 (size: 0x28)
    bool AlwaysDropGibs;                                                              // 0x1BB0 (size: 0x1)
    TEnumAsByte<E_NettedStates::Type> Netted;                                         // 0x1BB1 (size: 0x1)
    FVector LocationOfInterest;                                                       // 0x1BB8 (size: 0x18)
    double BleedoutTime;                                                              // 0x1BD0 (size: 0x8)
    double TimeSinceDBNO;                                                             // 0x1BD8 (size: 0x8)
    double DBNODamageDelay;                                                           // 0x1BE0 (size: 0x8)
    bool FrozenByDirector;                                                            // 0x1BE8 (size: 0x1)
    bool StationaryUntilPlayerEncounter;                                              // 0x1BE9 (size: 0x1)
    bool WaitForGrabMontageEnd;                                                       // 0x1BEA (size: 0x1)
    double BaseLookUpRate;                                                            // 0x1BF0 (size: 0x8)
    double BaseTurnRate;                                                              // 0x1BF8 (size: 0x8)
    bool Possessable;                                                                 // 0x1C00 (size: 0x1)
    double WalkSpeed;                                                                 // 0x1C08 (size: 0x8)
    bool HandleGrabManually;                                                          // 0x1C10 (size: 0x1)
    float Cooldown_IdleAbility;                                                       // 0x1C14 (size: 0x4)
    float Cooldown_CombatAbility1;                                                    // 0x1C18 (size: 0x4)
    float Cooldown_CombatAbility2;                                                    // 0x1C1C (size: 0x4)
    float Cooldown_CombatAbility3;                                                    // 0x1C20 (size: 0x4)
    float FallbackAggroDuration;                                                      // 0x1C24 (size: 0x4)
    float AggroDuration;                                                              // 0x1C28 (size: 0x4)
    class UStaticMesh* LoadedGrenadeMesh;                                             // 0x1C30 (size: 0x8)
    int32 CurrentAmmoCount;                                                           // 0x1C38 (size: 0x4)
    int32 MaxAmmoCount;                                                               // 0x1C3C (size: 0x4)
    TSoftObjectPtr<UAnimMontage> Asset;                                               // 0x1C40 (size: 0x28)
    class USoundBase* NettedSound;                                                    // 0x1C68 (size: 0x8)
    FName NettedSocket;                                                               // 0x1C70 (size: 0x8)
    class USoundBase* GibbedSound;                                                    // 0x1C78 (size: 0x8)
    TEnumAsByte<E_ShoveableType::Type> ShoveableType;                                 // 0x1C80 (size: 0x1)
    bool WasRecentlyStartled;                                                         // 0x1C81 (size: 0x1)
    float StartleCooldown;                                                            // 0x1C84 (size: 0x4)
    FGameplayTag GrabTag;                                                             // 0x1C88 (size: 0x8)
    float SpinAttackRadius;                                                           // 0x1C90 (size: 0x4)
    float DespawnDistance;                                                            // 0x1C94 (size: 0x4)
    float DespawnDistanceUnloaded;                                                    // 0x1C98 (size: 0x4)
    double HighMeleeHitApex;                                                          // 0x1CA0 (size: 0x8)
    TSoftObjectPtr<UAnimMontage> BackstepLeftAnimation;                               // 0x1CA8 (size: 0x28)
    TSoftObjectPtr<UAnimMontage> BackstepRightAnimation;                              // 0x1CD0 (size: 0x28)
    TSoftObjectPtr<UAnimMontage> GrenadeThrowAnimation;                               // 0x1CF8 (size: 0x28)
    int32 CurrentHealthTextureIndex;                                                  // 0x1D20 (size: 0x4)
    TArray<class UTexture2D*> HealthTextures;                                         // 0x1D28 (size: 0x10)
    bool IsPerformingDoorEnter;                                                       // 0x1D38 (size: 0x1)
    bool CanMeleeMultiHit;                                                            // 0x1D39 (size: 0x1)
    TEnumAsByte<E_NPC_MeleeTypes::Type> PreferredHighGroundAttack;                    // 0x1D3A (size: 0x1)
    double BehindAttackDirection;                                                     // 0x1D40 (size: 0x8)
    bool StationaryMode;                                                              // 0x1D48 (size: 0x1)
    class AActor* StationaryTarget;                                                   // 0x1D50 (size: 0x8)
    bool RecentlyWeaknessStaggered;                                                   // 0x1D58 (size: 0x1)
    bool CanInterruptAggroAnim;                                                       // 0x1D59 (size: 0x1)
    TArray<FName> Cages ID to Ignore;                                                 // 0x1D60 (size: 0x10)
    TEnumAsByte<E_SquadDesignations::Type> SquadDesignation;                          // 0x1D70 (size: 0x1)
    double NetDurationReductionPercentage;                                            // 0x1D78 (size: 0x8)
    TSoftObjectPtr<UAnimMontage> StaggerAnimationForward;                             // 0x1D80 (size: 0x28)
    class USoundWave* SFX_Breathing_Idle;                                             // 0x1DA8 (size: 0x8)
    class USoundWave* SFX_Breathing_Combat;                                           // 0x1DB0 (size: 0x8)
    TSoftObjectPtr<ANPCTetherVolume_C> TetherVolume;                                  // 0x1DB8 (size: 0x28)
    TSoftObjectPtr<ABP_SquadManager_C> LinkedSquadManager;                            // 0x1DE0 (size: 0x28)
    double ImmuneDamageMultiplier;                                                    // 0x1E08 (size: 0x8)
    FNPCVoiceRowHandle NPCVoiceRow;                                                   // 0x1E10 (size: 0x20)
    FNPCVoice NPCVoiceData;                                                           // 0x1E30 (size: 0x188)
    bool IsPerformingSpawnFX;                                                         // 0x1FB8 (size: 0x1)
    double SpawnFXDuration;                                                           // 0x1FC0 (size: 0x8)
    bool SkipSpawnFX;                                                                 // 0x1FC8 (size: 0x1)
    bool Stunned;                                                                     // 0x1FC9 (size: 0x1)
    double DistanceForDialogSubtitles;                                                // 0x1FD0 (size: 0x8)
    TSoftObjectPtr<UWorld> OwningLevel;                                               // 0x1FD8 (size: 0x28)
    class UAnimMontage* OverrideIdleMontage;                                          // 0x2000 (size: 0x8)
    bool RecentlyCriticalHit;                                                         // 0x2008 (size: 0x1)
    float CriticalHit_PreventionDuration;                                             // 0x200C (size: 0x4)
    bool ImmuneToBackstabs;                                                           // 0x2010 (size: 0x1)
    double RangedTarget_VerticalOffset;                                               // 0x2018 (size: 0x8)
    float FootfallTraceDistance;                                                      // 0x2020 (size: 0x4)
    class USoundBase* FootstepSFX;                                                    // 0x2028 (size: 0x8)
    class UNiagaraSystem* FootfallImpactFX;                                           // 0x2030 (size: 0x8)
    FName Left Foot;                                                                  // 0x2038 (size: 0x8)
    FName Right Foot;                                                                 // 0x2040 (size: 0x8)
    FName Left Hand;                                                                  // 0x2048 (size: 0x8)
    FName Right Hand;                                                                 // 0x2050 (size: 0x8)
    FNPC_Base_ParentBP_CCombatStateChanged CombatStateChanged;                        // 0x2058 (size: 0x10)
    void CombatStateChanged(class ANPC_Base_ParentBP_C* Target NPC);
    FName BioscrapItem;                                                               // 0x2068 (size: 0x8)
    TArray<FString> DebugActionStack;                                                 // 0x2070 (size: 0x10)
    bool HasDisabledStateApplied;                                                     // 0x2080 (size: 0x1)
    double BackstepTraceDistance;                                                     // 0x2088 (size: 0x8)
    bool NPCEnraged;                                                                  // 0x2090 (size: 0x1)
    FNPC_Base_ParentBP_CFiredWeapon FiredWeapon;                                      // 0x2098 (size: 0x10)
    void FiredWeapon();
    class USpringArmComponent* DynamicSpringArm;                                      // 0x20A8 (size: 0x8)
    class UCameraComponent* DynamicCamera;                                            // 0x20B0 (size: 0x8)
    double FallDistanceThreshold;                                                     // 0x20B8 (size: 0x8)
    FName FallBoneSocket;                                                             // 0x20C0 (size: 0x8)
    double LastEvadeTime;                                                             // 0x20C8 (size: 0x8)
    bool EvadesProjectiles;                                                           // 0x20D0 (size: 0x1)
    double ProjectileEvasionCooldown;                                                 // 0x20D8 (size: 0x8)
    bool FreezeAI;                                                                    // 0x20E0 (size: 0x1)
