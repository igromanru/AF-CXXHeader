...
class AContainer_Aquarium_ParentBP_C : public ADeployed_Container_ParentBP_C
{
    ...
    class UAudioComponent* AmbientWater;                                              // 0x09F0 (size: 0x8)
    class UNiagaraComponent* Niagara_Bubbler;                                         // 0x09F8 (size: 0x8)
    class UNiagaraComponent* Niagara_WaterDebris;                                     // 0x0A00 (size: 0x8)
    class UAudioComponent* BubblerAudio;                                              // 0x0A08 (size: 0x8)
    TArray<class UBP_FishTankMesh_C*> FishMeshes;                                     // 0x0A10 (size: 0x10)
