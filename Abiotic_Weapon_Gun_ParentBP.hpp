...
class AAbiotic_Weapon_Gun_ParentBP_C : public AAbiotic_Weapon_ParentBP_C
{
    ...
    class UNiagaraSystem* BulletTracerEffect;                                         // 0x0B70 (size: 0x8)
    class UNiagaraSystem* MuzzleFlashEffect;                                          // 0x0B78 (size: 0x8)
    double TimeLastDisplayedMuzzleFlash;                                              // 0x0B80 (size: 0x8)
    FString BulletTracerBeamEnd;                                                      // 0x0B88 (size: 0x10)
    bool ShouldOverrideHitscanLogic;                                                  // 0x0B98 (size: 0x1)
    int32 ShotsUntilTracer;                                                           // 0x0B9C (size: 0x4)
    TSubclassOf<class ABP_BulletTracer_C> Tracer Class;                               // 0x0BA0 (size: 0x8)
    bool DoLocalMuzzleLightFlash;                                                     // 0x0BA8 (size: 0x1)
    FLinearColor LocalMuzzleFlashColor;                                               // 0x0BAC (size: 0x10)
    FLinearColor MuzzleParticleTint;                                                  // 0x0BBC (size: 0x10)
