...
class AAbiotic_Weapon_Gun_ParentBP_C : public AAbiotic_Weapon_ParentBP_C
{
    ...
    class UNiagaraSystem* BulletTracerEffect;                                         // 0x0B78 (size: 0x8)
    class UNiagaraSystem* MuzzleFlashEffect;                                          // 0x0B80 (size: 0x8)
    double TimeLastDisplayedMuzzleFlash;                                              // 0x0B88 (size: 0x8)
    FString BulletTracerBeamEnd;                                                      // 0x0B90 (size: 0x10)
    bool ShouldOverrideHitscanLogic;                                                  // 0x0BA0 (size: 0x1)
    int32 ShotsUntilTracer;                                                           // 0x0BA4 (size: 0x4)
