...
struct FLevelFXData_Struct
{
    ...
    int32 AmbientTemperature_81_B40D46EB42FB1F79EB9E738FF13DDFD2;                     // 0x00E8 (size: 0x4)
    TSoftObjectPtr<UTexture> LUTOverride_67_9AE81DEF4772B99EE903168F538AB3DD;         // 0x00F0 (size: 0x28)
    FDataTableRowHandle DayAnnouncement_70_9AA6A26541EB4E5D26E6C4929824AEAC;          // 0x0118 (size: 0x10)
    FDataTableRowHandle NightAnnouncement_72_E65EAF7646A9B45584F614ADDCB80EA4;        // 0x0128 (size: 0x10)
    TSoftObjectPtr<UNiagaraSystem> WeatherParticle_76_59580B5D4B385C678A2AE4B65C9DE2AE; // 0x0138 (size: 0x28)
    bool WeatherRenderTargetCulling_80_C226FD054276FEAA01CCA388B3F563EA;              // 0x0160 (size: 0x1)
    bool HasDynamicSkybox_86_2A71CEFD45B1BBFD8D1BEC8794017644;                        // 0x0161 (size: 0x1)
