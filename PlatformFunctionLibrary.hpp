...
class UPlatformFunctionLibrary_C : public UBlueprintFunctionLibrary
{
    ...
    void ShouldHomeworldBeActive(const FGameEntitlementRowHandle& RequiredDLC, FWorldFlagRowHandle RequiredWorldFlag, class UObject* __WorldContext, bool& Active);
