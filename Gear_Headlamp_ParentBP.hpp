...
class AGear_Headlamp_ParentBP_C : public AItem_Gear_ParentBP_C
{
    ...
    class UMeshComponent* Headlamp;                                                   // 0x0B48 (size: 0x8)
    class UMaterialInstanceDynamic* LightEmissiveMaterial;                            // 0x0B50 (size: 0x8)
    double OriginalEmissiveGlow;                                                      // 0x0B58 (size: 0x8)
