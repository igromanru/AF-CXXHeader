...
class ADeployed_LaserReflector_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UStaticMeshComponent* ReflectiveSurface;                                    // 0x0878 (size: 0x8)
    class UArrowComponent* Arrow;                                                     // 0x0880 (size: 0x8)
    class ULaserComponent_C* LaserComponent;                                          // 0x0888 (size: 0x8)
    TArray<class UPrimitiveComponent*> ReflectiveSurfaces;                            // 0x0890 (size: 0x10)
    TArray<class ULaserComponent_C*> ReflectedLaserComponents;                        // 0x08A0 (size: 0x10)
