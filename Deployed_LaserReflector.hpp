...
class ADeployed_LaserReflector_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UStaticMeshComponent* ReflectiveSurface;                                    // 0x0928 (size: 0x8)
    class UArrowComponent* Arrow;                                                     // 0x0930 (size: 0x8)
    class ULaserComponent_C* LaserComponent;                                          // 0x0938 (size: 0x8)
    TArray<class UPrimitiveComponent*> ReflectiveSurfaces;                            // 0x0940 (size: 0x10)
    TArray<class ULaserComponent_C*> ReflectedLaserComponents;                        // 0x0950 (size: 0x10)
