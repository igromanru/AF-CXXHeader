...
class ABenchUpgrade_Dioxohealer_C : public ABenchUpgrade_ParentBP_C
{
    ...
    class UNiagaraComponent* Niagara_Dioxohealer_Active;                              // 0x02E0 (size: 0x8)
    ...
    class USphereComponent* Sphere;                                                   // 0x0300 (size: 0x8)
    class UStaticMeshComponent* StaticMesh;                                           // 0x0308 (size: 0x8)
    int32 NearbyPlants;                                                               // 0x0310 (size: 0x4)
    TArray<class AFarmingPlot_BP_C*> PlantList;                                       // 0x0318 (size: 0x10)
