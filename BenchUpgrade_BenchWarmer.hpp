...
class ABenchUpgrade_BenchWarmer_C : public ABenchUpgrade_ParentBP_C
{
    ...
    class UThermalEmitterComponent* ThermalEmitter;                                   // 0x02E0 (size: 0x8)
    class USphereComponent* HeatRadiusSphere;                                         // 0x02E8 (size: 0x8)
    class URectLightComponent* RectLight;                                             // 0x02F0 (size: 0x8)
    class UStaticMeshComponent* Warmer;                                               // 0x02F8 (size: 0x8)
    float Timeline_Light_51BA83C84A4F69D959E32CBAACDC5FE2;                            // 0x0300 (size: 0x4)
    float Timeline_Coils_51BA83C84A4F69D959E32CBAACDC5FE2;                            // 0x0304 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline__Direction_51BA83C84A4F69D959E32CBAACDC5FE2; // 0x0308 (size: 0x1)
    class UTimelineComponent* Timeline;                                               // 0x0310 (size: 0x8)
    bool Switch On;                                                                   // 0x0318 (size: 0x1)
