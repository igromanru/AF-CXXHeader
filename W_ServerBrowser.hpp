...
class UW_ServerBrowser_C : public UUserWidget
{
    ...
    class UBorder* ServerInfo_HardcoreBorder;                                         // 0x0368 (size: 0x8)
    class UTextBlock* ServerInfo_PingText;                                            // 0x0370 (size: 0x8)
    class UTextBlock* ServerInfo_PlayersText;                                         // 0x0378 (size: 0x8)
    class UImage* ServerInfo_ProgressImage;                                           // 0x0380 (size: 0x8)
    class UTextBlock* ServerInfo_StoryProgressDescription;                            // 0x0388 (size: 0x8)
    class UTextBlock* ServerInfo_StoryProgressText;                                   // 0x0390 (size: 0x8)
    class UCanvasPanel* ServerInfoBox;                                                // 0x0398 (size: 0x8)
    class UTextBlock* ServerTitleText;                                                // 0x03A0 (size: 0x8)
    class UTextBlock* ShowDedicated_Text;                                             // 0x03A8 (size: 0x8)
    class UTextBlock* ShowLocked_Text;                                                // 0x03B0 (size: 0x8)
    class UTextBlock* ShowModified_Text;                                              // 0x03B8 (size: 0x8)
    class UTextBlock* StatusText;                                                     // 0x03C0 (size: 0x8)
    class UW_MainMenuButton_C* W_MainMenuButton_Back;                                 // 0x03C8 (size: 0x8)
    class UW_MainMenuButton_C* W_MainMenuButton_DirectConnect;                        // 0x03D0 (size: 0x8)
    class UW_MainMenuButton_C* W_MainMenuButton_FilterApply;                          // 0x03D8 (size: 0x8)
    class UW_MainMenuButton_C* W_MainMenuButton_Join;                                 // 0x03E0 (size: 0x8)
    class UW_MainMenuButton_C* W_MainMenuButton_LANSwitch;                            // 0x03E8 (size: 0x8)
    class UW_MainMenuButton_C* W_MainMenuButton_Refresh;                              // 0x03F0 (size: 0x8)
    class UW_MenuTitleBig_C* W_MenuTitleBig;                                          // 0x03F8 (size: 0x8)
    bool SearchLAN;                                                                   // 0x0400 (size: 0x1)
    TArray<FBlueprintSessionResult> Results;                                          // 0x0408 (size: 0x10)
    FBlueprintSessionResult SelectedSession;                                          // 0x0418 (size: 0x120)
    bool Empty Servers Only;                                                          // 0x0538 (size: 0x1)
    bool Non Empty Servers Only;                                                      // 0x0539 (size: 0x1)
    FString PasswordEntered;                                                          // 0x0540 (size: 0x10)
    bool JoiningInProgress;                                                           // 0x0550 (size: 0x1)
    class UW_PopupPleaseWait_C* PleaseWaitPopup;                                      // 0x0558 (size: 0x8)
    TArray<class USessionResultItem*> SessionResults;                                 // 0x0560 (size: 0x10)
    FString FilterString;                                                             // 0x0570 (size: 0x10)
    TArray<FSessionsSearchSetting> CachedServerFilters;                               // 0x0580 (size: 0x10)
    TArray<FSessionsSearchSetting> CachedServerFilters_OR;                            // 0x0590 (size: 0x10)
    bool JoiningServerIsRecent;                                                       // 0x05A0 (size: 0x1)

    void AddSessionToJoinToRecent();
    void CheckSessionToJoinForRecent(bool& IsRecent);
    ...
    void UpdateSelectedServerInfo(FBlueprintSessionResult Session, FName StoryProgressRowName, bool Hardcore);
    ...
    void HardcoreJoin_Yes();
    void HardcoreJoin_No();
    void SkipToPasswordCheck();
