...
class ANPC_Monster_Symphonist_C : public ANPC_Base_ParentBP_C
{
    ...
    class USceneComponent* ThrowEndLocation;                                          // 0x20F0 (size: 0x8)
    class UNiagaraComponent* Fog;                                                     // 0x20F8 (size: 0x8)
    class UCapsuleComponent* NearbyAlertCapsule;                                      // 0x2100 (size: 0x8)
    class URadialForceComponent* RadialForce;                                         // 0x2108 (size: 0x8)
    class UNiagaraComponent* DissolveParticle;                                        // 0x2110 (size: 0x8)
    class USceneComponent* StompLocation;                                             // 0x2118 (size: 0x8)
    class UNavigationInvokerComponent* NavigationInvoker;                             // 0x2120 (size: 0x8)
    float Timeline_Dissolve_NewTrack_1_3CA55A274045FB46A1A835948F11E3C3;              // 0x2128 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_Dissolve__Direction_3CA55A274045FB46A1A835948F11E3C3; // 0x212C (size: 0x1)
    class UTimelineComponent* Timeline_Dissolve;                                      // 0x2130 (size: 0x8)
    float Timeline_1_Value_1B8B4C8C4D664960582146A1ABA187CE;                          // 0x2138 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_1__Direction_1B8B4C8C4D664960582146A1ABA187CE; // 0x213C (size: 0x1)
    class UTimelineComponent* Timeline_1;                                             // 0x2140 (size: 0x8)
    double StompCheckDistance;                                                        // 0x2148 (size: 0x8)
    bool SoundAlerted;                                                                // 0x2150 (size: 0x1)
    class UAnimMontage* SoundAlertMontage;                                            // 0x2158 (size: 0x8)
    bool HasTriggeredAlertAggro;                                                      // 0x2160 (size: 0x1)
    bool IsStampeding;                                                                // 0x2161 (size: 0x1)
    double TimeStampedeStarted;                                                       // 0x2168 (size: 0x8)
    float StampedeDuration;                                                           // 0x2170 (size: 0x4)
    class USoundBase* ChargeImpactSFX;                                                // 0x2178 (size: 0x8)
    float ThrowVelocity;                                                              // 0x2180 (size: 0x4)
    int32 NumberOfMirages;                                                            // 0x2184 (size: 0x4)
    bool WantsToActivateMirage;                                                       // 0x2188 (size: 0x1)
    bool PerformingMirage;                                                            // 0x2189 (size: 0x1)
    class UAnimMontage* LeapAttackMontage;                                            // 0x2190 (size: 0x8)
    bool ScarecrowEscape;                                                             // 0x2198 (size: 0x1)
    FVector CalculatedThrowLocation;                                                  // 0x21A0 (size: 0x18)
