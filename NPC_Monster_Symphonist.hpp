...
class ANPC_Monster_Symphonist_C : public ANPC_Base_ParentBP_C
{
    ...
    class USceneComponent* ThrowEndLocation;                                          // 0x1F60 (size: 0x8)
    class UNiagaraComponent* Fog;                                                     // 0x1F68 (size: 0x8)
    class UCapsuleComponent* NearbyAlertCapsule;                                      // 0x1F70 (size: 0x8)
    class URadialForceComponent* RadialForce;                                         // 0x1F78 (size: 0x8)
    class UNiagaraComponent* DissolveParticle;                                        // 0x1F80 (size: 0x8)
    class USceneComponent* StompLocation;                                             // 0x1F88 (size: 0x8)
    class UNavigationInvokerComponent* NavigationInvoker;                             // 0x1F90 (size: 0x8)
    float Timeline_Dissolve_NewTrack_1_3CA55A274045FB46A1A835948F11E3C3;              // 0x1F98 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_Dissolve__Direction_3CA55A274045FB46A1A835948F11E3C3; // 0x1F9C (size: 0x1)
    class UTimelineComponent* Timeline_Dissolve;                                      // 0x1FA0 (size: 0x8)
    float Timeline_1_Value_1B8B4C8C4D664960582146A1ABA187CE;                          // 0x1FA8 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_1__Direction_1B8B4C8C4D664960582146A1ABA187CE; // 0x1FAC (size: 0x1)
    class UTimelineComponent* Timeline_1;                                             // 0x1FB0 (size: 0x8)
    double StompCheckDistance;                                                        // 0x1FB8 (size: 0x8)
    bool SoundAlerted;                                                                // 0x1FC0 (size: 0x1)
    class UAnimMontage* SoundAlertMontage;                                            // 0x1FC8 (size: 0x8)
    bool HasTriggeredAlertAggro;                                                      // 0x1FD0 (size: 0x1)
    bool IsStampeding;                                                                // 0x1FD1 (size: 0x1)
    double TimeStampedeStarted;                                                       // 0x1FD8 (size: 0x8)
    float StampedeDuration;                                                           // 0x1FE0 (size: 0x4)
    class USoundBase* ChargeImpactSFX;                                                // 0x1FE8 (size: 0x8)
    float ThrowVelocity;                                                              // 0x1FF0 (size: 0x4)
    int32 NumberOfMirages;                                                            // 0x1FF4 (size: 0x4)
    bool WantsToActivateMirage;                                                       // 0x1FF8 (size: 0x1)
    bool PerformingMirage;                                                            // 0x1FF9 (size: 0x1)
    class UAnimMontage* LeapAttackMontage;                                            // 0x2000 (size: 0x8)
    bool ScarecrowEscape;                                                             // 0x2008 (size: 0x1)
    FVector CalculatedThrowLocation;                                                  // 0x2010 (size: 0x18)
