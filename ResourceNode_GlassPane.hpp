...
class AResourceNode_GlassPane_C : public AResourceNode_ParentBP_C
{
    ...
    int32 GlassShape;                                                                 // 0x04E8 (size: 0x4)
    int32 GlassScrapToDrop;                                                           // 0x04EC (size: 0x4)
    bool CustomMaterial;                                                              // 0x04F0 (size: 0x1)
    class UMaterialInterface* MaterialOverride;                                       // 0x04F8 (size: 0x8)
