...
class AInvisibleSafetyNode_C : public AAbioticDeployed_ParentBP_C
{
    ...
    class USphereComponent* RangeVisualizer;                                          // 0x0568 (size: 0x8)
    class UStaticMeshComponent* Sphere;                                               // 0x0570 (size: 0x8)
    double ForcedSafetyValue;                                                         // 0x0578 (size: 0x8)
    bool ActAsLightForVisibility;                                                     // 0x0580 (size: 0x1)
    double ForcedLightValue;                                                          // 0x0588 (size: 0x8)
