...
class ADeployed_ElectricFan_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UBoxComponent* FanFriendlyVolume;                                           // 0x0928 (size: 0x8)
    class UBoxComponent* FanBladeVolume;                                              // 0x0930 (size: 0x8)
    class UStaticMeshComponent* FanBlade;                                             // 0x0938 (size: 0x8)
    float Gradual_Fan_Blade_Spin_Speed_9A0AF7FD46A683A1E1778E8DCE50D471;              // 0x0940 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Gradual_Fan_Blade_Spin__Direction_9A0AF7FD46A683A1E1778E8DCE50D471; // 0x0944 (size: 0x1)
    class UTimelineComponent* Gradual Fan Blade Spin;                                 // 0x0948 (size: 0x8)
    TArray<class APowerSocket_ChildOfActor_C*> PlugStripPowerSockets;                 // 0x0950 (size: 0x10)
    TArray<class AActor*> ActorsInBladeZone;                                          // 0x0960 (size: 0x10)
    TArray<class AActor*> FriendliesInBladeZone;                                      // 0x0970 (size: 0x10)
    double LastDamageIntervalTime;                                                    // 0x0980 (size: 0x8)
    float Blade Speed;                                                                // 0x0988 (size: 0x4)
