...
class ADeployed_ElectricFan_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UBoxNavAreaComponent* BoxNavArea;                                           // 0x0878 (size: 0x8)
    class UAudioComponent* Audio;                                                     // 0x0880 (size: 0x8)
    class UBoxComponent* FanFriendlyVolume;                                           // 0x0888 (size: 0x8)
    class UBoxComponent* FanBladeVolume;                                              // 0x0890 (size: 0x8)
    class UStaticMeshComponent* FanBlade;                                             // 0x0898 (size: 0x8)
    float Gradual_Fan_Blade_Spin_Speed_9A0AF7FD46A683A1E1778E8DCE50D471;              // 0x08A0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Gradual_Fan_Blade_Spin__Direction_9A0AF7FD46A683A1E1778E8DCE50D471; // 0x08A4 (size: 0x1)
    class UTimelineComponent* Gradual Fan Blade Spin;                                 // 0x08A8 (size: 0x8)
    TArray<class APowerSocket_ChildOfActor_C*> PlugStripPowerSockets;                 // 0x08B0 (size: 0x10)
    TArray<class AActor*> ActorsInBladeZone;                                          // 0x08C0 (size: 0x10)
    TArray<class AActor*> FriendliesInBladeZone;                                      // 0x08D0 (size: 0x10)
    double LastDamageIntervalTime;                                                    // 0x08E0 (size: 0x8)
    float Blade Speed;                                                                // 0x08E8 (size: 0x4)
