...
class AWeapon_Melee_QuillSpear_C : public AAbiotic_Weapon_Melee_ParentBP_C
{
    ...
    class AActor* LastHomingTarget;                                                   // 0x0B78 (size: 0x8)
    double HomingMaxRange;                                                            // 0x0B80 (size: 0x8)
    bool SaveChargingProgress;                                                        // 0x0B88 (size: 0x1)
    bool AutoFire;                                                                    // 0x0B89 (size: 0x1)
