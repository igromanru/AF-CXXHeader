...
class AResource_Micronode_LeyakEssence_C : public AResource_MicroNode_ParentBP_C
{
    ...
    float FloatDownTimeline_NewTrack_0_945DD8F345F91028E12829B01DC2DC20;              // 0x04F0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> FloatDownTimeline__Direction_945DD8F345F91028E12829B01DC2DC20; // 0x04F4 (size: 0x1)
    class UTimelineComponent* FloatDownTimeline;                                      // 0x04F8 (size: 0x8)
