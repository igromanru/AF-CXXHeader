...
class AResource_Micronode_LeyakEssence_C : public AResource_MicroNode_ParentBP_C
{
    ...
    float FloatDownTimeline_NewTrack_0_945DD8F345F91028E12829B01DC2DC20;              // 0x0508 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> FloatDownTimeline__Direction_945DD8F345F91028E12829B01DC2DC20; // 0x050C (size: 0x1)
    class UTimelineComponent* FloatDownTimeline;                                      // 0x0510 (size: 0x8)
    class UNiagaraSystem* System Template;                                            // 0x0518 (size: 0x8)
