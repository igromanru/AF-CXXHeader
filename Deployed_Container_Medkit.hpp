...
class ADeployed_Container_Medkit_C : public ADeployed_Container_ParentBP_C
{
    ...
    class UStaticMeshComponent* Lid;                                                  // 0x0948 (size: 0x8)
    float LidAnimTimeline_NewTrack_0_B7E881B74D1BC15EDEA835AEB0F10D18;                // 0x0950 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> LidAnimTimeline__Direction_B7E881B74D1BC15EDEA835AEB0F10D18; // 0x0954 (size: 0x1)
    class UTimelineComponent* LidAnimTimeline;                                        // 0x0958 (size: 0x8)
    FRotator LidClosedRot;                                                            // 0x0960 (size: 0x18)
    FRotator LidOpenRot;                                                              // 0x0978 (size: 0x18)
