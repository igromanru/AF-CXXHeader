...
class UAbioticFunctionLibrary_C : public UBlueprintFunctionLibrary
{
    ...
    int32 NpcAbilityDifficulty(class UObject* __WorldContext);
    bool ApocalypticAbilitiesEnabled(class UObject* __WorldContext);
    ...
    bool PlayerTeleportCheck(FVector TeleportLocation, class AActor* OwningActor, double CapsuleRadius, bool UsePlayerZ, class UObject* __WorldContext, TArray<FHitResult>& OutHits);
