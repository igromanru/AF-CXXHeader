...
class ADeployed_Armor_Stand_C : public ADeployed_Container_ParentBP_C
{
    ...
    class UBoxComponent* Box;                                                         // 0x09F0 (size: 0x8)
    class UStaticMeshComponent* BackpackMesh;                                         // 0x09F8 (size: 0x8)
    class USkeletalMeshComponent* Armor_Torso;                                        // 0x0A00 (size: 0x8)
    class USkeletalMeshComponent* Armor_Arms;                                         // 0x0A08 (size: 0x8)
    class USkeletalMeshComponent* Armor_Legs;                                         // 0x0A10 (size: 0x8)
    class USkeletalMeshComponent* Armor_Suit;                                         // 0x0A18 (size: 0x8)
    class USkeletalMeshComponent* Armor_Helmet;                                       // 0x0A20 (size: 0x8)
    class USkeletalMeshComponent* SkeletalMesh;                                       // 0x0A28 (size: 0x8)
    int32 PoseNumber;                                                                 // 0x0A30 (size: 0x4)
    bool SwapEmptySlot;                                                               // 0x0A34 (size: 0x1)
