...
class ADeployed_JumpPad_ParentBP_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UBoxComponent* JumpZone;                                                    // 0x0938 (size: 0x8)
    float JumpPadWooshAnim_NewTrack_0_6CA810E4424A3C530346A79F5C10579C;               // 0x0940 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> JumpPadWooshAnim__Direction_6CA810E4424A3C530346A79F5C10579C; // 0x0944 (size: 0x1)
    class UTimelineComponent* JumpPadWooshAnim;                                       // 0x0948 (size: 0x8)
    double LaunchVelocity;                                                            // 0x0950 (size: 0x8)
    FVector MeshScaleDefault;                                                         // 0x0958 (size: 0x18)
    FVector MeshScaleMaxBounce;                                                       // 0x0970 (size: 0x18)
    class USoundBase* JumpPadSound;                                                   // 0x0988 (size: 0x8)
    bool AllowCrouchCanceling;                                                        // 0x0990 (size: 0x1)
