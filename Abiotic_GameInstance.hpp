...
class UAbiotic_GameInstance_C : public UAbioticGameInstance
{
    ...
    FString CustomizationSavePrefix;                                                  // 0x0388 (size: 0x10)
    class UAbiotic_SettingsSave_C* SettingsSaveFile;                                  // 0x0398 (size: 0x8)
    TArray<double> DefaultSkillXPTable;                                               // 0x03A0 (size: 0x10)
    double Skill1XP;                                                                  // 0x03B0 (size: 0x8)
    double SkillXPIncreasePerLevel;                                                   // 0x03B8 (size: 0x8)
    int32 MaxSkillLevel;                                                              // 0x03C0 (size: 0x4)
    TArray<FName> PlayerCraftingExtraCostItems;                                       // 0x03C8 (size: 0x10)
    class UAbiotic_CustomizationSave_C* CurrentCustomizationSave;                     // 0x03D8 (size: 0x8)
    int32 SelectedCustomizationPreset;                                                // 0x03E0 (size: 0x4)
    bool TraitDebugMode;                                                              // 0x03E4 (size: 0x1)
    FAbiotic_GameInstance_CPersistentLevelLoaded PersistentLevelLoaded;               // 0x03E8 (size: 0x10)
    void PersistentLevelLoaded(bool Success);
    double GlobalBuffTickRate;                                                        // 0x03F8 (size: 0x8)
    bool HasSeenSplashThisSession;                                                    // 0x0400 (size: 0x1)
    double AutosaveInterval;                                                          // 0x0408 (size: 0x8)
    bool AllowAnalytics;                                                              // 0x0410 (size: 0x1)
    bool AssaultsEnabled;                                                             // 0x0411 (size: 0x1)
    TArray<class UWidget*> UI_PopupStack;                                             // 0x0418 (size: 0x10)
    bool HideWatermark;                                                               // 0x0428 (size: 0x1)
    TArray<class UDataTable*> DataTableReferences;                                    // 0x0430 (size: 0x10)
    FErrorMessageRowHandle PendingErrorMessage;                                       // 0x0440 (size: 0x20)
    FAbiotic_GameInstance_CSessionInviteAccepted SessionInviteAccepted;               // 0x0460 (size: 0x10)
    void SessionInviteAccepted(FBlueprintSessionResult Session);
    bool HasPlayedTutorial;                                                           // 0x0470 (size: 0x1)
    bool IsLanSession;                                                                // 0x0471 (size: 0x1)
    bool IsSingleplayer;                                                              // 0x0472 (size: 0x1)
    int32 SessionMaxPlayers;                                                          // 0x0474 (size: 0x4)
    bool FirstTutorialPlaythrough;                                                    // 0x0478 (size: 0x1)
    TArray<class UObject*> ReferencedAssets;                                          // 0x0480 (size: 0x10)
    bool JustEndedTutorial;                                                           // 0x0490 (size: 0x1)
    int32 RequiredWorldVersion;                                                       // 0x0494 (size: 0x4)
    class UAbiotic_CustomizationUnlocks_Save_C* CustomizationUnlocksSaveFile;         // 0x0498 (size: 0x8)
    double LastAutoSaveTime;                                                          // 0x04A0 (size: 0x8)
    bool PendingBackupSave;                                                           // 0x04A8 (size: 0x1)
    ...
    void Display_YesNo_Popup(FText Text_Title, FText Text_Main, FText Text_Yes, bool HideYesButton, FText Text_No, bool HideNoButton, double InputDelay, class UW_MenuPopup_YesNo_C*& Widget);
