...
class AHandDryer_BP_C : public AAbioticActor_C
{
    ...
    class UAudioComponent* DryerAudio;                                                // 0x02C8 (size: 0x8)
    class UStaticMeshComponent* Button;                                               // 0x02D0 (size: 0x8)
    class UStaticMeshComponent* HandDryer;                                            // 0x02D8 (size: 0x8)
    float ButtonpressTimeline_NewTrack_0_9A74C8D141C4EF509CAEA59C56A98CCD;            // 0x02E0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> ButtonpressTimeline__Direction_9A74C8D141C4EF509CAEA59C56A98CCD; // 0x02E4 (size: 0x1)
    class UTimelineComponent* ButtonpressTimeline;                                    // 0x02E8 (size: 0x8)
    bool DryerActive;                                                                 // 0x02F0 (size: 0x1)
