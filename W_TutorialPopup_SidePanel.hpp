...
class UW_TutorialPopup_SidePanel_C : public UUserWidget
{
    ...
    class UGridPanel* KeybindsPanel;                                                  // 0x0308 (size: 0x8)
    class UTextBlock* Text_Tip;                                                       // 0x0310 (size: 0x8)
    class UTextBlock* Text_Title;                                                     // 0x0318 (size: 0x8)
    class UImage* Video;                                                              // 0x0320 (size: 0x8)
    class UW_Keybind_C* W_Keybind;                                                    // 0x0328 (size: 0x8)
    int32 CurrentTime;                                                                // 0x0330 (size: 0x4)
    FName TutorialTipRow;                                                             // 0x0334 (size: 0x8)
    FTimerHandle CountdownTimer;                                                      // 0x0340 (size: 0x8)
    TArray<class UUserWidget*> ExistingKeybinds;                                      // 0x0348 (size: 0x10)

    void SetupKeybinds(bool bUsingGamepad);
