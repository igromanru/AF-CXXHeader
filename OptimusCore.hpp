...
struct FOptimusGraphVariableDescription
{
    ...
    TSoftObjectPtr<UObject> SourceObject;                                             // 0x0030 (size: 0x28)
...
struct FOptimusParameterBinding
{
    ...
    FOptimusDataTypeRef DataType;                                                     // 0x0008 (size: 0x10)
    FOptimusDataDomain DataDomain;                                                    // 0x0018 (size: 0x40)
    bool bSupportAtomicIfCompatibleDataType;                                          // 0x0058 (size: 0x1)
    bool bSupportRead;                                                                // 0x0059 (size: 0x1)
...
class UOptimusDeformerInstance : public UMeshDeformerInstance
{
    ...
    TArray<TWeakObjectPtr<UActorComponent>> WeakBoundComponents;                      // 0x0050 (size: 0x10)
    TArray<TWeakObjectPtr<UOptimusComponentSource>> WeakComponentSources;             // 0x0060 (size: 0x10)
...
{
    UClass* DataInterfaceClass;                                                       // 0x0120 (size: 0x8)
    class UOptimusComputeDataInterface* DataInterfaceData;                            // 0x0128 (size: 0x8)
...
class UOptimusNode_GetVariable : public UOptimusNode
{
    ...
    FOptimusNode_GetVariable_DuplicationInfo DuplicationInfo;                         // 0x0128 (size: 0x28)
...
class UOptimusNode_ResourceAccessorBase : public UOptimusNode
{
    ...
    FOptimusNode_ResourceAccessorBase_DuplicationInfo DuplicationInfo;                // 0x0138 (size: 0x58)
