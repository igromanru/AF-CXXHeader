...
{
    class UReplicationGraph* ReplicationGraph;                                        // 0x0298 (size: 0x8)
    class UNetReplicationGraphConnection* ConnectionManager;                          // 0x02A0 (size: 0x8)
...
class UNetReplicationGraphConnection : public UReplicationConnectionDriver
{
    ...
    TWeakObjectPtr<class AReplicationGraphDebugActor> DebugActor;                     // 0x0174 (size: 0x8)
    TArray<FLastLocationGatherInfo> LastGatherLocations;                              // 0x0180 (size: 0x10)
    TArray<class UReplicationGraphNode*> ConnectionGraphNodes;                        // 0x0240 (size: 0x10)
    class UReplicationGraphNode_TearOff_ForConnection* TearOffNode;                   // 0x0250 (size: 0x8)
