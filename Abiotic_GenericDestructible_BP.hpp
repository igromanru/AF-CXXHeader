...
class AAbiotic_GenericDestructible_BP_C : public AAbioticActor_C
{
    ...
    class UNiagaraComponent* BreakFX;                                                 // 0x02D0 (size: 0x8)
    class UStaticMeshComponent* DestroyedMesh;                                        // 0x02D8 (size: 0x8)
    class UStaticMeshComponent* StaticMesh;                                           // 0x02E0 (size: 0x8)
    double Health;                                                                    // 0x02E8 (size: 0x8)
    bool Broken;                                                                      // 0x02F0 (size: 0x1)
    class UStaticMesh* DefaultStaticMesh;                                             // 0x02F8 (size: 0x8)
    class UStaticMesh* DestroyedStaticMesh;                                           // 0x0300 (size: 0x8)
    bool DestroyedOnlyByTrigger;                                                      // 0x0308 (size: 0x1)
    FWorldFlagRowHandle DestroyOnWorldFlag;                                           // 0x0310 (size: 0x20)
    class UNiagaraSystem* BreakFXParticles;                                           // 0x0330 (size: 0x8)
    class USoundBase* BreakSFX;                                                       // 0x0338 (size: 0x8)
    FAbiotic_GenericDestructible_BP_COnDestructibleDestroyed OnDestructibleDestroyed; // 0x0340 (size: 0x10)
    void OnDestructibleDestroyed();
    FWorldFlagRowHandle SetWorldFlagOnBreak;                                          // 0x0350 (size: 0x20)
    TArray<class TSubclassOf<UAbiotic_DamageType_ParentBP_C>> ValidDamageTypes;       // 0x0370 (size: 0x10)
