...
class AContainer_KitchenCabinet_C : public ADeployed_Container_ParentBP_C
{
    ...
    class UStaticMeshComponent* DrawerR;                                              // 0x09F0 (size: 0x8)
    class UStaticMeshComponent* DrawerL;                                              // 0x09F8 (size: 0x8)
    float Timeline_NewTrack_0_AD3926F14EB41A9F6216EE817CD44A6C;                       // 0x0A00 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline__Direction_AD3926F14EB41A9F6216EE817CD44A6C; // 0x0A04 (size: 0x1)
    class UTimelineComponent* Timeline;                                               // 0x0A08 (size: 0x8)
    bool Laboratory;                                                                  // 0x0A10 (size: 0x1)
