...
class AContainer_KitchenCabinet_C : public ADeployed_Container_ParentBP_C
{
    ...
    class UStaticMeshComponent* DrawerR;                                              // 0x0948 (size: 0x8)
    class UStaticMeshComponent* DrawerL;                                              // 0x0950 (size: 0x8)
    float Timeline_NewTrack_0_AD3926F14EB41A9F6216EE817CD44A6C;                       // 0x0958 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline__Direction_AD3926F14EB41A9F6216EE817CD44A6C; // 0x095C (size: 0x1)
    class UTimelineComponent* Timeline;                                               // 0x0960 (size: 0x8)
    bool Laboratory;                                                                  // 0x0968 (size: 0x1)
