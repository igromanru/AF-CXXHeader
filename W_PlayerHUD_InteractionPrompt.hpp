...
class UW_PlayerHUD_InteractionPrompt_C : public UUserWidget
{
    ...
    class UImage* ActionIcon;                                                         // 0x02E8 (size: 0x8)
    class UTextBlock* DescriptionText;                                                // 0x02F0 (size: 0x8)
    class UProgressBar* DurabilityBar;                                                // 0x02F8 (size: 0x8)
    class UHorizontalBox* HBox_HoldInteract;                                          // 0x0300 (size: 0x8)
    class UHorizontalBox* HBox_HoldPackage;                                           // 0x0308 (size: 0x8)
    class UHorizontalBox* Hbox_JumpPrompt;                                            // 0x0310 (size: 0x8)
    class UHorizontalBox* HBox_PressInteract;                                         // 0x0318 (size: 0x8)
    class UHorizontalBox* HBox_PressPackage;                                          // 0x0320 (size: 0x8)
    class UHorizontalBox* HBox_PrimaryPrompt;                                         // 0x0328 (size: 0x8)
    class UHorizontalBox* HBox_SecondaryPrompt;                                       // 0x0330 (size: 0x8)
    class UW_Keybind_C* HoldInteractKeybind;                                          // 0x0338 (size: 0x8)
    class UTextBlock* HoldInteractSuffix;                                             // 0x0340 (size: 0x8)
    class UW_Keybind_C* HoldPackageKeybind;                                           // 0x0348 (size: 0x8)
    class UTextBlock* HoldPackageSuffix;                                              // 0x0350 (size: 0x8)
    class UTextBlock* InteractionObjectName;                                          // 0x0358 (size: 0x8)
    class UW_Keybind_C* JumpKeybind;                                                  // 0x0360 (size: 0x8)
    class UTextBlock* JumpKeySuffix;                                                  // 0x0368 (size: 0x8)
    class UW_Keybind_C* PressInteractKeybind;                                         // 0x0370 (size: 0x8)
    class UTextBlock* PressInteractSuffix;                                            // 0x0378 (size: 0x8)
    class UW_Keybind_C* PressPackageKeybind;                                          // 0x0380 (size: 0x8)
    class UTextBlock* PressPackageSuffix;                                             // 0x0388 (size: 0x8)
    class UW_Keybind_C* PrimaryFireKeybind;                                           // 0x0390 (size: 0x8)
    class UTextBlock* PrimaryFireSuffix;                                              // 0x0398 (size: 0x8)
