...
class ADeployed_Ladder_ParentBP_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class USceneComponent* RopeMeshesStartPoint;                                      // 0x0878 (size: 0x8)
    class UBoxComponent* LadderCollision;                                             // 0x0880 (size: 0x8)
    class UArrowComponent* Arrow;                                                     // 0x0888 (size: 0x8)
    class USceneComponent* LadderEndLaunchPoint;                                      // 0x0890 (size: 0x8)
    class UBillboardComponent* Billboard_Down;                                        // 0x0898 (size: 0x8)
    class USceneComponent* LadderLengthStart;                                         // 0x08A0 (size: 0x8)
    class UBillboardComponent* Billboard_Up;                                          // 0x08A8 (size: 0x8)
    class UBoxComponent* LadderVolume;                                                // 0x08B0 (size: 0x8)
    bool LadderDownOnly;                                                              // 0x08B8 (size: 0x1)
    bool LadderAutomaticTraversal;                                                    // 0x08B9 (size: 0x1)
    double LadderLength;                                                              // 0x08C0 (size: 0x8)
    float LadderMaxLength;                                                            // 0x08C8 (size: 0x4)
    bool LadderLengthTooShort;                                                        // 0x08CC (size: 0x1)
    bool LadderFixedDistance;                                                         // 0x08CD (size: 0x1)
    TArray<class AActor*> ActorsInLadderVolume;                                       // 0x08D0 (size: 0x10)
    bool CanInteractToGrabLadder;                                                     // 0x08E0 (size: 0x1)
    class USoundBase* LadderSound_Enter;                                              // 0x08E8 (size: 0x8)
    class USoundBase* LadderSound_Step;                                               // 0x08F0 (size: 0x8)
    class USoundBase* LadderSound_Exit;                                               // 0x08F8 (size: 0x8)
    bool LadderActivated;                                                             // 0x0900 (size: 0x1)
    bool LadderReachesFloor;                                                          // 0x0901 (size: 0x1)
    bool HasSetLadderDistance;                                                        // 0x0902 (size: 0x1)
    class UStaticMesh* LadderRungMesh;                                                // 0x0908 (size: 0x8)
    class UStaticMesh* LadderRungEndMesh;                                             // 0x0910 (size: 0x8)
    double LadderSegmentHeight;                                                       // 0x0918 (size: 0x8)
    double LadderMinimumLength;                                                       // 0x0920 (size: 0x8)
