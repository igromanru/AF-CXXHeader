...
class ADeployed_Ladder_ParentBP_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class USceneComponent* RopeMeshesStartPoint;                                      // 0x0938 (size: 0x8)
    class UBoxComponent* LadderCollision;                                             // 0x0940 (size: 0x8)
    class UArrowComponent* Arrow;                                                     // 0x0948 (size: 0x8)
    class USceneComponent* LadderEndLaunchPoint;                                      // 0x0950 (size: 0x8)
    class UBillboardComponent* Billboard_Down;                                        // 0x0958 (size: 0x8)
    class USceneComponent* LadderLengthStart;                                         // 0x0960 (size: 0x8)
    class UBillboardComponent* Billboard_Up;                                          // 0x0968 (size: 0x8)
    class UBoxComponent* LadderVolume;                                                // 0x0970 (size: 0x8)
    bool LadderDownOnly;                                                              // 0x0978 (size: 0x1)
    bool LadderAutomaticTraversal;                                                    // 0x0979 (size: 0x1)
    double LadderLength;                                                              // 0x0980 (size: 0x8)
    float LadderMaxLength;                                                            // 0x0988 (size: 0x4)
    bool LadderLengthTooShort;                                                        // 0x098C (size: 0x1)
    bool LadderFixedDistance;                                                         // 0x098D (size: 0x1)
    TArray<class AActor*> ActorsInLadderVolume;                                       // 0x0990 (size: 0x10)
    bool CanInteractToGrabLadder;                                                     // 0x09A0 (size: 0x1)
    class USoundBase* LadderSound;                                                    // 0x09A8 (size: 0x8)
    class USoundBase* LadderSound_Exit;                                               // 0x09B0 (size: 0x8)
    bool LadderActivated;                                                             // 0x09B8 (size: 0x1)
    bool LadderReachesFloor;                                                          // 0x09B9 (size: 0x1)
    bool HasSetLadderDistance;                                                        // 0x09BA (size: 0x1)
    class UStaticMesh* LadderRungMesh;                                                // 0x09C0 (size: 0x8)
    class UStaticMesh* LadderRungEndMesh;                                             // 0x09C8 (size: 0x8)
    double LadderSegmentHeight;                                                       // 0x09D0 (size: 0x8)
    double LadderMinimumLength;                                                       // 0x09D8 (size: 0x8)
