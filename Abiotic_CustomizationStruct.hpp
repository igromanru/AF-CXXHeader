...
struct FAbiotic_CustomizationStruct
{
    ...
    FString RequiredConditionToUnlock_62_980F45B3465594E7A7649DAB3BAA9E2F;            // 0x0110 (size: 0x10)
    bool Unlocked_31_8C0F4163431DFF87062EA3ABFC8E8482;                                // 0x0120 (size: 0x1)
    FLinearColor ColorA_38_48A0590C4984FA0BF470568FBF92F889;                          // 0x0124 (size: 0x10)
    FLinearColor ColorB_39_3822B550469594F922E379847D5EBF48;                          // 0x0134 (size: 0x10)
    FLinearColor ColorC_40_9F427AD14FB5A1947B698EA1A4F8C176;                          // 0x0144 (size: 0x10)
    TEnumAsByte<E_SkinTones::Type> SkinTone_60_03519A424DBA1796501ECAA5F93B0B50;      // 0x0154 (size: 0x1)
    FGameplayTagContainer Tags_67_53C7CA184101D5AC79BCD983AF71AC7C;                   // 0x0158 (size: 0x20)
