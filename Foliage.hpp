...
{
    class UProceduralFoliageSpawner* FoliageSpawner;                                  // 0x00A8 (size: 0x8)
    float TileOverlap;                                                                // 0x00B0 (size: 0x4)
    class AVolume* SpawningVolume;                                                    // 0x00B8 (size: 0x8)
    FGuid ProceduralGuid;                                                             // 0x00C0 (size: 0x10)
