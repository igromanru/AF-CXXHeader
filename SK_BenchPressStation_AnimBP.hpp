#ifndef UE4SS_SDK_SK_BenchPressStation_AnimBP_HPP
#define UE4SS_SDK_SK_BenchPressStation_AnimBP_HPP
...
class USK_BenchPressStation_AnimBP_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_SK_BenchPressStation_AnimBP(int32 EntryPoint);
}; // Size: 0x4B8
