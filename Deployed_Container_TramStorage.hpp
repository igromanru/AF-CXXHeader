...
class ADeployed_Container_TramStorage_C : public ADeployed_Container_Cargo_C
{
    ...
    float LidAnimTimeline_NewTrack_0_5A51AFA8451C7154E063089BD8306703;                // 0x0A00 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> LidAnimTimeline__Direction_5A51AFA8451C7154E063089BD8306703; // 0x0A04 (size: 0x1)
