...
class ADeployed_Container_TramStorage_C : public ADeployed_Container_Cargo_C
{
    ...
    float LidAnimTimeline_NewTrack_0_5A51AFA8451C7154E063089BD8306703;                // 0x0958 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> LidAnimTimeline__Direction_5A51AFA8451C7154E063089BD8306703; // 0x095C (size: 0x1)
    class UTimelineComponent* LidAnimTimeline;                                        // 0x0960 (size: 0x8)
    FRotator LidClosedRot;                                                            // 0x0968 (size: 0x18)
    FRotator LidOpenRot;                                                              // 0x0980 (size: 0x18)
