...
class UW_Inventory_ItemContextMenu_C : public UAbioticWidget
{
    ...
    class UTextBlock* ApplyCoatingText;                                               // 0x02E8 (size: 0x8)
    class UButton* Button_ApplyCoating;                                               // 0x02F0 (size: 0x8)
    class UButton* Button_Drop;                                                       // 0x02F8 (size: 0x8)
    class UButton* Button_Favorite;                                                   // 0x0300 (size: 0x8)
    class UButton* Button_PourOut;                                                    // 0x0308 (size: 0x8)
    class UButton* Button_PrimaryUse;                                                 // 0x0310 (size: 0x8)
    class UButton* Button_Recharge;                                                   // 0x0318 (size: 0x8)
    class UButton* Button_Rename;                                                     // 0x0320 (size: 0x8)
    class UButton* Button_repair;                                                     // 0x0328 (size: 0x8)
    class UButton* Button_SplitStack;                                                 // 0x0330 (size: 0x8)
    class UButton* Button_Take;                                                       // 0x0338 (size: 0x8)
    class UButton* Button_UnloadMagazine;                                             // 0x0340 (size: 0x8)
    class UTextBlock* FavoriteText;                                                   // 0x0348 (size: 0x8)
    class UTextBlock* PrimaryUseText;                                                 // 0x0350 (size: 0x8)
    class UTextBlock* TakeText;                                                       // 0x0358 (size: 0x8)
    class UVerticalBox* VerticalBox_126;                                              // 0x0360 (size: 0x8)
    class UW_Keybind_C* W_Keybind;                                                    // 0x0368 (size: 0x8)
    class UW_Keybind_C* W_Keybind_1;                                                  // 0x0370 (size: 0x8)
    FAbiotic_InventoryItemSlotStruct ItemSlotStruct;                                  // 0x0378 (size: 0x98)
    class UW_InventoryItemSlot_C* OriginSlot;                                         // 0x0410 (size: 0x8)
    bool CheckForFocus;                                                               // 0x0418 (size: 0x1)
    bool Removed;                                                                     // 0x0419 (size: 0x1)
    ...
    void BndEvt__W_Inventory_ItemContextMenu_Button_Rename_K2Node_ComponentBoundEvent_9_OnButtonClickedEvent__DelegateSignature();
    void BndEvt__W_Inventory_ItemContextMenu_Button_ApplyCoating_K2Node_ComponentBoundEvent_10_OnButtonClickedEvent__DelegateSignature();
