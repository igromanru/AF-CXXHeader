...
class ADeployed_ChargingStation_ParentBP_C : public AAbioticDeployed_Furniture_ParentBP_C
{
    ...
    class UAudioComponent* Charging_Station_Loop;                                     // 0x0878 (size: 0x8)
    class UNiagaraComponent* ChargingParticle;                                        // 0x0880 (size: 0x8)
    class UPointLightComponent* PointLight;                                           // 0x0888 (size: 0x8)
    class UAbiotic_InventoryComponent_C* ChargeStationInventory;                      // 0x0890 (size: 0x8)
    float Timeline_NewTrack_0_2970AB954481CD0A5EE5A6B0C726E9CA;                       // 0x0898 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline__Direction_2970AB954481CD0A5EE5A6B0C726E9CA; // 0x089C (size: 0x1)
    class UTimelineComponent* Timeline;                                               // 0x08A0 (size: 0x8)
    bool Local_HoldingChargeableItem;                                                 // 0x08A8 (size: 0x1)
    bool IsChargingItem;                                                              // 0x08A9 (size: 0x1)
    class AAbiotic_Item_ParentBP_C* ChargingItem;                                     // 0x08B0 (size: 0x8)
    double ChargingInterval;                                                          // 0x08B8 (size: 0x8)
    FTimerHandle ChargingTimer;                                                       // 0x08C0 (size: 0x8)
    double ChargingIncreasePerTick;                                                   // 0x08C8 (size: 0x8)
    double CurrentChargePercent;                                                      // 0x08D0 (size: 0x8)
    TArray<class AChargedProxy_BP_C*> ChargingProxies;                                // 0x08D8 (size: 0x10)
    int32 LastLightElement;                                                           // 0x08E8 (size: 0x4)
    bool BlinkOn;                                                                     // 0x08EC (size: 0x1)
    FTimerHandle BeepTimer;                                                           // 0x08F0 (size: 0x8)
    bool ChargingBeepDisabled;                                                        // 0x08F8 (size: 0x1)
